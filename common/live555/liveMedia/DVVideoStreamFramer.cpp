...
#undef DV_SMALLEST_POSSIBLE_FRAME_SIZE
#undef DVSectionId
#undef DVData
#undef DV_SECTION_HEADER
#undef DV_PACK_HEADER_10
#undef DV_PACK_HEADER_12
#undef DV_SECTION_VAUX_MIN
#undef DV_SECTION_VAUX_MAX
#undef DV_PACK_VIDEO_SOURCE
