...
void MPEG4VideoFileServerMediaSubsession::afterPlayingDummy(void* clientData) {
...
void MPEG4VideoFileServerMediaSubsession::checkForAuxSDPLine(void* clientData) {
  MPEG4VideoFileServerMediaSubsession* subsess
    = (MPEG4VideoFileServerMediaSubsession*)clientData;
...
void MPEG4VideoFileServerMediaSubsession::checkForAuxSDPLine1() {
  if (fAuxSDPLine != NULL) {
    ...
    const char* auxSDP = fDummyRTPSink->auxSDPLine();
    if (auxSDP != NULL && strstr(auxSDP, "a=fmtp:") != NULL) {
      fAuxSDPLine = strDup(auxSDP);
      fDummyRTPSink = NULL;
