...
enum MPEG4ParseState {
  MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE,
  MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE_SEEN_CODE,
  MPEG4_PARSING_VISUAL_OBJECT,
  MPEG4_PARSING_VIDEO_OBJECT_LAYER,
  MPEG4_PARSING_GROUP_OF_VIDEO_OBJECT_PLANE,
  MPEG4_PARSING_VIDEO_OBJECT_PLANE,
  MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE_END_CODE
};
...
private:
  ...
  void setParseState(MPEG4ParseState parseState);
...
private:
  MPEG4ParseState fCurrentParseState;
...
::MPEG4VideoStreamParser(MPEG4VideoStreamFramer* usingSource,
  ...
  : MPEGVideoStreamParser(usingSource, inputSource),
    fCurrentParseState(MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE),
...
void MPEG4VideoStreamParser::setParseState(MPEG4ParseState parseState) {
...
void MPEG4VideoStreamParser::flushInput() {
  ...
  if (fCurrentParseState != MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE) {
    setParseState(MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE); // later, change to GOV or VOP? #####
  }
}
...
unsigned MPEG4VideoStreamParser::parse() {
  try {
    ...
    case MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE: {
      return parseVisualObjectSequence();
    }
    case MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE_SEEN_CODE: {
      return parseVisualObjectSequence(True);
    }
    case MPEG4_PARSING_VISUAL_OBJECT: {
      return parseVisualObject();
    }
    case MPEG4_PARSING_VIDEO_OBJECT_LAYER: {
      return parseVideoObjectLayer();
    }
    case MPEG4_PARSING_GROUP_OF_VIDEO_OBJECT_PLANE: {
      return parseGroupOfVideoObjectPlane();
    }
    case MPEG4_PARSING_VIDEO_OBJECT_PLANE: {
      return parseVideoObjectPlane();
    }
    case MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE_END_CODE: {
...
::parseVisualObjectSequence(Boolean haveSeenStartCode) {
...
#endif
      get1Byte(); setParseState(MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE);
  ...
  setParseState(MPEG4_PARSING_VISUAL_OBJECT);
...
unsigned MPEG4VideoStreamParser::parseVisualObject() {
  ...
  setParseState(MPEG4_PARSING_VIDEO_OBJECT_LAYER);
...
unsigned MPEG4VideoStreamParser::parseGroupOfVideoObjectPlane() {
  ...
  setParseState(MPEG4_PARSING_VIDEO_OBJECT_PLANE);
...
unsigned MPEG4VideoStreamParser::parseVideoObjectPlane() {
  ...
  case VISUAL_OBJECT_SEQUENCE_END_CODE: {
    setParseState(MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE_END_CODE);
    break;
  }
  case VISUAL_OBJECT_SEQUENCE_START_CODE: {
    setParseState(MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE_SEEN_CODE);
    break;
  }
  ...
  case GROUP_VOP_START_CODE: {
    setParseState(MPEG4_PARSING_GROUP_OF_VIDEO_OBJECT_PLANE);
    break;
  }
  case VOP_START_CODE: {
    setParseState(MPEG4_PARSING_VIDEO_OBJECT_PLANE);
  ...
  default: {
	...
	saveToNextCode(next4Bytes);
      ...
      usingSource()->envir() << "MPEG4VideoStreamParser::parseVideoObjectPlane(): Saw unexpected code "
			     << (void*)next4Bytes << "\n";
      setParseState(MPEG4_PARSING_VIDEO_OBJECT_PLANE); // the safest way to recover...
    }
    break;
  }
  }
...
unsigned MPEG4VideoStreamParser::parseVisualObjectSequenceEndCode() {
  ...
  setParseState(MPEG4_PARSING_VISUAL_OBJECT_SEQUENCE);
...
#undef VISUAL_OBJECT_SEQUENCE_START_CODE
#undef VISUAL_OBJECT_SEQUENCE_END_CODE
#undef GROUP_VOP_START_CODE
#undef VISUAL_OBJECT_START_CODE
#undef VOP_START_CODE
