...
#define _MATROSKA_FILE_PARSER_HH
...
enum MatroskaParseState {
  MKV_PARSING_START_OF_FILE,
  MKV_LOOKING_FOR_TRACKS,
  MKV_PARSING_TRACK,
  MKV_PARSING_CUES,
  MKV_LOOKING_FOR_CLUSTER,
  MKV_LOOKING_FOR_BLOCK,
  MKV_PARSING_BLOCK,
  MKV_DELIVERING_FRAME_WITHIN_BLOCK,
  MKV_DELIVERING_FRAME_BYTES
};
