...
#undef fourChar
#undef addFileHeader
#undef addFileHeader1
#undef addFileHeaderEnd
#undef AVIF_HASINDEX
#undef AVIF_MUSTUSEINDEX
#undef AVIF_ISINTERLEAVED
#undef AVIF_TRUSTCKTYPE
#undef AVIF_WASCAPTUREFILE
#undef AVIF_COPYRIGHTED
#undef AVI_MASTER_INDEX_SIZE
