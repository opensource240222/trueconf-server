...
class LIVE_API RTSPServerSupportingHTTPStreaming: public RTSPServer {
public:
...
public: // should be protected, but some old compilers complain otherwise
  class LIVE_API RTSPClientConnectionSupportingHTTPStreaming: public RTSPServer::RTSPClientConnection {
  public:
