...
LIVE_API char* our_MD5Data(unsigned char const* data, unsigned dataSize, char* outputDigest);
...
LIVE_API unsigned char* our_MD5DataRaw(unsigned char const* data, unsigned dataSize,
