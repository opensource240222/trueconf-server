...
class LIVE_API MPEG4LATMAudioRTPSource: public MultiFramedRTPSource {
public:
...
LIVE_API unsigned char* parseStreamMuxConfigStr(char const* configStr,
				       // result parameter:
				       unsigned& audioSpecificConfigSize);
...
LIVE_API unsigned char* parseGeneralConfigStr(char const* configStr,
				     // result parameter:
				     unsigned& configSize);
