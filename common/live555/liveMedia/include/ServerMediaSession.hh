...
public:
  ...
  char const* info() const { return fInfoSDPString; }
  char const* description() const { return fDescriptionSDPString; }
  Boolean isSSM() const { return fIsSSM; }
  char const* miscSDPLines() const { return fMiscSDPLines; }
