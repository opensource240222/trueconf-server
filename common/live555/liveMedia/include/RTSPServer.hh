...
class LIVE_API UserAuthenticationDatabase {
public:
...
class LIVE_API RTSPServer: public Medium {
public:
  ...
  virtual void removeServerMediaSession(ServerMediaSession* serverMediaSession);
  ...
  virtual void closeAllClientSessionsForServerMediaSession(ServerMediaSession* serverMediaSession);
...
public: // should be protected, but some old compilers complain otherwise
  ...
  class LIVE_API RTSPClientConnection {
  public:
    // A data structure that's used to implement the "REGISTER" command:
    class LIVE_API ParamsForREGISTER {
    public:
  ...
  class LIVE_API RTSPClientSession {
  protected:
...
protected:
  ...
  class LIVE_API ServerMediaSessionIterator {
  public:
...
class LIVE_API RTSPServerWithREGISTERProxying: public RTSPServer {
public:
