...
class LIVE_API UsageEnvironment {
public:
  Boolean reclaim();
  ...
  virtual void prependToResultMsg(MsgString msg) = 0;
  ...
  virtual UsageEnvironment& operator<<(struct timeval tv) = 0;
