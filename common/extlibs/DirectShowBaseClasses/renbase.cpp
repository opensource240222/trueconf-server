...
void CBaseRenderer::DisplayRendererState()
{
    ...
    DbgLog((LOG_TIMING, 1, TEXT("Deliver time %s"),(LPCSTR)CDisp((LONGLONG)m_SignalTime)));
    ...
    DbgLog((LOG_TIMING, 1, TEXT("Last run time %s"),(LPCSTR)CDisp((LONGLONG)m_tStart.m_time)));
    ...
    DbgLog((LOG_TIMING, 1, TEXT("Clock time %s"),(LPCSTR)CDisp((LONGLONG)CurrentTime.m_time)));
