...
IPPAPI(IppStatus, ippiMorphologyBorderInit_16s_C1R,(IppiSize roiSize, const Ipp8u* pMask, IppiSize maskSize,
                                              IppiMorphState* pMorphSpec, Ipp8u* pBuffer))
IPPAPI(IppStatus, ippiMorphologyBorderInit_1u_C1R,( IppiSize roiSize, const Ipp8u* pMask, IppiSize maskSize,
                                              IppiMorphState* pMorphSpec, Ipp8u* pBuffer ))
...
IPPAPI(IppStatus, ippiDilateBorder_8u_C3R, (const Ipp8u* pSrc, int srcStep,
                                   Ipp8u* pDst, int dstStep, IppiSize roiSize,
                                   IppiBorderType borderType, const Ipp8u borderValue[3], const IppiMorphState* pMorphSpec, Ipp8u* pBuffer))
IPPAPI(IppStatus, ippiDilateBorder_8u_C4R, (const Ipp8u* pSrc, int srcStep,
                                   Ipp8u* pDst, int dstStep, IppiSize roiSize,
                                   IppiBorderType borderType, const Ipp8u borderValue[4], const IppiMorphState* pMorphSpec, Ipp8u* pBuffer))
...
IPPAPI(IppStatus, ippiDilateBorder_32f_C3R, (const Ipp32f* pSrc, int srcStep,
                                   Ipp32f* pDst, int dstStep, IppiSize roiSize,
                                   IppiBorderType borderType, const Ipp32f borderValue[3], const IppiMorphState* pMorphSpec, Ipp8u* pBuffer))
IPPAPI(IppStatus, ippiDilateBorder_32f_C4R, (const Ipp32f* pSrc, int srcStep,
                                   Ipp32f* pDst, int dstStep, IppiSize roiSize,
                                   IppiBorderType borderType, const Ipp32f borderValue[4], const IppiMorphState* pMorphSpec, Ipp8u* pBuffer))
...
IPPAPI( IppStatus, ippiMorphOpenBorder_8u_C3R,(
                const Ipp8u* pSrc, int srcStep, Ipp8u* pDst, int dstStep,
                IppiSize roiSize, IppiBorderType borderType, const Ipp8u borderValue[3], const IppiMorphAdvState* pMorthSpec, Ipp8u* pBuffer ))
IPPAPI( IppStatus, ippiMorphOpenBorder_8u_C4R,(
                const Ipp8u* pSrc, int srcStep, Ipp8u* pDst, int dstStep,
                IppiSize roiSize, IppiBorderType borderType, const Ipp8u borderValue[4], const IppiMorphAdvState* pMorthSpec, Ipp8u* pBuffer ))
...
IPPAPI( IppStatus, ippiMorphOpenBorder_32f_C3R,(
                const Ipp32f* pSrc, int srcStep, Ipp32f* pDst, int dstStep,
                IppiSize roiSize, IppiBorderType borderType, const Ipp32f borderValue[3], const IppiMorphAdvState* pMorthSpec, Ipp8u* pBuffer ))
IPPAPI( IppStatus, ippiMorphOpenBorder_32f_C4R,(
                const Ipp32f* pSrc, int srcStep, Ipp32f* pDst, int dstStep,
                IppiSize roiSize, IppiBorderType borderType, const Ipp32f borderValue[4], const IppiMorphAdvState* pMorthSpec, Ipp8u* pBuffer ))
...
IPPAPI( IppStatus, ippiMorphTophatBorder_32f_C1R,(
                const Ipp32f* pSrc, int srcStep, Ipp32f* pDst, int dstStep,
                IppiSize roiSize, IppiBorderType borderType, const Ipp32f borderValue, const IppiMorphAdvState* pMorthSpec, Ipp8u* pBuffer ))
