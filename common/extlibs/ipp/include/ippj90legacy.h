...
#if !defined(__IPPJ_90_LEGACY_H__)
#define __IPPJ_90_LEGACY_H__

#include "ippdefs90legacy.h"
#include "ippj90legacy_redef.h"
...
//              has to be working
*/
LEGACY90IPPAPI( IppStatus, legacy90ippjInit, ( void ))
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippjSetNumThreads, ( int numThr ) )
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippjGetNumThreads, (int* pNumThr) )
...
LEGACY90IPPAPI( const IppLibraryVersion*, legacy90ippjGetLibVersion, (void) )
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanRawTableInit_JPEG_8u, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanSpecGetBufSize_JPEG_8u, (
  int* size))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanSpecInit_JPEG_8u, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanSpecInitAlloc_JPEG_8u, (
  const Ipp8u*                  pListBits,
  const Ipp8u*                  pListVals,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanSpecFree_JPEG_8u, (
  IppiEncodeHuffmanSpec*  pEncHuffSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanStateGetBufSize_JPEG_8u, (
  int*  size))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanStateInit_JPEG_8u, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanStateInitAlloc_JPEG_8u, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanStateFree_JPEG_8u, (
  IppiEncodeHuffmanState*  pEncHuffState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffman8x8_JPEG_16s1u_C1, (
  const Ipp16s*                 pSrc,
        Ipp8u*                  pDst,
        int                     dstLenBytes,
        int*                    pDstCurrPos,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffman8x8_Direct_JPEG_16s1u_C1, (
  const Ipp16s*                 pSrc,
        Ipp8u*                  pDst,
        int*                    pDstBitsLen,
        Ipp16s*                 pLastDC,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetHuffmanStatistics8x8_JPEG_16s_C1, (
  const Ipp16s* pSrc,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetHuffmanStatistics8x8_DCFirst_JPEG_16s_C1, (
  const Ipp16s* pSrc,
        int     pDcStatistics[256],
        Ipp16s* pLastDC,
        int     Al))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetHuffmanStatistics8x8_ACFirst_JPEG_16s_C1, (
  const Ipp16s*                 pSrc,
        int                     pAcStatistics[256],
        int                     Ss,
        int                     Se,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetHuffmanStatistics8x8_ACRefine_JPEG_16s_C1, (
  const Ipp16s*                 pSrc,
        int                     pAcStatistics[256],
        int                     Ss,
        int                     Se,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffman8x8_DCFirst_JPEG_16s1u_C1, (
  const Ipp16s*                 pSrc,
        Ipp8u*                  pDst,
        int                     dstLenBytes,
        int*                    pDstCurrPos,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffman8x8_DCRefine_JPEG_16s1u_C1, (
  const Ipp16s*                 pSrc,
        Ipp8u*                  pDst,
        int                     dstLenBytes,
        int*                    pDstCurrPos,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffman8x8_ACFirst_JPEG_16s1u_C1, (
  const Ipp16s*                 pSrc,
        Ipp8u*                  pDst,
        int                     dstLenBytes,
        int*                    pDstCurrPos,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffman8x8_ACRefine_JPEG_16s1u_C1, (
  const Ipp16s*                 pSrc,
        Ipp8u*                  pDst,
        int                     dstLenBytes,
        int*                    pDstCurrPos,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanOne_JPEG_16s1u_C1, (
  const Ipp16s*                 pSrc,
        Ipp8u*                  pDst,
        int                     nDstLenBytes,
        int*                    pDstCurrPos,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeHuffmanRow_JPEG_16s1u_P4C1, (
  const Ipp16s*                 pSrc[4],
        int                     nSrcLen,
        int                     nSrcRows,
        Ipp8u*                  pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetHuffmanStatisticsOne_JPEG_16s_C1, (
  const Ipp16s* pSrc,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanSpecGetBufSize_JPEG_8u, (
  int*  size))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanSpecInit_JPEG_8u, (
  const Ipp8u*                  pListBits,
  const Ipp8u*                  pListVals,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanSpecInitAlloc_JPEG_8u, (
  const Ipp8u*                   pListBits,
  const Ipp8u*                   pListVals,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanSpecFree_JPEG_8u, (
  IppiDecodeHuffmanSpec*  pDecHuffSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanStateGetBufSize_JPEG_8u, (
  int*  size))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanStateInit_JPEG_8u, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanStateInitAlloc_JPEG_8u, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanStateFree_JPEG_8u, (
  IppiDecodeHuffmanState*  pDecHuffState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffman8x8_JPEG_1u16s_C1, (
  const Ipp8u*                  pSrc,
        int                     srcLenBytes,
        int*                    pSrcCurrPos,
        Ipp16s*                 pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffman8x8_Direct_JPEG_1u16s_C1, (
  const Ipp8u*                 pSrc,
        int*                   pSrcBitsLen,
        Ipp16s*                pDst,
        Ipp16s*                pLastDC,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffman8x8_DCFirst_JPEG_1u16s_C1, (
  const Ipp8u*                  pSrc,
        int                     srcLenBytes,
        int*                    pSrcCurrPos,
        Ipp16s*                 pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffman8x8_DCRefine_JPEG_1u16s_C1, (
  const Ipp8u*                   pSrc,
        int                      srcLenBytes,
        int*                     pSrcCurrPos,
        Ipp16s*                  pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffman8x8_ACFirst_JPEG_1u16s_C1, (
  const Ipp8u*                  pSrc,
        int                     srcLenBytes,
        int*                    pSrcCurrPos,
        Ipp16s*                 pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffman8x8_ACRefine_JPEG_1u16s_C1, (
  const Ipp8u*                  pSrc,
        int                     srcLenBytes,
        int*                    pSrcCurrPos,
        Ipp16s*                 pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanOne_JPEG_1u16s_C1, (
  const Ipp8u*                  pSrc,
        int                     nSrcLenBytes,
        int*                    pSrcCurrPos,
        Ipp16s*                 pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanRow_JPEG_1u16s_C1P4, (
  const Ipp8u*                  pSrc,
        int                     nSrcLenBytes,
        int*                    pSrcCurrPos,
        Ipp16s*                 pDst[4],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantFwdRawTableInit_JPEG_8u, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantFwdTableInit_JPEG_8u16u, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantFwd8x8_JPEG_16s_C1I, (
        Ipp16s* pSrcDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvTableInit_JPEG_8u16u, (
  const Ipp8u*  pQuantRawTable,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInv8x8_JPEG_16s_C1I, (
        Ipp16s* pSrcDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToY_JPEG_8u_P3C1R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToYCbCr_JPEG_8u_P3R, (
  const Ipp8u*   pSrcRGB[3],
        int      srcStep,
        Ipp8u*   pDstYCbCr[3],
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToY_JPEG_8u_C3C1R, (
  const Ipp8u*   pSrcRGB,
        int      srcStep,
        Ipp8u*   pDstY,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGRToY_JPEG_8u_C3C1R, (
  const Ipp8u*   pSrcBGR,
        int      srcStep,
        Ipp8u*   pDstY,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToYCbCr_JPEG_8u_C3P3R, (
  const Ipp8u*   pSrcRGB,
        int      srcStep,
        Ipp8u*   pDstYCbCr[3],
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGRToYCbCr_JPEG_8u_C3P3R, (
  const Ipp8u*   pSrcBGR,
        int      srcStep,
        Ipp8u*   pDstYCbCr[3],
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToYCbCr422_JPEG_8u_C3P3R,(
  const Ipp8u*   pRGB,
        int      srcStep,
        Ipp8u*   pYCbCr[3],
        int      dstStep[3],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGRToYCbCr422_JPEG_8u_C3P3R,(
  const Ipp8u*   pBGR,
        int      srcStep,
        Ipp8u*   pYCbCr[3],
        int      dstStep[3],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToYCbCr411_JPEG_8u_C3P3R,(
  const Ipp8u*   pRGB,
        int      srcStep,
        Ipp8u*   pYCbCr[3],
        int      dstStep[3],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGRToYCbCr411_JPEG_8u_C3P3R,(
  const Ipp8u*   pBGR,
        int      srcStep,
        Ipp8u*   pYCbCr[3],
        int      dstStep[3],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToYCbCr_JPEG_8u_C4P3R,(
  const Ipp8u*   pRGBA,
        int      srcStep,
        Ipp8u*   pYCbCr[3],
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGRToYCbCr_JPEG_8u_C4P3R,(
  const Ipp8u*   pBGRA,
        int      srcStep,
        Ipp8u*   pYCbCr[3],
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToYCbCr422_JPEG_8u_C4P3R,(
  const Ipp8u*   pRGBA,
        int      srcStep,
        Ipp8u*   pYCbCr[3],
        int      dstStep[3],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGRToYCbCr422_JPEG_8u_C4P3R,(
  const Ipp8u*   pBGRA,
        int      srcStep,
        Ipp8u*   pYCbCr[3],
        int      dstStep[3],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToYCbCr411_JPEG_8u_C4P3R,(
  const Ipp8u*   pRGBA,
        int      srcStep,
        Ipp8u*   pYCbCr[3],
        int      dstStep[3],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGRToYCbCr411_JPEG_8u_C4P3R,(
  const Ipp8u*   pBGRA,
        int      srcStep,
        Ipp8u*   pYCbCr[3],
        int      dstStep[3],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGB555ToYCbCr_JPEG_16u8u_C3P3R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGR555ToYCbCr_JPEG_16u8u_C3P3R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGB565ToYCbCr_JPEG_16u8u_C3P3R, (
  const Ipp16u*  pSrcRGB,
        int      srcStep,
        Ipp8u*   pDstYCbCr[3],
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGR565ToYCbCr_JPEG_16u8u_C3P3R, (
  const Ipp16u*  pSrc,
        int      srcStep,
        Ipp8u*   pDst[3],
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCMYKToYCCK_JPEG_8u_P4R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCMYKToYCCK_JPEG_8u_C4P4R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSub128_JPEG_8u16s_C1R, (
  const Ipp8u*   pSrc,
        int      srcStep,
        Ipp16s*  pDst,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiAdd128_JPEG_16s8u_C1R, (
  const Ipp16s*  pSrc,
        int      srcStep,
        Ipp8u*   pDst,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleDownH2V1_JPEG_8u_C1R, (
  const Ipp8u*   pSrc,
        int      srcStep,
        IppiSize srcRoiSize,
        Ipp8u*   pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleDownH2V2_JPEG_8u_C1R, (
  const Ipp8u*   pSrc,
        int      srcStep,
        IppiSize srcRoiSize,
        Ipp8u*   pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleDownRowH2V1_Box_JPEG_8u_C1, (
  const Ipp8u*   pSrc,
        int      srcWidth,
        Ipp8u*   pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleDownRowH2V2_Box_JPEG_8u_C1, (
  const Ipp8u*   pSrc1,
  const Ipp8u*   pSrc2,
        int      srcWidth,
        Ipp8u*   pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleUpH2V1_JPEG_8u_C1R, (
  const Ipp8u*   pSrc,
        int      srcStep,
        IppiSize srcRoiSize,
        Ipp8u*   pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleUpH2V2_JPEG_8u_C1R, (
  const Ipp8u*   pSrc,
        int      srcStep,
        IppiSize srcRoiSize,
        Ipp8u*   pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleUpRowH2V1_Triangle_JPEG_8u_C1, (
  const Ipp8u*   pSrc,
        int      srcWidth,
        Ipp8u*   pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleUpRowH2V2_Triangle_JPEG_8u_C1, (
  const Ipp8u*   pSrc1,
  const Ipp8u*   pSrc2,
        int      srcWidth,
        Ipp8u*   pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToYCbCr444LS_MCU_8u16s_C3P3R, (
  const Ipp8u*  pSrcRGB,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToYCbCr422LS_MCU_8u16s_C3P3R, (
  const Ipp8u*  pSrcRGB,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRGBToYCbCr411LS_MCU_8u16s_C3P3R, (
  const Ipp8u*  pSrcRGB,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGRToYCbCr444LS_MCU_8u16s_C3P3R, (
  const Ipp8u*  pSrcBGR,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGRToYCbCr422LS_MCU_8u16s_C3P3R, (
  const Ipp8u*  pSrcBGR,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGRToYCbCr411LS_MCU_8u16s_C3P3R, (
  const Ipp8u*  pSrcBGR,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleDown444LS_MCU_8u16s_C3P3R, (
  const Ipp8u*  pSrc,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleDown422LS_MCU_8u16s_C3P3R, (
  const Ipp8u*  pSrc,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleDown411LS_MCU_8u16s_C3P3R, (
  const Ipp8u*  pSrc,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSplit422LS_MCU_8u16s_C2P3R,(
  const Ipp8u*  pSrc,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCMYKToYCCK444LS_MCU_8u16s_C4P4R, (
  const Ipp8u*  pSrcCMYK,
        int     srcStep,
        Ipp16s* pDstYCCK[4]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCMYKToYCCK422LS_MCU_8u16s_C4P4R, (
  const Ipp8u*  pSrcCMYK,
        int     srcStep,
        Ipp16s* pDstYCCK[4]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCMYKToYCCK411LS_MCU_8u16s_C4P4R, (
  const Ipp8u*  pSrcCMYK,
        int     srcStep,
        Ipp16s* pDstYCCK[4]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBGR555ToYCbCr444LS_MCU_16u16s_C3P3R, (
  const Ipp16u* pSrcBGR,
        int     srcStep,
        Ipp16s* pDstMCU[3]))


LEGACY90IPPAPI(IppStatus, legacy90ippiBGR555ToYCbCr422LS_MCU_16u16s_C3P3R, (
  const Ipp16u* pSrcBGR,
        int     srcStep,
        Ipp16s* pDstMCU[3]))


LEGACY90IPPAPI(IppStatus, legacy90ippiBGR555ToYCbCr411LS_MCU_16u16s_C3P3R, (
  const Ipp16u* pSrcBGR,
        int     srcStep,
        Ipp16s* pDstMCU[3]))


LEGACY90IPPAPI(IppStatus, legacy90ippiBGR565ToYCbCr444LS_MCU_16u16s_C3P3R, (
  const Ipp16u* pSrcBGR,
        int     srcStep,
        Ipp16s* pDstMCU[3]))


LEGACY90IPPAPI(IppStatus, legacy90ippiBGR565ToYCbCr422LS_MCU_16u16s_C3P3R, (
  const Ipp16u* pSrcBGR,
        int     srcStep,
        Ipp16s* pDstMCU[3]))


LEGACY90IPPAPI(IppStatus, legacy90ippiBGR565ToYCbCr411LS_MCU_16u16s_C3P3R, (
  const Ipp16u* pSrcBGR,
        int     srcStep,
        Ipp16s* pDstMCU[3]))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCrToRGB_JPEG_8u_P3R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCrToRGB_JPEG_8u_P3C3R, (
  const Ipp8u*   pSrcYCbCr[3],
        int      srcStep,
        Ipp8u*   pDstRGB,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCrToBGR_JPEG_8u_P3C3R, (
  const Ipp8u*   pSrcYCbCr[3],
        int      srcStep,
        Ipp8u*   pDstBGR,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr422ToRGB_JPEG_8u_P3C3R,(
  const Ipp8u*   pSrcYCbCr[3],
        int      srcStep[3],
        Ipp8u*   pDstRGB,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr422ToBGR_JPEG_8u_P3C3R,(
  const Ipp8u*   pSrcYCbCr[3],
        int      srcStep[3],
        Ipp8u*   pDstBGR,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr411ToRGB_JPEG_8u_P3C3R,(
  const Ipp8u*   pSrcYCbCr[3],
        int      srcStep[3],
        Ipp8u*   pDstRGB,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr411ToBGR_JPEG_8u_P3C3R,(
  const Ipp8u*   pSrcYCbCr[3],
        int      srcStep[3],
        Ipp8u*   pDstBGR,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCrToRGB_JPEG_8u_P3C4R,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCrToBGR_JPEG_8u_P3C4R,(
  const Ipp8u*   pYCbCr[3],
        int      srcStep,
        Ipp8u*   pBGR,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr422ToRGB_JPEG_8u_P3C4R,(
  const Ipp8u*   pYCbCr[3],
        int      srcStep[3],
        Ipp8u*   pRGB,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr422ToBGR_JPEG_8u_P3C4R,(
  const Ipp8u*   pYCbCr[3],
        int      srcStep[3],
        Ipp8u*   pBGR,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr411ToRGB_JPEG_8u_P3C4R,(
  const Ipp8u*   pYCbCr[3],
        int      srcStep[3],
        Ipp8u*   pRGB,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr411ToBGR_JPEG_8u_P3C4R,(
  const Ipp8u*   pYCbCr[3],
        int      srcStep[3],
        Ipp8u*   pBGR,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr422ToRGB_JPEG_8u_C2C3R, (
  const Ipp8u*   pSrc,
        int      srcStep,
        Ipp8u*   pDst,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCrToRGB555_JPEG_8u16u_P3C3R, (
  const Ipp8u*   pSrcYCbCr[3],
        int      srcStep,
        Ipp16u*  pDstRGB,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCrToBGR555_JPEG_8u16u_P3C3R, (
  const Ipp8u*   pSrcYCbCr[3],
        int      srcStep,
        Ipp16u*  pDstBGR,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCrToRGB565_JPEG_8u16u_P3C3R, (
  const Ipp8u*   pSrcYCbCr[3],
        int      srcStep,
        Ipp16u*  pDstRGB,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCrToBGR565_JPEG_8u16u_P3C3R, (
  const Ipp8u*   pSrcYCbCr[3],
        int      srcStep,
        Ipp16u*  pDstBGR,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCCKToCMYK_JPEG_8u_P4R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCCKToCMYK_JPEG_8u_P4C4R, (
  const Ipp8u*   pSrcYCCK[4],
        int      srcStep,
        Ipp8u*   pDstCMYK,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr444ToRGBLS_MCU_16s8u_P3C3R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr422ToRGBLS_MCU_16s8u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp8u*  pDstRGB,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr411ToRGBLS_MCU_16s8u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp8u*  pDstRGB,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr444ToBGRLS_MCU_16s8u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp8u*  pDstBGR,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr422ToBGRLS_MCU_16s8u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp8u*  pDstBGR,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr411ToBGRLS_MCU_16s8u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp8u*  pDstBGR,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr444ToBGR555LS_MCU_16s16u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp16u* pDstBGR,
        int     dstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr422ToBGR555LS_MCU_16s16u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp16u* pDstBGR,
        int     dstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr411ToBGR555LS_MCU_16s16u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp16u* pDstBGR,
        int     dstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr444ToBGR565LS_MCU_16s16u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp16u* pDstBGR,
        int     dstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr422ToBGR565LS_MCU_16s16u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp16u* pDstBGR,
        int     dstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiYCbCr411ToBGR565LS_MCU_16s16u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp16u* pDstBGR,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleUp444LS_MCU_16s8u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp8u*  pDst,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleUp422LS_MCU_16s8u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp8u*  pDst,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSampleUp411LS_MCU_16s8u_P3C3R, (
  const Ipp16s* pSrcMCU[3],
        Ipp8u*  pDst,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiJoin422LS_MCU_16s8u_P3C2R, (
  const Ipp16s* pSrcMCU[3],
        Ipp8u*  pDst,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCCK444ToCMYKLS_MCU_16s8u_P4C4R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCCK422ToCMYKLS_MCU_16s8u_P4C4R, (
  const Ipp16s* pSrcMCU[4],
        Ipp8u*  pDstCMYK,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCCK411ToCMYKLS_MCU_16s8u_P4C4R, (
  const Ipp16s* pSrcMCU[4],
        Ipp8u*  pDstCMYK,
        int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantFwd8x8LS_JPEG_8u16s_C1R, (
  const Ipp8u*  pSrc,
        int     srcStep,
        Ipp16s* pDst,
  const Ipp16u* pQuantFwdTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantFwd8x8LS_JPEG_16u16s_C1R, (
  const Ipp16u* pSrc,
        int     srcStep,
        Ipp16s* pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantFwd8x8_JPEG_16s_C1, (
  const Ipp16s* pSrc,
        Ipp16s* pDst,
  const Ipp16u* pQuantFwdTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantFwd8x8_JPEG_16s_C1I, (
        Ipp16s* pSrcDst,
  const Ipp16u* pQuantFwdTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantInv8x8LS_JPEG_16s8u_C1R, (
  const Ipp16s* pSrc,
        Ipp8u*  pDst,
        int     dstStep,
  const Ipp16u* pQuantInvTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantInv8x8LS_4x4_JPEG_16s8u_C1R,(
  const Ipp16s* pSrc,
        Ipp8u*  pDst,
        int     dstStep,
  const Ipp16u* pQuantInvTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantInv8x8LS_2x2_JPEG_16s8u_C1R,(
  const Ipp16s* pSrc,
        Ipp8u*  pDst,
        int     dstStep,
  const Ipp16u* pQuantInvTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantInv8x8LS_1x1_JPEG_16s8u_C1R,(
  const Ipp16s* pSrc,
        Ipp8u*  pDst,
        int     dstStep,
  const Ipp16u* pQuantInvTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantInv8x8To4x4LS_JPEG_16s8u_C1R,(
  const Ipp16s* pSrc,
        Ipp8u*  pDst,
        int     dstStep,
  const Ipp16u* pQuantInvTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantInv8x8To2x2LS_JPEG_16s8u_C1R,(
  const Ipp16s* pSrc,
        Ipp8u*  pDst,
        int     dstStep,
  const Ipp16u* pQuantInvTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantInv8x8LS_JPEG_16s16u_C1R, (
  const Ipp16s* pSrc,
        Ipp16u* pDst,
        int     dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantInv8x8_JPEG_16s_C1, (
  const Ipp16s* pSrc,
        Ipp16s* pDst,
  const Ipp16u* pQuantInvTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCTQuantInv8x8_JPEG_16s_C1I, (
        Ipp16s* pSrcDst,
  const Ipp16u* pQuantInvTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDiffPredFirstRow_JPEG_16s_C1, (
  const Ipp16s*  pSrc,
        Ipp16s*  pDst,
        int      width,
        int      P,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDiffPredRow_JPEG_16s_C1, (
  const Ipp16s*  pSrc,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructPredFirstRow_JPEG_16s_C1, (
  const Ipp16s*  pSrc,
        Ipp16s*  pDst,
        int      width,
        int      P,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructPredRow_JPEG_16s_C1, (
  const Ipp16s*  pSrc,
  const Ipp16s*  pPrevRow,
        Ipp16s*  pDst,
        int      width,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdRow_B53_JPEG2K_16s_C1R, (
  const Ipp16s*           pSrc,
        int               srcStep,
        Ipp16s*           pDstLow,
        int               dstLowStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdRow_B53_JPEG2K_32s_C1R, (
  const Ipp32s*           pSrc,
        int               srcStep,
        Ipp32s*           pDstLow,
        int               dstLowStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdCol_B53_JPEG2K_16s_C1R, (
  const Ipp16s*           pSrc,
        int               srcStep,
        Ipp16s*           pDstLow,
        int               dstLowStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdCol_B53_JPEG2K_32s_C1R, (
  const Ipp32s*           pSrc,
        int               srcStep,
        Ipp32s*           pDstLow,
        int               dstLowStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdColLift_B53_JPEG2K_16s_C1, (
  const Ipp16s* pSrc0,
  const Ipp16s* pSrc1,
  const Ipp16s* pSrc2,
        Ipp16s* pDstLow0,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdColLift_B53_JPEG2K_32s_C1, (
  const Ipp32s* pSrc0,
  const Ipp32s* pSrc1,
  const Ipp32s* pSrc2,
        Ipp32s* pDstLow0,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvRow_B53_JPEG2K_16s_C1R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvRow_B53_JPEG2K_32s_C1R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvCol_B53_JPEG2K_16s_C1R, (
  const Ipp16s*           pSrcLow,
        int               srcLowStep,
  const Ipp16s*           pSrcHigh,
        int               srcHighStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvCol_B53_JPEG2K_32s_C1R, (
  const Ipp32s*           pSrcLow,
        int               srcLowStep,
  const Ipp32s*           pSrcHigh,
        int               srcHighStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvColLift_B53_JPEG2K_16s_C1, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvColLift_B53_JPEG2K_32s_C1, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdRow_D97_JPEG2K_16s_C1R, (
  const Ipp16s*           pSrc,
        int               srcStep,
        Ipp16s*           pDstLow,
        int               dstLowStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdRow_D97_JPEG2K_32s_C1R, (
  const Ipp32s*           pSrc,
        int               srcStep,
        Ipp32s*           pDstLow,
        int               dstLowStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdRow_D97_JPEG2K_32f_C1R, (
  const Ipp32f*           pSrc,
        int               srcStep,
        Ipp32f*           pDstLow,
        int               dstLowStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdCol_D97_JPEG2K_32f_C1R, (
  const Ipp32f*           pSrc,
        int               srcStep,
        Ipp32f*           pDstLow,
        int               dstLowStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdColLift_D97_JPEG2K_16s_C1, (
  const Ipp16s* pSrc0,
  const Ipp16s* pSrc1,
  const Ipp16s* pSrc2,
        Ipp16s* pSrcDstLow0,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdColLift_D97_JPEG2K_32s_C1, (
  const Ipp32s* pSrc0,
  const Ipp32s* pSrc1,
  const Ipp32s* pSrc2,
        Ipp32s* pSrcDstLow0,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwdColLift_D97_JPEG2K_32f_C1, (
  const Ipp32f* pSrc0,
  const Ipp32f* pSrc1,
  const Ipp32f* pSrc2,
        Ipp32f* pSrcDstLow0,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvRow_D97_JPEG2K_16s_C1R, (
  const Ipp16s*           pSrcLow,
        int               srcLowStep,
  const Ipp16s*           pSrcHigh,
        int               srcHighStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvRow_D97_JPEG2K_32s_C1R, (
  const Ipp32s*           pSrcLow,
        int               srcLowStep,
  const Ipp32s*           pSrcHigh,
        int               srcHighStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvRow_D97_JPEG2K_32f_C1R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvCol_D97_JPEG2K_32f_C1R, (
  const Ipp32f*           pSrcLow,
        int               srcLowStep,
  const Ipp32f*           pSrcHigh,
        int               srcHighStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvColLift_D97_JPEG2K_16s_C1, (
  const Ipp16s* pSrcLow0,
  const Ipp16s* pSrcHigh0,
  const Ipp16s* pSrcHigh1,
  const Ipp16s* pSrc0,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvColLift_D97_JPEG2K_32s_C1, (
  const Ipp32s* pSrcLow0,
  const Ipp32s* pSrcHigh0,
  const Ipp32s* pSrcHigh1,
  const Ipp32s* pSrc0,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInvColLift_D97_JPEG2K_32f_C1, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTGetBufSize_B53_JPEG2K_16s_C1IR, (
  const IppiRect* pTileRect,
        int*      pSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiWTGetBufSize_B53_JPEG2K_32s_C1IR, (
  const IppiRect* pTileRect,
        int*      pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwd_B53_JPEG2K_16s_C1IR, (
        Ipp16s*   pSrcDstTile,
        int       srcDstStep,
  const IppiRect* pTileRect,
        Ipp8u*    pBuffer))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwd_B53_JPEG2K_32s_C1IR, (
        Ipp32s*   pSrcDstTile,
        int       srcDstStep,
  const IppiRect* pTileRect,
        Ipp8u*    pBuffer))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInv_B53_JPEG2K_16s_C1IR, (
        Ipp16s*   pSrcDstTile,
        int       srcDstStep,
  const IppiRect* pTileRect,
        Ipp8u*    pBuffer))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInv_B53_JPEG2K_32s_C1IR, (
        Ipp32s*   pSrcDstTile,
        int       srcDstStep,
  const IppiRect* pTileRect,
        Ipp8u*    pBuffer))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTGetBufSize_D97_JPEG2K_16s_C1IR, (
  const IppiRect* pTileRect,
        int*      pSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiWTGetBufSize_D97_JPEG2K_32s_C1IR, (
  const IppiRect* pTileRect,
        int*      pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwd_D97_JPEG2K_16s_C1IR, (
        Ipp16s*   pSrcDstTile,
        int       srcDstStep,
  const IppiRect* pTileRect,
        Ipp8u*    pBuffer))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwd_D97_JPEG2K_32s_C1IR, (
        Ipp32s*   pSrcDstTile,
        int       srcDstStep,
  const IppiRect* pTileRect,
        Ipp8u*    pBuffer))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInv_D97_JPEG2K_16s_C1IR, (
        Ipp16s*   pSrcDstTile,
        int       srcDstStep,
  const IppiRect* pTileRect,
        Ipp8u*    pBuffer))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInv_D97_JPEG2K_32s_C1IR, (
        Ipp32s*   pSrcDstTile,
        int       srcDstStep,
  const IppiRect* pTileRect,
        Ipp8u*    pBuffer))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTGetBufSize_B53_JPEG2K_16s_C1R, (
  const IppiRect* pTileRect,
        int*      pSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiWTGetBufSize_B53_JPEG2K_32s_C1R, (
  const IppiRect* pTileRect,
        int*      pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwd_B53_JPEG2K_16s_C1R, (
  const Ipp16s*   pSrc,
        int       srcStep,
  const IppiRect* pTileRect,
        Ipp16s*   pDst[4],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwd_B53_JPEG2K_32s_C1R, (
  const Ipp32s*   pSrc,
        int       srcStep,
  const IppiRect* pTileRect,
        Ipp32s*   pDst[4],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInv_B53_JPEG2K_16s_C1R, (
  const Ipp16s*   pSrc[4],
        int       srcStep[4],
        Ipp16s*   pDst,
        int       dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInv_B53_JPEG2K_32s_C1R, (
  const Ipp32s*   pSrc[4],
        int       srcStep[4],
        Ipp32s*   pDst,
        int       dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTGetBufSize_D97_JPEG2K_16s_C1R, (
  const IppiRect* pTileRect,
        int*      pSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiWTGetBufSize_D97_JPEG2K_32s_C1R, (
  const IppiRect* pTileRect,
        int*      pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwd_D97_JPEG2K_16s_C1R, (
  const Ipp16s*   pSrc,
        int       srcStep,
  const IppiRect* pTileRect,
        Ipp16s*   pDst[4],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTFwd_D97_JPEG2K_32s_C1R, (
  const Ipp32s*   pSrc,
        int       srcStep,
  const IppiRect* pTileRect,
        Ipp32s*   pDst[4],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInv_D97_JPEG2K_16s_C1R, (
  const Ipp16s*   pSrc[4],
        int       srcStep[4],
        Ipp16s*   pDst,
        int       dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWTInv_D97_JPEG2K_32s_C1R, (
  const Ipp32s*   pSrc[4],
        int       srcStep[4],
        Ipp32s*   pDst,
        int       dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeInitAlloc_JPEG2K, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeFree_JPEG2K, (
  IppiEncodeState_JPEG2K* pState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeLoadCodeBlock_JPEG2K_32s_C1R, (
  const Ipp32s*                 pSrc,
        int                     srcStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeStoreBits_JPEG2K_1u, (
  Ipp8u*                  pDst,
  int*                    pDstLen,
  IppiEncodeState_JPEG2K* pState,
  int*                    pIsNotFinish))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeGetTermPassLen_JPEG2K, (
  IppiEncodeState_JPEG2K* pState,
  int                     passNumber,
  int*                    pPassLen))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeGetRate_JPEG2K, (
  IppiEncodeState_JPEG2K* pState,
  int                     passNumber,
  int*                    pRate))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeGetDist_JPEG2K, (
  IppiEncodeState_JPEG2K* pState,
  int                     passNumber,
  Ipp64f*                 pDist))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCBProgrGetStateSize_JPEG2K, (
  IppiSize  codeBlockMaxSize,
  int      *pStateSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCBProgrInit_JPEG2K, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCBProgrInitAlloc_JPEG2K, (
  IppiDecodeCBProgrState_JPEG2K **pState,
  IppiSize                        codeBlockMaxSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCBProgrFree_JPEG2K, (
  IppiDecodeCBProgrState_JPEG2K *pState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCBProgrAttach_JPEG2K_32s_C1R, (
  Ipp32s                        *pDst,
  int                            dstStep,
  IppiSize                       codeBlockSize,
  IppiDecodeCBProgrState_JPEG2K *pState,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCBProgrSetPassCounter_JPEG2K, (
  int                            nOfPasses,
  IppiDecodeCBProgrState_JPEG2K *pState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCBProgrGetPassCounter_JPEG2K, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCBProgrGetCurBitPlaneNum_JPEG2K, (
  IppiDecodeCBProgrState_JPEG2K *pState,
  int                           *pBitPlaneNum))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCBProgrStep_JPEG2K, (
  const Ipp8u*                         pSrc,
        int                            srcLen,
        IppiDecodeCBProgrState_JPEG2K* pState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeGetBufSize_JPEG2K, (
  IppiSize  codeBlockMaxSize,
  int*      pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCodeBlock_JPEG2K_1u32s_C1R, (
  const Ipp8u*         pSrc,
        Ipp32s*        pDst,
        int            dstStep,
        IppiSize       codeBlockSize,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRCTFwd_JPEG2K_16s_C3P3R, (
  const Ipp16s*  pSrc,
        int      srcStep,
        Ipp16s*  pDst[3],
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRCTFwd_JPEG2K_32s_C3P3R, (
  const Ipp32s*  pSrc,
        int      srcStep,
        Ipp32s*  pDst[3],
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRCTFwd_JPEG2K_16s_P3IR, (
  Ipp16s*  pSrcDst[3],
  int      srcDstStep,
  IppiSize roiSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiRCTFwd_JPEG2K_32s_P3IR, (
  Ipp32s*  pSrcDst[3],
  int      srcDstStep,
  IppiSize roiSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRCTInv_JPEG2K_16s_P3C3R, (
  const Ipp16s*  pSrc[3],
        int      srcStep,
        Ipp16s*  pDst,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRCTInv_JPEG2K_32s_P3C3R, (
  const Ipp32s*  pSrc[3],
        int      srcStep,
        Ipp32s*  pDst,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRCTInv_JPEG2K_16s_P3IR, (
  Ipp16s*  pSrcDst[3],
  int      srcDstStep,
  IppiSize roiSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiRCTInv_JPEG2K_32s_P3IR, (
  Ipp32s*  pSrcDst[3],
  int      srcDstStep,
  IppiSize roiSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiICTFwd_JPEG2K_32f_C3P3R, (
  const Ipp32f*  pSrc,
        int      srcStep,
        Ipp32f*  pDst[3],
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiICTFwd_JPEG2K_16s_P3IR, (
  Ipp16s*  pSrcDst[3],
  int      srcDstStep,
  IppiSize roiSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiICTFwd_JPEG2K_32s_P3IR, (
  Ipp32s*  pSrcDst[3],
  int      srcDstStep,
  IppiSize roiSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiICTFwd_JPEG2K_32f_P3IR, (
  Ipp32f*  pSrcDst[3],
  int      srcDstStep,
  IppiSize roiSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiICTInv_JPEG2K_32f_P3C3R, (
  const Ipp32f*  pSrc[3],
        int      srcStep,
        Ipp32f*  pDst,
        int      dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiICTInv_JPEG2K_16s_P3IR, (
  Ipp16s*  pSrcDst[3],
  int      srcDstStep,
  IppiSize roiSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiICTInv_JPEG2K_32s_P3IR, (
  Ipp32s*  pSrcDst[3],
  int      srcDstStep,
  IppiSize roiSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiICTInv_JPEG2K_32f_P3IR, (
  Ipp32f*  pSrcDst[3],
  int      srcDstStep,
  IppiSize roiSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiPackBitsRow_TIFF_8u_C1,(
  const Ipp8u* pSrc,
        int    srcLenBytes,
        Ipp8u* pDst,
        int*   pDstCurrPos,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiUnpackBitsRow_TIFF_8u_C1,(
  const Ipp8u* pSrc,
        int*   pSrcCurrPos,
        int    srcLenBytes,
        Ipp8u* pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSplitRow_TIFF_16u8u_C1,(
  const Ipp16u* pSrc,
        Ipp8u*  pDst[2],
        int     dstLen))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiJoinRow_TIFF_8u16u_C1,(
  const Ipp8u*  pSrc[2],
        Ipp16u* pDst,
        int     dstLen))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd16x16_JPEGXR_16s_C1IR,(
  Ipp16s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd16x16_JPEGXR_32s_C1IR,(
  Ipp32s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd16x16_JPEGXR_32f_C1IR,(
  Ipp32f* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd8x16_JPEGXR_16s_C1IR,(
  Ipp16s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd8x16_JPEGXR_32s_C1IR,(
  Ipp32s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd8x16_JPEGXR_32f_C1IR,(
  Ipp32f* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd8x8_JPEGXR_16s_C1IR,(
  Ipp16s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd8x8_JPEGXR_32s_C1IR,(
  Ipp32s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd8x8_JPEGXR_32f_C1IR,(
  Ipp32f* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd_JPEGXR_16s_C1IR,(
  Ipp16s*  pSrcDst,
  Ipp32u   srcDstStep,
  IppiSize roiSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd_JPEGXR_32s_C1IR,(
  Ipp32s*  pSrcDst,
  Ipp32u   srcDstStep,
  IppiSize roiSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTFwd_JPEGXR_32f_C1IR,(
  Ipp32f*  pSrcDst,
  Ipp32u   srcDstStep,
  IppiSize roiSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv16x16_JPEGXR_16s_C1IR,(
  Ipp16s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv16x16_JPEGXR_32s_C1IR,(
  Ipp32s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv16x16_JPEGXR_32f_C1IR,(
  Ipp32f* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv8x16_JPEGXR_16s_C1IR,(
  Ipp16s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv8x16_JPEGXR_32s_C1IR,(
  Ipp32s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv8x16_JPEGXR_32f_C1IR,(
  Ipp32f* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv8x8_JPEGXR_16s_C1IR,(
  Ipp16s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv8x8_JPEGXR_32s_C1IR,(
  Ipp32s* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv8x8_JPEGXR_32f_C1IR,(
  Ipp32f* pSrcDst,
  Ipp32u  srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv_JPEGXR_16s_C1IR,(
  Ipp16s*  pSrcDst,
  Ipp32u   srcDstStep,
  IppiSize roiSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv_JPEGXR_32s_C1IR,(
  Ipp32s*  pSrcDst,
  Ipp32u   srcDstStep,
  IppiSize roiSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiPCTInv_JPEGXR_32f_C1IR,(
  Ipp32f*  pSrcDst,
  Ipp32u   srcDstStep,
  IppiSize roiSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCAdapt_JPEGXR,(
  IppiVLCState_JPEGXR* pVLCState,
  IppiVLCAdaptType     adaptType))


LEGACY90IPPAPI(IppStatus, legacy90ippiVLCScanReset_JPEGXR,(
  IppiVLCState_JPEGXR* pVLCState,
  IppiVLCScanType      scanType))


LEGACY90IPPAPI(IppStatus, legacy90ippiVLCScanSet_JPEGXR,(
  IppiVLCState_JPEGXR* pVLCState,
  IppiVLCScanType      scanType))


LEGACY90IPPAPI(IppStatus, legacy90ippiVLCInit_JPEGXR,(
  IppiVLCState_JPEGXR* pVLCState))


LEGACY90IPPAPI(IppStatus, legacy90ippiVLCGetStateSize_JPEGXR,(int* pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCScan4x4DC_JPEGXR_32s,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCEncode4x4Flex_JPEGXR_16s1u_C1R,(
  const Ipp16s*              pSrc,
        Ipp32u               srcStep,
        IppBool              chroma,
        Ipp32u               numModelBits,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCEncode4x4Flex_JPEGXR_32s1u_C1R,(
  const Ipp32s*              pSrc,
        Ipp32u               srcStep,
        IppBool              chroma,
        Ipp32u               numModelBits,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCEncode4x4_JPEGXR_16s1u_C1R,(
  const Ipp16s*              pSrc,
        Ipp32u               srcStep,
        IppBool              chroma,
        Ipp32u               numModelBits,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCEncode4x4_JPEGXR_32s1u_C1R,(
  const Ipp32s*              pSrc,
        Ipp32u               srcStep,
        IppBool              chroma,
        Ipp32u               numModelBits,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCEncodeDC444_JPEGXR_32s1u,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCEncodeDC422_JPEGXR_32s1u,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCEncodeDC420_JPEGXR_32s1u,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCDecode4x4_JPEGXR_1u16s_C1R,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCDecode4x4_JPEGXR_1u32s_C1R,(
  const Ipp8u**              ppBitStream,
        Ipp32u*              pBitsBuf,
        Ipp32u*              pNumBits,
        Ipp32s               dequantMult,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCDecodeDC444_JPEGXR_1u32s,(
  const Ipp8u**              ppBitStream,
        Ipp32u*              pBitsBuf,
        Ipp32u*              pNumBits,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCDecodeDC422_JPEGXR_1u32s,(
  const Ipp8u**              ppBitStream,
        Ipp32u*              pBitsBuf,
        Ipp32u*              pNumBits,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVLCDecodeDC420_JPEGXR_1u32s,(
  const Ipp8u**              ppBitStream,
        Ipp32u*              pBitsBuf,
        Ipp32u*              pNumBits,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFLCEncode4x4_JPEGXR_16s1u_C1R,(
  const Ipp16s* pSrc,
        Ipp32u  srcStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFLCEncode4x4_JPEGXR_32s1u_C1R,(
  const Ipp32s* pSrc,
        Ipp32u  srcStep,
  const Ipp32s* pSrcResidual,
        Ipp8u** ppBitStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFLCDecode4x4_JPEGXR_1u16s_C1IR,(
  const Ipp8u** ppBitStream,
        Ipp32u* pBitsBuf,
        Ipp32u* pNumBits,
        Ipp16s* pSrcDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFLCDecode4x4_JPEGXR_1u32s_C1IR,(
  const Ipp8u** ppBitStream,
        Ipp32u* pBitsBuf,
        Ipp32u* pNumBits,
        Ipp32s* pSrcDst,
