...
#if !defined(__IPPSC_90_LEGACY_H__)
#define __IPPSC_90_LEGACY_H__

#include "ippdefs90legacy.h"
#include "ippsc90legacy_redef.h"
...
//              has to be working
*/
LEGACY90IPPAPI( IppStatus, legacy90ippscInit, ( void ))
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippscSetNumThreads, ( int numThr ) )
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippscGetNumThreads, (int* pNumThr) )
...
*/
LEGACY90IPPAPI( const IppLibraryVersion*, legacy90ippscGetLibVersion, (void) )
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsHighPassFilterSize_G729, (int *pSize) )
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsHighPassFilterInit_G729, (const Ipp16s *pCoeff, char* pMem) )
/* /////////////////////////////////////////////////////////////////////////////
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsHighPassFilter_G729_16s_ISfs, (Ipp16s* pSrcDst, int len, int scaleFactor,
        char* pMem) )
LEGACY90IPPAPI( IppStatus, legacy90ippsHighPassFilter_G723_16s, (const Ipp16s* pSrc, Ipp16s* pDst, int* pMem) )
/* /////////////////////////////////////////////////////////////////////////////
//  Name:        ippsMul
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsMul_NR_16s_Sfs, (const Ipp16s*  pSrc1, const Ipp16s*  pSrc2,
       Ipp16s*  pDst, int len, int scaleFactor) )
LEGACY90IPPAPI( IppStatus, legacy90ippsMul_NR_16s_ISfs, (const Ipp16s*  pSrc, Ipp16s*  pSrcDst,
       int len, int scaleFactor) )
LEGACY90IPPAPI( IppStatus, legacy90ippsMulC_NR_16s_ISfs, (Ipp16s  val, Ipp16s*  pSrcDst, int len, int scaleFactor) )
LEGACY90IPPAPI( IppStatus, legacy90ippsMulC_NR_16s_Sfs, ( const Ipp16s* pSrc, Ipp16s val, Ipp16s* pDst,
       int len, int scaleFactor) )
/* /////////////////////////////////////////////////////////////////////////////
//  Name:        ippsMulPowerC
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsMulPowerC_NR_16s_Sfs, (const Ipp16s*  pSrc, Ipp16s  val, Ipp16s*  pDst,
       int len, int scaleFactor) )
/* /////////////////////////////////////////////////////////////////////////////
//  Name:        ippsInvSqrt
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsInvSqrt_32s_I, (Ipp32s *pSrcDst, int len ) )
/* /////////////////////////////////////////////////////////////////////////////
//  Name:        ippsAutoScale
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsAutoScale_16s, (const Ipp16s *pSrc,  Ipp16s *pDst, int Len , int *pScale) )
LEGACY90IPPAPI( IppStatus, legacy90ippsAutoScale_16s_I, ( Ipp16s *pSrcDst, int Len , int *pScale) )
/* /////////////////////////////////////////////////////////////////////////////
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsAutoCorrLagMax_Fwd_16s, (const Ipp16s *pSrc, int len, int lowerLag,
       int upperLag, Ipp32s *pMax, int *maxLag ) )
LEGACY90IPPAPI( IppStatus, legacy90ippsAutoCorrLagMax_Inv_16s, (const Ipp16s *pSrc, int len, int lowerLag,
       int upperLag, Ipp32s *pMax, int *maxLag ) )
LEGACY90IPPAPI( IppStatus, legacy90ippsAutoCorrLagMax_32f,(const Ipp32f *pSrc, int len, int lowerLag,
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsAutoCorr_16s32s,
       (const Ipp16s *pSrc, int srcLen, Ipp32s *pDst, int dstLen ))
LEGACY90IPPAPI( IppStatus, legacy90ippsAutoCorr_NormE_16s32s, (const Ipp16s *pSrc, int len, Ipp32s *pDst,
       int lenDst, int *pNorm) )
LEGACY90IPPAPI( IppStatus, legacy90ippsAutoCorr_NormE_NR_16s, (const Ipp16s *pSrc, int len, Ipp16s *pDst,
       int lenDst, int *pNorm) )
LEGACY90IPPAPI( IppStatus, legacy90ippsAutoCorr_NormE_G723_16s, (const Ipp16s *pSrc, Ipp16s *pDst, int *pNorm) )
/* /////////////////////////////////////////////////////////////////////////////
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsToeplizMatrix_G729_16s32s,(const Ipp16s *pSrcImpulseResponse, Ipp32s *pDstMatrix))
LEGACY90IPPAPI( IppStatus, legacy90ippsToeplizMatrix_G729_16s,   (const Ipp16s *pSrcImpulseResponse, Ipp16s *pDstMatrix))
LEGACY90IPPAPI( IppStatus, legacy90ippsToeplizMatrix_G723_16s32s,(const Ipp16s *pSrcImpulseResponse, Ipp32s *pDstMatrix))
LEGACY90IPPAPI( IppStatus, legacy90ippsToeplizMatrix_G723_16s,   (const Ipp16s *pSrcImpulseResponse, Ipp16s *pDstMatrix))
LEGACY90IPPAPI( IppStatus, legacy90ippsToeplizMatrix_G729_32f,   (const Ipp32f *pSrcImpulseResponse, Ipp32f *pDstMatrix))
LEGACY90IPPAPI( IppStatus, legacy90ippsToeplizMatrix_G729D_32f,  (const Ipp32f *pSrcImpulseResponse, Ipp32f *pDstMatrix))
/* /////////////////////////////////////////////////////////////////////////////
//  Name:        ippsCrossCorr
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsCrossCorr_NormM_16s, (const Ipp16s *pSrc1, const Ipp16s *pSrc2, int len,
       Ipp16s *pDst) )
LEGACY90IPPAPI( IppStatus, legacy90ippsCrossCorr_16s32s_Sfs, (const Ipp16s *pSrc1, const Ipp16s *pSrc2, int len,
       Ipp32s *pDst, int scaleFactor) )
LEGACY90IPPAPI(IppStatus, legacy90ippsCrossCorr_NR_16s, ( const Ipp16s* pSrc1, const Ipp16s* pSrc2, int len,
       Ipp16s* pDst, int lenDst))
LEGACY90IPPAPI ( IppStatus, legacy90ippsCrossCorr_NR_16s_Sfs, (const Ipp16s* pSrc1, const Ipp16s* pSrc2, int len, Ipp16s* pDst, int lenDst, int scaleFactor))
LEGACY90IPPAPI ( IppStatus, legacy90ippsCrossCorr_NR_16s32s, (const Ipp16s *pSrc1, const Ipp16s *pSrc2, Ipp32s len, Ipp32s *pDst, Ipp32s lenDst))
/* /////////////////////////////////////////////////////////////////////////////
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsCrossCorrLagMax_16s,   (const Ipp16s *pSrc1, const Ipp16s *pSrc2, int len,
                                              int lag, Ipp32s *pMax, int *pMaxLag))
LEGACY90IPPAPI(IppStatus, legacy90ippsCrossCorrLagMax_32f64f,(const Ipp32f *pSrc1, const Ipp32f *pSrc2, int len,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsOpenLoopPitchSearch_G729_16s, (const Ipp16s *pSrc, Ipp16s* bestLag) )
LEGACY90IPPAPI( IppStatus, legacy90ippsOpenLoopPitchSearch_G729A_16s,(const Ipp16s *pSrc, Ipp16s* bestLag) )
LEGACY90IPPAPI( IppStatus, legacy90ippsOpenLoopPitchSearch_G729A_32f,(const Ipp32f *pSrc, Ipp32s* bestLag))
LEGACY90IPPAPI( IppStatus, legacy90ippsOpenLoopPitchSearch_G723_16s, (const Ipp16s *pSrc, Ipp16s* bestLag ) )
/* /////////////////////////////////////////////////////////////////////////////
//  Name:        ippsDotProd
...
//            ippStsOverflow, if at least one result really was saturated
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsDotProd_G729A_16s32s,
   (const Ipp16s* pSrc1, const Ipp16s* pSrc2, int len, Ipp32s* pDp) )
LEGACY90IPPAPI( IppStatus, legacy90ippsDotProd_G729A_32f,
   (const Ipp32f* pSrc1, const Ipp32f* pSrc2, int len, Ipp32f* pDp) )
LEGACY90IPPAPI( IppStatus, legacy90ippsDotProdAutoScale_16s32s_Sfs,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsLagWindow_G729_32s_I, (Ipp32s *pSrcDst, int len) )
/* /////////////////////////////////////////////////////////////////////////////
//  Name:        ippsLSPToLSF
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsLSPToLSF_G729_16s, (const Ipp16s *pLSP, Ipp16s *pLSF) )
LEGACY90IPPAPI( IppStatus, legacy90ippsLSPToLSF_Norm_G729_16s, (const Ipp16s *pLSP, Ipp16s *pLSF) )
/* /////////////////////////////////////////////////////////////////////////////
//  Name:        ippsLSFQuant
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsLSFQuant_G729_16s, (const Ipp16s *pLSF, Ipp16s *pQuantLSFTable,
        Ipp16s *pQuantLSF, Ipp16s *quantIndex) )
LEGACY90IPPAPI( IppStatus, legacy90ippsLSFQuant_G729B_16s, (const Ipp16s *pLSF, Ipp16s *pQuantLSFTable,
        Ipp16s *pQuantLSF, Ipp16s *quantIndex) )
LEGACY90IPPAPI ( IppStatus, legacy90ippsLSFQuant_G729B_32f,(const Ipp32f *pLSF, Ipp32f *pQuantLSFTable,
...
//            ippStsLSFHigh, ippStsLSFLow or ippStsLSFLowAndHigh warnings
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsLSFDecode_G729_16s, (const Ipp16s *quantIndex, Ipp16s *pQuantLSPTable,
       Ipp16s *pQuantLSF) )
LEGACY90IPPAPI (IppStatus, legacy90ippsLSFDecode_G729_32f, (const int *quantIndex, Ipp32f *pQuantLSFTable,
       Ipp32f *pQuantLSF) )
LEGACY90IPPAPI( IppStatus, legacy90ippsLSFDecodeErased_G729_16s, (Ipp16s maIndex, Ipp16s *pQuantLSFTable,
       const Ipp16s *pLSF) )
LEGACY90IPPAPI ( IppStatus, legacy90ippsLSFDecodeErased_G729_32f, (int maIndex, Ipp32f *pQuantLSFTable,
       const Ipp32f *pSrcPrevLSF))
LEGACY90IPPAPI( IppStatus, legacy90ippsLSFDecode_G729B_16s, (const Ipp16s *quantIndex, Ipp16s *pQuantLSFTable,
        Ipp16s *pLSF) )
LEGACY90IPPAPI ( IppStatus, legacy90ippsLSFDecode_G729B_32f,(const int *quantIndex, Ipp32f *pQuantLSFTable, Ipp32f *pDstQLsp ))
LEGACY90IPPAPI( IppStatus, legacy90ippsLSFDecode_G723_16s, ( const Ipp16s *quantIndex, const Ipp16s *pPrevLSF,
...
//
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsLSFToLSP_G729_16s, (const Ipp16s *pLSF, Ipp16s *pLSP) )
LEGACY90IPPAPI( IppStatus, legacy90ippsLSFToLSP_GSMAMR_16s, (const Ipp16s *pLSF, Ipp16s *pLSP) )
/* /////////////////////////////////////////////////////////////////////////////
...
/  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsInterpolate_G729_16s, (const Ipp16s *pSrc1, const Ipp16s *pSrc2,
        Ipp16s *pDst, int  len) )
LEGACY90IPPAPI( IppStatus, legacy90ippsInterpolateC_G729_16s_Sfs, (const Ipp16s *pSrc1, Ipp16s val1,
        const Ipp16s *pSrc2, Ipp16s val2, Ipp16s *pDst, int  len, int scaleFactor) )
LEGACY90IPPAPI( IppStatus, legacy90ippsInterpolateC_NR_G729_16s_Sfs, (const Ipp16s *pSrc1, Ipp16s val1,
        const Ipp16s *pSrc2, Ipp16s val2, Ipp16s *pDst, int  len, int scaleFactor) )
LEGACY90IPPAPI( IppStatus, legacy90ippsInterpolateC_G729_32f,(const Ipp32f *pSrc1, Ipp32f val1,
       const Ipp32f *pSrc2, Ipp32f val2, Ipp32f *pDst, int len))
LEGACY90IPPAPI ( IppStatus, legacy90ippsInterpolate_GSMAMR_16s,
...
//
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsLSPToLPC_G729_16s, (const Ipp16s *pSrcLSP, Ipp16s *pDstLPC) )
LEGACY90IPPAPI( IppStatus, legacy90ippsLSPToLPC_G729_32f, (const Ipp32f *pSrcLSP, Ipp32f *pDstLPC) )
/* ///////////////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsResidualFilter_G729_16s, ( const Ipp16s * pSrc, const Ipp16s * pSrcLPC,
        Ipp16s * pDst) )
LEGACY90IPPAPI( IppStatus, legacy90ippsResidualFilter_G729E_16s,(
...
//            ippStsOverflow, if at least one result really was saturated
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_NR_16s_Sfs, (const Ipp16s * pLPC, const Ipp16s * pSrc,
        Ipp16s * pDst, int len, int scaleFactor, const Ipp16s *pMem) )
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterLow_NR_16s_ISfs, (const Ipp16s * pLPC, Ipp16s * pSrcDst,
       int len, int scaleFactor, const Ipp16s *pMem) )
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_NR_16s_ISfs, (const Ipp16s * pLPC, Ipp16s * pSrcDst,
       int len, int scaleFactor, const Ipp16s *pMem) )
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterZeroStateResponse_NR_16s,
       (const Ipp16s * pSrcLPC, Ipp16s * pDstImp, int len, int scaleFactor))
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_G729E_16s,(
   const Ipp16s *pSrcLpc, Ipp16s order, const Ipp16s *pSrcSignal,
   Ipp16s *pDstFltSignal, int len, Ipp16s *pSrcDstSynFltMemory))
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_G729_32f,(
   const Ipp32f *pSrcLpc, Ipp32s order, const Ipp32f *pSrcSignal,
   Ipp32f *pDstFltSignal, int len, Ipp32f *pSrcDstSynFltMemory))
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_G729E_16s_I,(
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsConvPartial_NR_Low_16s,(const Ipp16s *pSrc1,
       const Ipp16s *pSrc2, Ipp16s *pDst, int len))
LEGACY90IPPAPI(IppStatus, legacy90ippsConvPartial_NR_16s,
       (const Ipp16s *pSrc1,const Ipp16s *pSrc2, Ipp16s *pDst, int len))
LEGACY90IPPAPI(IppStatus, legacy90ippsConvPartial_16s_Sfs,
       ( const Ipp16s* pSrc1, const Ipp16s* pSrc2,  Ipp16s* pDst, int len, int scaleFactor) )
LEGACY90IPPAPI(IppStatus, legacy90ippsConvPartial_16s32s,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsDecodeAdaptiveVector_G729_16s_I,(const Ipp16s * pSrcDelay,
       Ipp16s * pSrcDstPrevExcitation))
LEGACY90IPPAPI( IppStatus, legacy90ippsDecodeAdaptiveVector_G729_32f_I,(const Ipp32s * pSrcDelay,
       Ipp32f * pSrcDstPrevExcitation))
LEGACY90IPPAPI( IppStatus, legacy90ippsDecodeAdaptiveVector_G729_16s,(const Ipp16s * pSrcDelay,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsAdaptiveCodebookContribution_G729_16s, (Ipp16s gain,
       const Ipp16s *pFltAdptVector, const Ipp16s *pSrcAdptTarget, Ipp16s* pDstAdptTarget))
LEGACY90IPPAPI(IppStatus, legacy90ippsAdaptiveCodebookContribution_G729_32f,(Ipp32f gain,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_G729_32s16s, (const Ipp16s *pSrcFixedCorr,
       Ipp32s *pSrcDstMatrix, Ipp16s *pDstFixedVector,
       Ipp16s *pDstFixedIndex, Ipp16s *pSearchTimes, Ipp16s subFrame))
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_G729_16s, (const Ipp16s *pSrcFixedCorr,
       Ipp16s *pSrcDstMatrix, Ipp16s *pDstFixedVector,
       Ipp16s *pDstFixedIndex, Ipp16s *pSearchTimes, Ipp16s subFrame))
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_G729A_32s16s,(const Ipp16s *pSrcFixedCorr,
       Ipp32s *pSrcDstMatrix, Ipp16s *pDstFixedVector, Ipp16s *pDstFixedIndex))
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_G729A_16s,(const Ipp16s *pSrcFixedCorr,
       Ipp16s *pSrcDstMatrix, Ipp16s *pDstFixedVector, Ipp16s *pDstFixedIndex))
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_G729E_16s,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_G729D_16s,(const Ipp16s *pSrcFixedCorr,
       const Ipp16s *pSrcImpulseResponse, Ipp16s *pDstFixedVector, Ipp16s *pDstFltFixedVector,
       Ipp16s *pDstSign, Ipp16s *pDstFixedIndex))
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_G729_32f,(const Ipp32f *pSrcFixedCorr,
       Ipp32f *pSrcDstMatrix, Ipp32f *pDstFixedVector, Ipp32s *pDstFixedIndex,
       Ipp32s *pSearchTimes, Ipp32s subFrame))
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_G729A_32f,(const Ipp32f *pSrcFixedCorr,
       Ipp32f *pSrcDstMatrix, Ipp32f *pDstFixedVector, Ipp32s *pDstFixedIndex))
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_G729D_32f,(Ipp32f *pSrcDstFixedCorr,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_G729E_32f, (int mode,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsHarmonicFilter_16s_I,(Ipp16s val, int T, Ipp16s *pSrcDst, int len) )
LEGACY90IPPAPI( IppStatus, legacy90ippsHarmonicFilter_32f_I,(Ipp32f val, int T, Ipp32f *pSrcDst, int len) )
LEGACY90IPPAPI( IppStatus, legacy90ippsHarmonicFilter_NR_16s, (Ipp16s val, int T, const Ipp16s *pSrc,
       Ipp16s *pDst, int len) )
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsGainQuant_G729_16s, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippsGainQuant_G729D_16s, (
       const Ipp16s  *pSrcAdptTarget, const Ipp16s  *pSrcFltAdptVector,
       const Ipp16s  *pSrcFixedVector, const Ipp16s  *pSrcFltFixedVector,
       Ipp16s *pSrcDstEnergyErr, Ipp16s *pDstQGain, Ipp16s *pDstQGainIndex, Ipp16s tameProcess))
/* /////////////////////////////////////////////////////////////////////////////
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsGainCodebookSearch_G729_32f,(const Ipp32f *pSrcCorr,
       Ipp32f valPredictedGain, const int *pCand, int *pIdxs, int tameProcess))
LEGACY90IPPAPI(IppStatus, legacy90ippsGainCodebookSearch_G729D_32f,(const Ipp32f *pSrcCorr,
       Ipp32f valPredictedGain, const int *pCand, int *pIdxs, int tameProcess))
/* /////////////////////////////////////////////////////////////////////////////
//  Name:       ippsGainQuant
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsGainQuant_G723_16s, (const Ipp16s *pImp, const Ipp16s *pSrc,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsDecodeGain_G729_16s, (Ipp32s energy, Ipp16s *pPastEnergy,
       const Ipp16s *quaIndex, Ipp16s *pGain) )
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeGain_G729I_16s, (Ipp32s energy, Ipp16s valGainAttenuation, Ipp16s *pPastEnergy,
       const Ipp16s *quaIndex, Ipp16s *pGain))
/* /////////////////////////////////////////////////////////////////////////////
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsTiltCompensation_G729E_16s, (Ipp16s val, const Ipp16s *pSrc,
       Ipp16s *pDst) )
LEGACY90IPPAPI( IppStatus, legacy90ippsTiltCompensation_G723_32s16s, (Ipp16s val, const Ipp32s *pSrc,
       Ipp16s *pDst) )

LEGACY90IPPAPI (IppStatus, legacy90ippsTiltCompensation_G729_16s,(const Ipp16s * pSrcImpulseResponse,
                                        Ipp16s * pSrcDstSpch))
LEGACY90IPPAPI (IppStatus, legacy90ippsTiltCompensation_G729A_16s,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLongTermPostFilter_G729_16s,(Ipp16s gammaFactor, int valDelay,
       const Ipp16s *pSrcDstResidual, Ipp16s *pDstFltResidual, Ipp16s *pResultVoice ))
LEGACY90IPPAPI(IppStatus, legacy90ippsLongTermPostFilter_G729A_16s,(Ipp16s valDelay, const Ipp16s * pSrcSpch,
       const Ipp16s * pSrcLPC, Ipp16s * pSrcDstResidual, Ipp16s * pDstFltResidual))
LEGACY90IPPAPI(IppStatus, legacy90ippsLongTermPostFilter_G729B_16s,(Ipp16s valDelay, const Ipp16s * pSrcSpch,
       const Ipp16s * pSrcLPC, Ipp16s * pSrcDstResidual, Ipp16s * pDstFltResidual,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsShortTermPostFilter_G729_16s, (const Ipp16s * pSrcLPC,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsPreemphasize_G729A_16s_I, (Ipp16s gamma, Ipp16s *pSrcDst, int len,
       Ipp16s* pMem) )
LEGACY90IPPAPI( IppStatus, legacy90ippsPreemphasize_32f_I,(Ipp32f gamma, Ipp32f *pSrcDst, int len,
       Ipp32f *pMem))
LEGACY90IPPAPI( IppStatus, legacy90ippsPreemphasize_G729A_16s, (Ipp16s gamma, const Ipp16s *pSrc, Ipp16s *pDst,
       int len, Ipp16s* pMem) )
LEGACY90IPPAPI( IppStatus, legacy90ippsPreemphasize_GSMAMR_16s, (Ipp16s gamma, const Ipp16s *pSrc, Ipp16s *pDst,
       int len, Ipp16s* pMem) )
/* /////////////////////////////////////////////////////////////////////////////
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsGainControl_G729_16s_I, (const Ipp16s *pSrc1, Ipp16s *pSrcDst,
       Ipp16s *pGain) )
LEGACY90IPPAPI( IppStatus, legacy90ippsGainControl_G729A_16s_I, (const Ipp16s *pSrc1, Ipp16s *pSrcDst,
       Ipp16s *pGain) )
LEGACY90IPPAPI( IppStatus, legacy90ippsGainControl_G723_16s_I, (Ipp32s energy, Ipp16s *pSrcDst, Ipp16s *pGain) )

LEGACY90IPPAPI( IppStatus, legacy90ippsGainControl_G729_32f_I,(Ipp32f gainScalingVal,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsRandomNoiseExcitation_G729B_16s, (Ipp16s *pSeed, Ipp16s *pExc, int len) )
LEGACY90IPPAPI( IppStatus, legacy90ippsRandomNoiseExcitation_G729B_16s32f,(Ipp16s *pSeed, Ipp32f *pExc, int len))
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLevinsonDurbin_G729_32s16s,( const Ipp32s * pSrcAutoCorr,
       int order, Ipp16s * pDstLPC, Ipp16s * pDstRc, Ipp16s * pResultResidualEnergy))
LEGACY90IPPAPI(IppStatus, legacy90ippsLevinsonDurbin_G729_32f,(const Ipp32f * pSrcAutoCorr,
       int order, Ipp32f * pDstLpc, Ipp32f * pDstRc, Ipp32f * pResultResidualEnergy))
LEGACY90IPPAPI(IppStatus, legacy90ippsLevinsonDurbin_G729B,(const Ipp32s * pSrcAutoCorr,
       Ipp16s * pDstLPC, Ipp16s * pDstRc, Ipp16s * pResultResidualEnergy))


LEGACY90IPPAPI(IppStatus, legacy90ippsLevinsonDurbin_G723_16s,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsIIR16sLow_G729_16s,
        (const Ipp16s *pCoeffs, const Ipp16s *pSrc, Ipp16s *pDst, Ipp16s *pMem))
LEGACY90IPPAPI (IppStatus, legacy90ippsIIR16s_G729_16s,
        (const Ipp16s *pCoeffs, const Ipp16s *pSrc, Ipp16s *pDst, Ipp16s *pMem))
LEGACY90IPPAPI( IppStatus, legacy90ippsIIR16s_G723_16s32s, (const Ipp16s *pCoeffs, const Ipp16s *pSrc,
       Ipp32s *pDst, Ipp16s *pMem ) )
LEGACY90IPPAPI( IppStatus, legacy90ippsIIR16s_G723_16s_I, (const Ipp16s *pCoeffs, Ipp16s *pSrcDst,
       Ipp16s *pMem ) )
LEGACY90IPPAPI( IppStatus, legacy90ippsIIR16s_G723_32s16s_Sfs, (const Ipp16s *pCoeffs, const Ipp32s *pSrc,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsHarmonicNoiseSubtract_G723_16s_I, (Ipp16s val, int T, const Ipp16s *pSrc,
       Ipp16s *pSrcDst) )
/* /////////////////////////////////////////////////////////////////////////////
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPhaseDispersionGetStateSize_G729D_16s,(int *pSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsPhaseDispersionInit_G729D_16s,(IppsPhaseDispersion_State_G729D *pPhDMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsPhaseDispersionUpdate_G729D_16s,(
  Ipp16s valPitchGain,
  Ipp16s valCodebookGain,
  IppsPhaseDispersion_State_G729D *pPhDMem
))
LEGACY90IPPAPI(IppStatus, legacy90ippsPhaseDispersion_G729D_16s,(
...
#endif
LEGACY90IPPAPI(IppStatus, legacy90ippsWinHybridGetStateSize_G729E_16s,(int *pSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsWinHybridGetStateSize_G729E_32f,(int *pSize))

LEGACY90IPPAPI(IppStatus, legacy90ippsWinHybridInit_G729E_16s,(IppsWinHybridState_G729E_16s *pMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsWinHybridInit_G729E_32f,(IppsWinHybridState_G729E_32f *pMem))

LEGACY90IPPAPI(IppStatus, legacy90ippsWinHybrid_G729E_16s32s,(const Ipp16s  *pSrcSynthSpeech,
       Ipp32s  *pDstInvAutoCorr, IppsWinHybridState_G729E_16s *pMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsWinHybrid_G729E_32f,(const Ipp32f  *pSrcSynthSpeech,
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsAutoCorr_G729B,
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsLPCToLSP_G729_16s,
       (const Ipp16s* pSrcLPC, const Ipp16s* pSrcPrevLsp, Ipp16s* pDstLSP) )
LEGACY90IPPAPI( IppStatus, legacy90ippsLPCToLSP_G729A_16s,
       (const Ipp16s* pSrcLPC, const Ipp16s* pSrcPrevLsp, Ipp16s* pDstLSP) )
LEGACY90IPPAPI( IppStatus, legacy90ippsLPCToLSP_G729_32f,
       (const Ipp32f* pSrcLPC, const Ipp32f* pSrcPrevLsp, Ipp32f* pDstLSP))
LEGACY90IPPAPI( IppStatus, legacy90ippsLPCToLSP_G729A_32f,
       (const Ipp32f* pSrcLPC, const Ipp32f* pSrcPrevLsp, Ipp32f* pDstLSP))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsAdaptiveCodebookSearch_G729_16s, (Ipp16s valOpenDelay,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsAdaptiveCodebookSearch_G729A_16s, (Ipp16s valOpenDelay,
        const Ipp16s * pSrcAdptTarget, const Ipp16s * pSrcImpulseResponse,
        Ipp16s * pSrcDstPrevExcitation, Ipp16s * pDstDelay,
        Ipp16s * pDstAdptVector, Ipp16s subFrame))
LEGACY90IPPAPI( IppStatus, legacy90ippsAdaptiveCodebookSearch_G729D_16s, (Ipp16s valOpenDelay,
        const Ipp16s * pSrcAdptTarget, const Ipp16s * pSrcImpulseResponse,
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFilteredExcitation_G729_32f,
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsLSPQuant_G729_16s, (const Ipp16s * pSrcLsp, Ipp16s * pSrcDstPrevFreq,
        Ipp16s * pDstQLsp, Ipp16s * pDstQLspIndex))
LEGACY90IPPAPI (IppStatus, legacy90ippsLSPQuant_G729E_16s, (const Ipp16s * pSrcLsp, const Ipp16s * pSrcPrevFreq,
        Ipp16s * pDstQLsf, Ipp16s * pDstQLsp, Ipp16s * pDstQLspIndex))
LEGACY90IPPAPI (IppStatus, legacy90ippsLSPQuant_G729E_32f, (const Ipp32f  *pSrcLsp,  Ipp32f*  pSrcDstPrevFreq, Ipp32f *pDstQLsf,
...
//                         If xy < 4 then gain = 0;
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsAdaptiveCodebookGain_G729_16s, (const Ipp16s * pSrcAdptTarget,
       const Ipp16s * pSrcImpulseResponse, const Ipp16s * pSrcAdptVector,
       Ipp16s * pDstFltAdptVector, Ipp16s * pResultAdptGain))
LEGACY90IPPAPI( IppStatus, legacy90ippsAdaptiveCodebookGain_G729A_16s, (const Ipp16s * pSrcAdptTarget,
       const Ipp16s * pSrcLPC, const Ipp16s * pSrcAdptVector, Ipp16s * pDstFltAdptVector,
       Ipp16s * pResultAdptGain))
LEGACY90IPPAPI( IppStatus, legacy90ippsAdaptiveCodebookGain_GSMAMR_16s,(const Ipp16s * pSrcAdptTarget,
       const Ipp16s * pSrcFltAdptVector, Ipp16s * pResultAdptGain))
LEGACY90IPPAPI( IppStatus, legacy90ippsAdaptiveCodebookGainCoeffs_GSMAMR_16s,(const Ipp16s * pSrcAdptTarget,
       const Ipp16s * pSrcFltAdptVector, Ipp16s * pResultAdptGain,
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsFFTFwd_RToPerm_GSMAMR_16s_I, (Ipp16s *pSrcDst))
/* /////////////////////////////////////////////////////////////////////////////
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAutoCorr_G723_16s,(const Ipp16s * pSrcSpch,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLPCToLSF_G723_16s,(const Ipp16s * pSrcLPC,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsHarmonicSearch_G723_16s,(Ipp16s valOpenDelay, const Ipp16s * pSrcWgtSpch,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsAdaptiveCodebookSearch_G723,(
   Ipp16s valBaseDelay,
...
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsDecodeAdaptiveVector_G723_16s,(
        Ipp16s valBaseDelay,
        Ipp16s valCloseLag,
...
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsLSFToLPC_G723_16s,(const Ipp16s * pSrcLSF, Ipp16s * pDstLPC))
LEGACY90IPPAPI( IppStatus, legacy90ippsLSFToLPC_G723_16s_I, (Ipp16s *pLSFLPC) )
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLSFQuant_G723_16s32s,(const Ipp16s * pSrcLSF, const Ipp16s *pSrcPrevLSF,
...
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsACELPFixedCodebookSearch_G723_16s,(
        ...
        Ipp16s * pSearchTimes))
LEGACY90IPPAPI( IppStatus, legacy90ippsACELPFixedCodebookSearch_G723_32s16s,(
        const Ipp16s * pSrcFixedCorr,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsMPMLQFixedCodebookSearch_G723,(
             Ipp16s valBaseDelay,
             const Ipp16s * pSrcImpulseResponse,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_G723_16s32s, (const Ipp16s *pQntLPC,  const Ipp16s *pSrc,
       Ipp32s *pDst, Ipp16s *pMem ) )

LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilter_G723_16s, (const Ipp16s *pSrcLPC, const Ipp16s *pSrcResidual,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsPitchPostFilter_G723_16s, (Ipp16s valBaseDelay, const Ipp16s *pSrcResidual,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsAutoCorr_GSMAMR_16s32s,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLevinsonDurbin_GSMAMR_32s16s,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsLPCToLSP_GSMAMR_16s,
                  (const Ipp16s * pSrcLPC, const Ipp16s * pSrcPrevLsp, Ipp16s * pDstLsp))
/* /////////////////////////////////////////////////////////////////////////////
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLSPToLPC_GSMAMR_16s, (const Ipp16s *pSrcLsp, Ipp16s *pDstLPC))
/* /////////////////////////////////////////////////////////////////////////////
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLSPQuant_GSMAMR_16s, (const Ipp16s *pSrcLsp,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsEncDTXSID_GSMAMR_16s, (const Ipp16s *pSrcLspBuffer,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsQuantLSPDecode_GSMAMR_16s, (const Ipp16s *pSrcQLspIndex,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsEncDTXHandler_GSMAMR_16s, (Ipp16s *pValResultHangOverCount,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsEncDTXBuffer_GSMAMR_16s, (const Ipp16s * pSrcSpch,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsDecDTXBuffer_GSMAMR_16s, (const Ipp16s *pSrcSpch,
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsAlgebraicCodebookSearchGetBufferSize_GSMAMR_16s,(int *pBufferSize ))
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsAlgebraicCodebookSearch_GSMAMR_16s, (Ipp16s valIntPitchLag, Ipp16s valBoundQAdptGain,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAlgebraicCodebookSearchEX_GSMAMR_16s,
...
//      ippStsNoErr         if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsFixedCodebookDecode_GSMAMR_16s,
...
LEGACY90IPPAPI (IppStatus, legacy90ippsOpenLoopPitchSearchNonDTX_GSMAMR_16s,(
...
//      ippStsNoErr             if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsOpenLoopPitchSearchDTXVAD1_GSMAMR_16s,(
      const Ipp16s * pSrcWgtLPC1,
      const Ipp16s * pSrcWgtLPC2,
      const Ipp16s * pSrcSpch,
...
//      ippStsNoErr             if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsOpenLoopPitchSearchDTXVAD2_GSMAMR_16s32s,(
      const Ipp16s * pSrcWgtLPC1,
      const Ipp16s * pSrcWgtLPC2,
      const Ipp16s * pSrcSpch,
      Ipp16s * pValResultPrevMidPitchLag,
...
//      ippStsNoErr             if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsImpulseResponseTarget_GSMAMR_16s,(
      const Ipp16s * pSrcSpch,
      const Ipp16s * pSrcWgtLPC1,
      const Ipp16s * pSrcWgtLPC2,
...
//      ippStsNoErr             if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsAdaptiveCodebookSearch_GSMAMR_16s,(
      const Ipp16s * pSrcAdptTarget,
      const Ipp16s * pSrcImpulseResponse,
...
//      ippStsNoErr             if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsAdaptiveCodebookDecode_GSMAMR_16s,(
      Ipp16s valAdptIndex,
      Ipp16s * pValResultPrevIntPitchLag,
...
//      ippStsNoErr             if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsPostFilter_GSMAMR_16s,(
        const Ipp16s * pSrcQLPC,
        const Ipp16s * pSrcSpch,
...
//      ippStsNoErr         if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsVAD1_GSMAMR_16s,
        (const Ipp16s *pSrcSpch,
...
//      ippStsNoErr         if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsVAD2_GSMAMR_16s,
        (const Ipp16s * pSrcSpch,
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsDCTFwd_G722_16s, (const Ipp16s *pSrc, Ipp16s *pDst))
LEGACY90IPPAPI( IppStatus, legacy90ippsDCTFwd_G7221_16s, (const Ipp16s *pSrc, Ipp16s *pDst, int len))

LEGACY90IPPAPI( IppStatus, legacy90ippsDCTInv_G722_16s, (const Ipp16s *pSrc, Ipp16s *pDst))
LEGACY90IPPAPI( IppStatus, legacy90ippsDCTInv_G7221_16s, (const Ipp16s *pSrcMLT, Ipp16s *pDstSmpl, int len))
/* /////////////////////////////////////////////////////////////////////////////
...
//    IppStsSizeErr     Indicates an error when len has an illegal value.
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsDecomposeMLTToDCT_G722_16s, (const Ipp16s *pSrcSpch,
       Ipp16s *pSrcDstSpchOld, Ipp16s *pDstSpchDecomposed))
LEGACY90IPPAPI( IppStatus, legacy90ippsDecomposeMLTToDCT_G7221_16s, (const Ipp16s *pSrcSpch,
...
//    IppStsSizeErr     Indicates an error when len has an illegal value.
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsDecomposeDCTToMLT_G722_16s, (const Ipp16s *pSrcSpchDecomposed,
       Ipp16s *pSrcDstSpchDecomposedOld, Ipp16s *pDstSpch))
LEGACY90IPPAPI( IppStatus, legacy90ippsDecomposeDCTToMLT_G7221_16s, (const Ipp16s *pSrcSpchDecomposed,
...
//                         proper range.
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsHuffmanEncode_G722_16s32u, (int category, int qntAmpEnvIndex,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsEncodeGetStateSize_G726_16s8u,(unsigned int* pEncSize))
/* /////////////////////////////////////////////////////////////////////////////
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsEncodeInit_G726_16s8u,
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsEncode_G726_16s8u,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeGetStateSize_G726_8u16s,(unsigned int* pDecSize))
/* /////////////////////////////////////////////////////////////////////////////
//  Name:        ippsEncodeInit_G726
//  Purpose:       Initializes the memory for the ADPCM encode
//  Parameters:
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeInit_G726_8u16s,
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsDecode_G726_8u16s,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsIIR16sGetStateSize_G728_16s, (int *pSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsIIR16sInit_G728_16s, (IppsIIRState_G728_16s *pMem ))
LEGACY90IPPAPI(IppStatus, legacy90ippsIIR16s_G728_16s, (const Ipp16s *pCoeffs, const Ipp16s *pSrcQntSpeech,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterGetStateSize_G728_16s,(int* pSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterInit_G728_16s,(IppsSynthesisFilterState_G728_16s *pMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsSyntesisFilterZeroInput_G728_16s,(const Ipp16s* pCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsCombinedFilterGetStateSize_G728_16s,(int* pSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsCombinedFilterInit_G728_16s,(IppsCombinedFilterState_G728_16s* pMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsCombinedFilterZeroInput_G728_16s,(const Ipp16s* pSyntCoeff,
       const Ipp16s* pWgtCoeff, Ipp16s* pDstWgtZIR, IppsCombinedFilterState_G728_16s* pMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsCombinedFilterZeroState_G728_16s,(const Ipp16s* pSyntCoeff,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPostFilterGetStateSize_G728_16s,(int *pSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsPostFilterInit_G728_16s,(IppsPostFilterState_G728_16s *pMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsPostFilter_G728_16s,(Ipp16s gl, Ipp16s glb, Ipp16s kp, Ipp16s tiltz,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsWinHybridGetStateSize_G728_16s,(int M, int L, int N, int DIM, int *pMemSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsWinHybridInit_G728_16s,(const Ipp16s *pWinTab,int M, int L, int N,
       int DIM, Ipp16s a2L, IppsWinHybridState_G728_16s *pMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsWinHybridBlock_G728_16s,(Ipp16s bfi, const Ipp16s *pSrc, const Ipp16s *pSrcSfs, Ipp16s *pDst,
                                       IppsWinHybridState_G728_16s *pMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsWinHybrid_G728_16s,(Ipp16s bfi, const Ipp16s *pSrc, Ipp16s *pDst,
                                  IppsWinHybridState_G728_16s *pMem))
/* /////////////////////////////////////////////////////////////////////////////
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLevinsonDurbin_G728_16s_Sfs,(const Ipp16s *pSrcAutoCorr,
                                            int order,
                                            Ipp16s *pDstLPC,
                                            Ipp16s *pDstRC1,
                                            Ipp16s *pDstResidualEnergy,
                                            Ipp16s *pDstScaleFactor))
LEGACY90IPPAPI(IppStatus, legacy90ippsLevinsonDurbin_G728_16s_ISfs,(const Ipp16s *pSrcAutoCorr,
                                            int numSrcLPC,
                                            int order,
                                            Ipp16s *pSrcDstLPC,
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsCodebookSearch_G728_16s,(
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsImpulseResponseEnergy_G728_16s,(const Ipp16s *pSrcImpResp, Ipp16s *pDstEnergy))
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsPostFilterAdapterGetStateSize_G728, (int *pSize))

/* /////////////////////////////////////////////////////////////////////////////
// Name:          ippsPostFilterAdapterStateInit_G728
// Purpose:       initializes the memory for postfilter adapter.
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsPostFilterAdapterStateInit_G728, (IppsPostFilterAdapterState_G728 *pMem))
...
// Notes:
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLPCInverseFilter_G728_16s, (const Ipp16s* pSrcSpeech, const Ipp16s* pCoeffs,
...
// Notes:
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsPitchPeriodExtraction_G728_16s, (const Ipp16s* pSrcResidual,
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsRPEQuantDecode_GSMFR_16s,
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsDeemphasize_GSMFR_16s_I,(Ipp16s *pSrcDst,int len,Ipp16s *pMem))
/* /////////////////////////////////////////////////////////////////////////////
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsShortTermSynthesisFilter_GSMFR_16s,
...
//    pMem        pointer to the filter memory vector[9]
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsShortTermAnalysisFilter_GSMFR_16s_I,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsHighPassFilter_GSMFR_16s,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsSchur_GSMFR_32s16s,(const Ipp32s *pSrc,Ipp16s *pDst,int dstLen))
/* /////////////////////////////////////////////////////////////////////////////
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsWeightingFilter_GSMFR_16s,(const Ipp16s *pSrc, Ipp16s *pDst,int dstLen))
/* /////////////////////////////////////////////////////////////////////////////
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsPreemphasize_GSMFR_16s,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsResidualFilter_AMRWB_16s_Sfs,(
...
LEGACY90IPPAPI( IppStatus, legacy90ippsResidualFilter_Low_16s_Sfs,(
  const Ipp16s *pSrcLpc,
  Ipp16s valLPCOrder,
  const Ipp16s *pSrcSpeech,
  Ipp16s *pDstResidualSignal,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsLPCToISP_AMRWB_16s,(
     const Ipp16s *pSrcLpc,
     Ipp16s *pDstIsp,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsISPToLPC_AMRWB_16s,(
...
LEGACY90IPPAPI( IppStatus, legacy90ippsISPToISF_Norm_AMRWB_16s,(
     const Ipp16s *pSrcIsp,
     Ipp16s *pDstIsf,
     Ipp32s  len
))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsISFToISP_AMRWB_16s,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippsEncDTXBuffer_AMRWB_16s,(const Ipp16s * pSrcSpch,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsDecDTXBuffer_AMRWB_16s,(const Ipp16s *pSrcSpch,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsOpenLoopPitchSearch_AMRWB_16s,(const Ipp16s *pSrcWgtSpch,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsHighPassFilterGetSize_AMRWB_16s,(int order, int *pDstSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsHighPassFilterInit_AMRWB_16s,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsHighPassFilter_AMRWB_16s_Sfs,(
     const Ipp16s *pSrc, Ipp16s *pDst, int len,
     IppsHighPassFilterState_AMRWB_16s *pState, int scaleFactor))

LEGACY90IPPAPI(IppStatus, legacy90ippsHighPassFilter_AMRWB_16s_ISfs,(
     Ipp16s *pSrcDst, int len,
     IppsHighPassFilterState_AMRWB_16s *pState, int scaleFactor))

LEGACY90IPPAPI(IppStatus, legacy90ippsHighPassFilter_Direct_AMRWB_16s,(
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsHighPassFilterGetDlyLine_AMRWB_16s,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsHighPassFilterSetDlyLine_AMRWB_16s,
...
//      ippStsNoErr         if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsVADGetSize_AMRWB_16s,(int *pDstSize ))
...
//      ippStsNoErr         if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsVADInit_AMRWB_16s,(
...
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsVADGetEnergyLevel_AMRWB_16s,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsVAD_AMRWB_16s,(const Ipp16s *pSrcSpch,
                  IppsVADState_AMRWB_16s *pState,
                  Ipp16s *pToneFlag,
                  Ipp16s *pVadFlag))
...
//     ippStsNullPtrErr - Error when the pBufferSize is NULL.
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsAlgebraicCodebookSearchGetBufferSize_AMRWB_16s,(int *pBufferSize ))
...
//      ippStsNoErr         if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsAlgebraicCodebookSearch_AMRWB_16s,(const Ipp16s *pSrcFixedTarget, const Ipp16s *pSrcLtpResidual, 
   Ipp16s *pSrcDstImpulseResponse, Ipp16s *pDstFixedVector, Ipp16s *pDstFltFixedVector, IppSpchBitRate mode, Ipp16s *pDstIndex ))

LEGACY90IPPAPI(IppStatus, legacy90ippsAlgebraicCodebookSearchEX_AMRWB_16s,(const Ipp16s *pSrcFixedTarget, const Ipp16s *pSrcLtpResidual, 
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAlgebraicCodebookDecode_AMRWB_16s,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippsInterpolateC_NR_16s,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPreemphasize_AMRWB_16s_ISfs,(Ipp16s gamma, Ipp16s *pSrcDst,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsAdaptiveCodebookGainCoeff_AMRWB_16s,(const Ipp16s * pSrcAdptTarget,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsISFQuant_AMRWB_16s,(const Ipp16s *pSrcIsf,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsISFQuantDecode_AMRWB_16s,(
     const Ipp16s *pSrcIdxs,
     Ipp16s *pDstQntIsf,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsISFQuantDTX_AMRWB_16s,(
     const Ipp16s *pSrcIsf,
     Ipp16s *pDstQntIsf,
     Ipp16s *pDstIdxs
))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsISFQuantDecodeDTX_AMRWB_16s,(
     const Ipp16s *pSrcIdxs,
     Ipp16s *pDstQntIsf
))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilter_AMRWB_16s32s_I,(
...
//    len        length of input/output vector
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsDeemphasize_AMRWB_32s16s,(
     Ipp16s gamma, const Ipp32s *pSrc, Ipp16s *pDst, int len, Ipp16s *pMem))

LEGACY90IPPAPI(IppStatus, legacy90ippsDeemphasize_AMRWB_NR_16s_I,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAdaptiveCodebookSearch_AMRWB_16s,(
      const Ipp16s * pSrcAdptTarget,
      const Ipp16s * pSrcImpulseResponse,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAdaptiveCodebookDecodeGetSize_AMRWB_16s,(int *pDstSize))

LEGACY90IPPAPI(IppStatus, legacy90ippsAdaptiveCodebookDecodeInit_AMRWB_16s,(IppsAdaptiveCodebookDecodeState_AMRWB_16s *pState))

LEGACY90IPPAPI(IppStatus, legacy90ippsAdaptiveCodebookDecodeUpdate_AMRWB_16s,(int valPitchGain, int valIntPitchLag,
                                                      IppsAdaptiveCodebookDecodeState_AMRWB_16s *pState))
LEGACY90IPPAPI(IppStatus, legacy90ippsAdaptiveCodebookDecode_AMRWB_16s,(
      int valAdptIndex,
      Ipp16s * pFracPitchLag,
      Ipp16s * pSrcDstExcitation,
      Ipp16s * pResultIntPitchLag,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsGainQuant_AMRWB_16s,(
...
LEGACY90IPPAPI( IppStatus, legacy90ippsDecodeGain_AMRWB_16s,(
     int valQIndex,
     Ipp32s valEnergy,
...
//    ippStsNoErr             if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsAdaptiveCodebookSearch_AMRWBE_16s,(
      const Ipp16s * pSrcAdptTarget,
      const Ipp16s * pSrcImpulseResponse,
      const Ipp16s * pSrcOpenLoopLag,
      Ipp16s * pPitchLag,
...
//      ippStsNoErr             if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsAdaptiveCodebookDecode_AMRWBE_16s, (
       int valAdptIndex,
       Ipp16s* pSrcDstExcitation,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsGainQuant_AMRWBE_16s,(
       const Ipp16s *pSrcAdptTarget, const Ipp16s *pSrcFltAdptVector, int valFormat,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsSNR_AMRWBE_16s, (const Ipp16s* pSrcSignal,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsGainQuantTCX_AMRWBE_16s, (const Ipp16s *pSrcSignal,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsGainDecodeTCX_AMRWBE_16s, (const Ipp16s *pSrcQuantSignal,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI( IppStatus, legacy90ippsISFQuantDecode_AMRWBE_16s,(
...
//      ippStsNoErr             if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsOpenLoopPitchSearch_AMRWBE_16s,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLPCToISP_AMRWBE_16s, (const Ipp16s *pSrcLpc,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsResamplePolyphase_AMRWBE_16s, (const Ipp16s *pSrcSignal,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsBandSplit_AMRWBE_16s, (const Ipp16s* pSrcSignal,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsBandJoin_AMRWBE_16s, (const Ipp16s* pSrcSig2k,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsBandJoinUpsample_AMRWBE_16s, (const Ipp16s* pSrcSigLF,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsBandSplitDownsample_AMRWBE_16s, (const Ipp16s* pSrcSig, int lenSrc,
...
//     ippStsNullPtrErr - Error when the pBufferSize is NULL.
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsUpsampleGetBufferSize_AMRWBE_16s,(int *pBufferSize ))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsUpsample_AMRWBE_16s, (const Ipp16s* pSrcSignal,
       Ipp16s* pSrcDstSignal, int lenDst, Ipp16s* pMem, Ipp32s bandIdx, Ipp32s addFlag))

LEGACY90IPPAPI(IppStatus, legacy90ippsUpsampleEX_AMRWBE_16s, (const Ipp16s* pSrcSignal,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsDownsample_AMRWBE_16s, (const Ipp16s* pSrcSignal, int lenSrc,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsISFQuantHighBand_AMRWBE_16s, (const Ipp16s *pSrcISF,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsISFQuantDecodeHighBand_AMRWBE_16s, (const Ipp16s *pSrcQuantIdxs,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFFTFwd_RToPerm_AMRWBE_16s, (const Ipp16s* pSrc, Ipp16s* pDst, int len))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFFTInv_PermToR_AMRWBE_16s, (const Ipp16s* pSrc, Ipp16s* pDst, int len))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilter_AMRWBE_16s32s_I,(
     const Ipp16s *pSrcLpc, int order,  const Ipp16s *pSrcExc, Ipp32s *pSrcDstSignal, int len))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsDeemphasize_AMRWBE_NR_16s_I, (Ipp16s gamma,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRGenMidBand_AMRWBE_16s, (const Ipp16s* pSrcSignal,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsPostFilterLowBand_AMRWBE_16s, (const Ipp16s *pSrcOldPitchLag,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsQuantTCX_AMRWBE_16s, (const Ipp16s *pSrc, Ipp16s *pDst,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsEncodeMux_AMRWBE_16s, (const Ipp16s *pSrc, int nSubvectors,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeDemux_AMRWBE_16s, (const Ipp16s *pSrcParams,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsSBADPCMEncodeStateSize_G722_16s, (int* pEncMemSize))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsSBADPCMEncodeInit_G722_16s, (IppsEncoderState_G722_16s* pEncMem))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsSBADPCMEncode_G722_16s, (const Ipp16s *pSrc, Ipp16s *pDst,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsQMFEncode_G722_16s,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsSBADPCMDecodeStateSize_G722_16s, (int* pDecMemSize))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsSBADPCMDecodeInit_G722_16s, (IppsDecoderState_G722_16s *pDecMem))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsSBADPCMDecode_G722_16s, (const Ipp16s *pSrc, Ipp16s *pDst,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsQMFDecode_G722_16s,
        (const Ipp16s *pSrc, Ipp16s *pDst, int len, Ipp16s *delay))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsSBADPCMDecodeStateUpdate_G722_16s, (const Ipp16s pCoeffs[2], Ipp16s gainFactor,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsClassifyFrame_G722_16s_I, (Ipp16s *pSrcDst, Ipp16s valDelay, IppG722SBClass *pSrcDstClass,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsFilterHighband_G722_16s_I, (Ipp16s *pSrcDst, int len, Ipp16s pMem[2]))
/* /////////////////////////////////////////////////////////////////////////////
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsDownsampleFilter_G722_16s, (const Ipp16s *pSrc, int lenSrc, Ipp16s *pDst))
/* /////////////////////////////////////////////////////////////////////////////
//                         G722 SBADPCM end
///////////////////////////////////////////////////////////////////////////// */
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandProcessGetSize_32f, (int order, int windowLen,
      int *pSize, int *pInitBufSize, int *pBufSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandProcessGetSize_16s, (int order, int windowLen,
      int *pSize, int *pInitBufSize, int *pBufSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandProcessInit_32f, (
      IppsSubbandProcessState_32f *state,
      int order, int frameSize, int windowLen, const Ipp32f *pWindow,
      Ipp8u *pInitBuf))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandProcessInit_16s, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandAnalysis_32f32fc, (const Ipp32f *pSignal, Ipp32fc *pSubbands,
      IppsSubbandProcessState_32f *pState, Ipp8u *pBuf))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandAnalysis_16s32sc_Sfs, (const Ipp16s *pSignal, Ipp32sc *pSubbands,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandSynthesis_32fc32f, (const Ipp32fc *pSubbands, Ipp32f *pSignal,
      IppsSubbandProcessState_32f *pState, Ipp8u *pBuf))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandSynthesis_32sc16s_Sfs, (const Ipp32sc *pSubbands, Ipp16s *pSignal,
      IppsSubbandProcessState_16s *pState, int scalefactor, Ipp8u *pBuf))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerGetSize_EC_32f, (int numSubbands, int frameSize,
      int numSegments, IppPCMFrequency sampleFreq, int *pSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerGetSize_EC_16s, (int numSubbands, int frameSize,
      int numSegments, IppPCMFrequency sampleFreq, int *pSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerDTGetSize_EC_16s, (int numSubbands, int frameSize,
      int numSegments, IppPCMFrequency sampleFreq, int *pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerInit_EC_32f, (IppsSubbandControllerState_EC_32f *pState,
      int numSubbands, int frameSize, int numSegments, IppPCMFrequency sampleFreq))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerInit_EC_16s, (IppsSubbandControllerState_EC_16s *pState,
      int numSubbands, int frameSize, int numSegments, IppPCMFrequency sampleFreq))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerDTInit_EC_16s, (IppsSubbandControllerDTState_EC_16s *pState,
      int numSubbands, int frameSize, int numSegments, IppPCMFrequency sampleFreq))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerUpdate_EC_16s, (const Ipp16s *pSrcRin, const Ipp16s *pSrcSin,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandAPControllerUpdate_EC_32f,(
...
//                          pointers is NULL.
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerUpdate_EC_32f, (const Ipp32f *pSrcRin, const Ipp32f *pSrcSin,
       const Ipp32fc **ppSrcRinSubbandsHistory, const Ipp32fc *pSrcSinSubbands,
       double *pDstStepSize, IppsSubbandControllerState_EC_32f *pState))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandController_EC_32f, (const Ipp32fc *pSrcAdaptiveFilterErr,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandController_EC_16s, (const Ipp32sc *pSrcAdaptiveFilterErr,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerReset_EC_32f, (IppsSubbandControllerState_EC_32f *pState))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerReset_EC_16s, (IppsSubbandControllerState_EC_16s *pState))
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerDTReset_EC_16s, (IppsSubbandControllerDTState_EC_16s *pState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFullbandControllerGetSize_EC_32f, (int frameSize,
      int tapLen, IppPCMFrequency sampleFreq, int *pSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsFullbandControllerGetSize_EC_16s, (int frameSize,
      int tapLen, IppPCMFrequency sampleFreq, int *pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFullbandControllerInit_EC_32f, (IppsFullbandControllerState_EC_32f *pState,
      int frameSize, int tapLen, IppPCMFrequency sampleFreq))
LEGACY90IPPAPI(IppStatus, legacy90ippsFullbandControllerInit_EC_16s, (IppsFullbandControllerState_EC_16s *pState,
      int frameSize, int tapLen, IppPCMFrequency sampleFreq))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFullbandControllerUpdate_EC_32f, (const Ipp32f *pSrcRin,
      const Ipp32f *pSrcSin, Ipp32f *pDstStepSize,
      IppsFullbandControllerState_EC_32f *pState))
LEGACY90IPPAPI(IppStatus, legacy90ippsFullbandControllerUpdate_EC_16s, (const Ipp16s *pSrcRin,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFullbandController_EC_32f, (const Ipp32f *pAdaptiveFilterErr,
      const Ipp32f *pFixedFilterErr,
      Ipp32f *pAdaptiveCoefs, Ipp32f *pFixedCoefs,
      Ipp32f *pSGain,
      IppsFullbandControllerState_EC_32f *pState))
LEGACY90IPPAPI(IppStatus, legacy90ippsFullbandController_EC_16s, (const Ipp16s *pAdaptiveFilterErr,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFullbandControllerReset_EC_32f, (IppsFullbandControllerState_EC_32f *pState))
LEGACY90IPPAPI(IppStatus, legacy90ippsFullbandControllerReset_EC_16s, (IppsFullbandControllerState_EC_16s *pState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFIR_EC_32f, (const Ipp32f *pSrcSpchRef,
      const Ipp32f *pSrcSpch,
      Ipp32f *pDstSpch,
      int len,
      Ipp32f *pSrcCoef,
      int     tapLength))
LEGACY90IPPAPI(IppStatus, legacy90ippsFIR_EC_16s, (const Ipp16s *pSrcSpchRef,
      const Ipp16s *pSrcSpch,
      Ipp16s *pDstSpch,
      int len,
      Ipp16s *pSrcCoef,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsNLMS_EC_32f, (const Ipp32f *pSrcSpchRef,
      const Ipp32f *pSrcSpch,
      ...
      int tapLength,
      Ipp32f *pErr))
LEGACY90IPPAPI(IppStatus, legacy90ippsNLMS_EC_16s, (const Ipp16s *pSrcSpchRef,
      const Ipp16s *pSrcSpch,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRSubband_EC_32fc, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRSubband_EC_32sc_Sfs,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRSubbandLow_EC_32sc_Sfs,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRSubbandCoeffUpdate_EC_32fc_I, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRSubbandAPCoeffUpdate_EC_32fc_I, (
                    ...
                    Ipp32u len,
                    Ipp32u apOrder))
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRSubbandCoeffUpdate_EC_32sc_I, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRSubbandLowCoeffUpdate_EC_32sc_I, (
      const Ipp32sc**      ppSrcFilterInput,
      const Ipp32sc*       pSrcError,
      Ipp32sc**            ppSrcDstCoefsQ15,
      int                  numSegments,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsToneDetectGetStateSize_EC_32f, (IppPCMFrequency sampleFreq, int *pSize))
LEGACY90IPPAPI(IppStatus, legacy90ippsToneDetectGetStateSize_EC_16s, (IppPCMFrequency sampleFreq, int *pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsToneDetectInit_EC_32f, (IppsToneDetectState_EC_32f *pState,
      IppPCMFrequency sampleFreq))
LEGACY90IPPAPI(IppStatus, legacy90ippsToneDetectInit_EC_16s, (IppsToneDetectState_EC_16s *pState,
      IppPCMFrequency sampleFreq))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsToneDetect_EC_32f, (const Ipp32f *pSignal,
      int len, int *pResult,
      IppsToneDetectState_EC_32f *pState))
LEGACY90IPPAPI(IppStatus, legacy90ippsToneDetect_EC_16s, (const Ipp16s *pSignal,
      int len, int *pResult,
...
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerDT_EC_16s, (const Ipp32sc* pSrcAdaptiveFilterErr, const Ipp32sc* pSrcFixedFilterErr,
...
//    ippStsBadArgErr       Indicates an error when startSubband is less 0 or startSubband is greater than or equal to numSubbands.
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsSubbandControllerDTUpdate_EC_16s, (const Ipp32sc** ppSrcRinSubbandsHistory,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLPCToLSP_RTA_32f,(const Ipp32f* pSrcLPC, Ipp32f* pDstLSP, int order))
/* /////////////////////////////////////////////////////////////////////////////
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLSPToLPC_RTA_32f,(const Ipp32f* pSrcLSP, Ipp32f* pDstLPC, int order))
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLevinsonDurbin_RTA_32f, (const Ipp32f* pSrcAutoCorr, Ipp32f* pDstLPC, Ipp32f* pDstRC, int order))
/* /////////////////////////////////////////////////////////////////////////////
...
//    ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsQMFGetStateSize_RTA_32f, ( int* pSize ))
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsQMFInit_RTA_32f,( IppsQMFState_RTA_32f* pQMFMem, int nTaps ))
/* /////////////////////////////////////////////////////////////////////////////
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsQMFDecode_RTA_32f,(const Ipp32f* pSrcLow, const Ipp32f* pSrcHigh,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsQMFEncode_RTA_32f,(const Ipp32f* pSrc, int len, Ipp32f* pDstLow,
...
//    ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsPostFilterGetStateSize_RTA_32f,(int* pSize))
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsPostFilterInit_RTA_32f,( IppsPostFilterState_RTA_32f *pStateMem))
/* /////////////////////////////////////////////////////////////////////////////
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsPostFilter_RTA_32f_I,(const Ipp32f* pSrcLPC, int order, Ipp32f* pSrcDstSpeech,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsAdaptiveCodebookSearch_RTA_32f,(
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearchBuffer_RTA_32f,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearchRandom_RTA_32f,(
...
//    ippStsNoErr, if no errors
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFixedCodebookSearch_RTA_GetBufferSize_32f,( int * pBuferSize))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsLSPQuant_RTA_32f,(
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsHighPassFilter_RTA_32f,(const Ipp32f* pSrc, Ipp32f* pDst, int len, int hpfOrder, IppPCMFrequency frequency, Ipp32f* pMem))
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsBandPassFilter_RTA_32f_I,(Ipp32f* pSrcDst, int len, Ipp32f *pMem))
...
//    ippStsNoErr, if no errors
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsFilterHighpassGetStateSize_G7291_16s, (int* pSize))
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsFilterHighpassInit_G7291_16s, (IppsFilterHighpassState_G7291_16s* pState,
        const Ipp16s* pCoeff))
/* /////////////////////////////////////////////////////////////////////////////
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsFilterHighpass_G7291_16s_ISfs, (Ipp16s* pSrcDst, int len,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsFilterLowpass_G7291_16s_I, (Ipp16s* pSrcDst, int len, Ipp16s* pMem,
...
//    ippStsNoErr, if no errors
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsQMFGetStateSize_G7291_16s, (int* pSize))
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsQMFInit_G7291_16s, (IppsQMFState_G7291_16s* pState))
/* /////////////////////////////////////////////////////////////////////////////
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsQMFEncode_G7291_16s, (const Ipp16s* pSrc, int len,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsQMFDecode_G7291_16s, (const Ipp16s* pSrcLowBand, const Ipp16s* pSrcHighBand,
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsLSFDecode_G7291_16s, (const Ipp16s* pQuantIndex, Ipp16s* pSrcDstPrevLSF,
        Ipp16s* pSrcDstLSF))
/* /////////////////////////////////////////////////////////////////////////////
...
//    subFrame                Subframe number, either 0 or 1.
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsAdaptiveCodebookSearch_G7291_16s, (const Ipp16s* pSrcAdptTarget,
...
LEGACY90IPPAPI (IppStatus, legacy90ippsAdaptiveCodebookGain_G7291_16s, (const Ipp16s* pSrcAdptTarget,
...
//      ippStsNoErr         if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsAlgebraicCodebookSearchL1_G7291_16s, (const Ipp16s* pSrcFixedTarget,
...
LEGACY90IPPAPI (IppStatus, legacy90ippsAlgebraicCodebookSearchL2_G7291_16s, (const Ipp16s* pSrcFixedTarget,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsGainQuant_G7291_16s, (const Ipp16s* pSrcFixedTarget, const Ipp16s* pSrcFltFixedVector,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsEnvelopTime_G7291_16s, (const Ipp16s* pSrc, Ipp16s nls,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsEnvelopFrequency_G7291_16s, (const Ipp16s* pSrc, Ipp16s* pDstEnvelopFreq))
/* /////////////////////////////////////////////////////////////////////////////
...
//    ippStsNoErr, if no errors
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsGenerateExcitationGetStateSize_G7291_16s, (int* pSize))
/* /////////////////////////////////////////////////////////////////////////////
...
//  Returns:  ippStsNoErr, if no errors
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsGenerateExcitationInit_G7291_16s, (IppsGenerateExcitationState_G7291_16s* pState))
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsGenerateExcitation_G7291_16s, (const Ipp16s* pIntPitchLag,
...
//
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsShapeEnvelopTime_G7291_16s, (const Ipp16s* pSrc,
...
//
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsShapeEnvelopFrequency_G7291_16s, (const Ipp16s* pSrc,
...
//
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsCompressEnvelopTime_G7291_16s, (const Ipp16s* pSrcEnvelopTime,
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwd_G7291_16s, (const Ipp16s* pSrc, const Ipp16s* pSrcPrev,
...
//
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsMDCTInv_G7291_16s, (const Ipp16s* pMDCTCoeffs,
...
//
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsMDCTQuantFwd_G7291_16s32u,
...
//
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsMDCTQuantInv_G7291_32u16s,
...
//
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsMDCTPostProcess_G7291_16s, (Ipp16s* pSrcDstMDCTCoeffs,
        int numBits))
/* /////////////////////////////////////////////////////////////////////////////
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsGainControl_G7291_16s_I, (const Ipp16s* pSrc, Ipp16s *pSrcDst,
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsTiltCompensation_G7291_16s, (const Ipp16s* pSrc, Ipp16s* pDst,
        Ipp16s gain))
/* /////////////////////////////////////////////////////////////////////////////
...
//      ippStsNoErr          if no error
*/
LEGACY90IPPAPI (IppStatus, legacy90ippsQuantParam_G7291_16s, (Ipp16s *pSrcDst, Ipp16s *pCdbkIndices))
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoiseGetStateSize_RTA_32f, (IppPCMFrequency pcmFreq, int* pSize ))
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoiseGetStateSize_EC_32f, (IppPCMFrequency pcmFreq,int *size))
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoiseInit_RTA_32f, (IppPCMFrequency pcmFreq, IppsFilterNoiseState_RTA_32f* pNRStateMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoiseInit_EC_32f, (IppPCMFrequency pcmFreq, IppsFilterNoiseState_EC_32f* pNRStateMem))
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoiseLevel_RTA_32f, (IppsNRLevel level, IppsFilterNoiseState_RTA_32f* pNRStateMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoiseLevel_EC_32f, (IppsNRLevel  level, IppsFilterNoiseState_EC_32f* pNRStateMem))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoiseSetMode_EC_32f, (IppsNrSmoothMode  mode, IppsFilterNoiseState_EC_32f* pNRStateMem))
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoiseDetect_EC_32f64f, (const Ipp32f pSrc1[16],Ipp64f *pNoisePwr,
       Ipp32f *pMean,int *pDstFlag,IppsFilterNoiseState_EC_32f *pNRStateMem))

       LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoiseDetectModerate_EC_32f64f, (const Ipp32f pSrc1[16],const Ipp32f pSrc2[16],Ipp64f *pNoisePwr,
       Ipp32f *pMean,int *pDstFlag,IppsFilterNoiseState_EC_32f *pNRStateMem))
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoise_RTA_32f, (const Ipp32f pSrc[160], Ipp32f pDst[160], IppsFilterNoiseState_RTA_32f* pNRStateMem ))
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoise_RTA_32f_I, (Ipp32f pSrcDst[160], IppsFilterNoiseState_RTA_32f* pNRStateMem ))
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoise_EC_32f, (const Ipp32f pSrc[16],Ipp32f pDst[16],IppsNrMode noiseFlag,
                                 IppsFilterNoiseState_EC_32f *pNRStateMem))
LEGACY90IPPAPI(IppStatus, legacy90ippsFilterNoise_EC_32f_I, (Ipp32f pSrcDst[16],IppsNrMode noiseFlag,IppsFilterNoiseState_EC_32f *pNRStateMem))
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsALCGetStateSize_G169_16s,(int* pSize ))
/* /////////////////////////////////////////////////////////////////////////////
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsALCInit_G169_16s,(IppsALCState_G169_16s* pALCMem))
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsALCSetLevel_G169_16s,(Ipp32f targetLevel, Ipp32f clipLevel, IppsALCState_G169_16s* pALCMem))
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsALCSetGain_G169_16s,(Ipp32f maxGain, IppsALCState_G169_16s* pALCMem))
...
//
*/
LEGACY90IPPAPI(IppStatus, legacy90ippsALC_G169_16s,(const Ipp16s *pSrc, Ipp16s *pDst, int len, IppsALCState_G169_16s* pALCMem))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsCodebookSearchTCQ_G728_16s8u,(const Ipp16s *pSrc, const Ipp16s *pSrcLPC,Ipp8u *pDst,
