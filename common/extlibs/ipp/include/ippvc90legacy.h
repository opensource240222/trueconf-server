...
#if !defined(__IPPVC_90_LEGACY_H__)
#define __IPPVC_90_LEGACY_H__

#include "ippdefs90legacy.h"
#include "ippvc90legacy_redef.h"
...
//              has to be working
*/
LEGACY90IPPAPI( IppStatus, legacy90ippvcInit, ( void ))
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippvcSetNumThreads, ( int numThr ) )
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippvcGetNumThreads, (int* pNumThr) )
...
LEGACY90IPPAPI( const IppLibraryVersion*, legacy90ippvcGetLibVersion, (void) )
...
LEGACY90IPPAPI(IppStatus, legacy90ippiHuffmanTableInitAlloc_32s, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiHuffmanRunLevelTableInitAlloc_32s, (
  const Ipp32s*                pSrcTable,
        IppVCHuffmanSpec_32s** ppDstSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanOne_1u32s, (
        Ipp32u**              ppBitStream,
        int*                  pOffset,
        Ipp32s*               pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeHuffmanPair_1u16s, (
        Ipp32u **ppBitStream,
        Ipp32s *pOffset,
  const IppVCHuffmanSpec_32s *pDecodeTable,
        Ipp8s *pFirst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructDCTBlock_MPEG1_32s, (
        Ipp32u** ppBitStream,
        int*     pOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructDCTBlockIntra_MPEG1_32s, (
        Ipp32u** ppBitStream,
        int*     pOffset,
  const Ipp32s*  pDCSizeTable,
  const Ipp32s*  pACTable,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructDCTBlock_MPEG2_32s, (
        Ipp32u**              ppBitStream,
        int*               pOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructDCTBlockIntra_MPEG2_32s, (
        Ipp32u**              ppBitStream,
        int*                  pOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiHuffmanTableFree_32s, (IppVCHuffmanSpec_32s *pDecodeTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvIntra_MPEG2_16s_C1I, (
  Ipp16s* pSrcDst,
  int     QP,
  Ipp16s* pQPMatrix))


LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInv_MPEG2_16s_C1I, (
  Ipp16s* pSrcDst,
  int     QP,
  Ipp16s* pQPMatrix))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCT8x8Inv_AANTransposed_16s_C1R, (
  const Ipp16s* pSrc,
        Ipp16s* pDst,
        Ipp32s  dstStep,
        Ipp32s  count))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCT8x8Inv_AANTransposed_16s8u_C1R, (
  const Ipp16s* pSrc,
        Ipp8u*  pDst,
        Ipp32s  dstStep,
        Ipp32s  count))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCT8x8Inv_AANTransposed_16s_P2C2R, (
  const Ipp16s* pSrcU,
  const Ipp16s* pSrcV,
        Ipp16s* pDstUV,
        Ipp32s  dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCT8x8Inv_AANTransposed_16s8u_P2C2R, (
  const Ipp16s* pSrcU,
  const Ipp16s* pSrcV,
        Ipp8u*  pDstUV,
        Ipp32s  dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCT8x8Fwd_8u16s_C2P2, (
       const Ipp8u* pSrc,
             Ipp32s srcStep,
             Ipp16s* pDstU,
             Ipp16s* pDstV ))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCT8x8InvOrSet_16s8u_P2C2, (
       const Ipp16s* pSrcU,
       const Ipp16s* pSrcV,
             Ipp8u* pDst,
             Ipp32s dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC16x16_8u_C1,(
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC16x8_8u_C1, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
  const Ipp16s*      pSrcYData,
        Ipp32s       srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC8x16_8u_C1, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
  const Ipp16s*      pSrcYData,
        Ipp32s       srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC8x8_8u_C1, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
  const Ipp16s*      pSrcYData,
        Ipp32s       srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC8x4_8u_C1, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
  const Ipp16s*      pSrcYData,
        Ipp32s       srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC4x8_8u_C1, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
  const Ipp16s*      pSrcYData,
        Ipp32s       srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC4x4_8u_C1, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
  const Ipp16s*      pSrcYData,
        Ipp32s       srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC2x4_8u_C1, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
  const Ipp16s*      pSrcYData,
        Ipp32s       srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC4x2_8u_C1, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
  const Ipp16s*      pSrcYData,
        Ipp32s       srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC2x2_8u_C1, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
  const Ipp16s*      pSrcYData,
        Ipp32s       srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC16x4_8u_C1, (
  const Ipp8u*  pSrcRef,
        Ipp32s  srcStep,
  const Ipp16s* pSrcYData,
        Ipp32s  srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC16x8UV_8u_C1, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcStep,
  const Ipp16s*      pSrcYData,
        Ipp32s       srcYDataStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC16x16B_8u_C1, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC16x8B_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC8x16B_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC8x8B_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC8x4B_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC4x8B_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC4x4B_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC2x4B_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC4x2B_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC2x2B_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC16x4B_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC16x8BUV_8u_C1, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcStepF,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC8x8_16s8u_P2C2R, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcRefStep,
  const Ipp16s*      pSrcU,
  const Ipp16s*      pSrcV,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC8x4_16s8u_P2C2R, (
  const Ipp8u*       pSrcRef,
        Ipp32s       srcRefStep,
  const Ipp16s*      pSrcU,
  const Ipp16s*      pSrcV,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC8x8B_16s8u_P2C2R, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcRefFStep,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMC8x4B_16s8u_P2C2R, (
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcRefFStep,
        Ipp32s       mcTypeF,
  const Ipp8u*       pSrcRefB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff16x16_8u16s_C1,(
  const Ipp8u*  pSrcCur,
        Ipp32s  srcCurStep,
  const Ipp8u*  pSrcRef,
        Ipp32s  srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff16x8_8u16s_C1, (
  const Ipp8u*  pSrcCur,
        Ipp32s  srcCurStep,
  const Ipp8u*  pSrcRef,
        Ipp32s  srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff8x8_8u16s_C1, (
  const Ipp8u*  pSrcCur,
        Ipp32s  srcCurStep,
  const Ipp8u*  pSrcRef,
        Ipp32s  srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff8x16_8u16s_C1, (
  const Ipp8u*  pSrcCur,
        Ipp32s  srcCurStep,
  const Ipp8u*  pSrcRef,
        Ipp32s  srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff8x4_8u16s_C1, (
  const Ipp8u*  pSrcCur,
        Ipp32s  srcCurStep,
  const Ipp8u*  pSrcRef,
        Ipp32s  srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff8x4_8u16s_C2P2,(const Ipp8u *pSrcCur,Ipp32s srcCurStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff8x8_8u16s_C2P2,(const Ipp8u *pSrcCur,Ipp32s srcCurStep,
                                             const Ipp8u *pSrcRef,Ipp32s srcRefStep,
                                             Ipp16s *pDstDiffU,Ipp32s dstDiffStepU,
                                             Ipp16s *pDstDiffV,Ipp32s dstDiffStepV,
                                             Ipp32s mcType,Ipp32s roundControl))
...
LEGACY90IPPAPI( IppStatus, legacy90ippiGetDiff4x4_8u16s_C1,(
  const Ipp8u*  pSrcCur,
        Ipp32s  srcCurStep,
  const Ipp8u*  pSrcRef,
                Ipp32s  srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff16x16B_8u16s_C1, (
  const Ipp8u*       pSrcCur,
        Ipp32s       srcCurStep,
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcRefStepF,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff16x8B_8u16s_C1, (
  const Ipp8u*       pSrcCur,
        Ipp32s       srcCurStep,
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcRefStepF,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff8x8B_8u16s_C1, (
  const Ipp8u*       pSrcCur,
        Ipp32s       srcCurStep,
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcRefStepF,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff8x16B_8u16s_C1, (
  const Ipp8u*       pSrcCur,
        Ipp32s       srcCurStep,
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcRefStepF,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff8x4B_8u16s_C1, (
  const Ipp8u*       pSrcCur,
        Ipp32s       srcCurStep,
  const Ipp8u*       pSrcRefF,
        Ipp32s       srcRefStepF,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff8x4B_8u16s_C2P2, (const Ipp8u *pSrcCur,Ipp32s srcCurStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGetDiff8x8B_8u16s_C2P2, (const Ipp8u *pSrcCur, Ipp32s srcCurStep,
                                               const Ipp8u *pSrcRefF,Ipp32s srcRefStepF,
                                               Ipp32s mcTypeF,
                                               const Ipp8u *pSrcRefB,Ipp32s srcRefStepB,
                                               Ipp32s mcTypeB,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD16x16_8u32s, (
  const Ipp8u*  pSrc,
        Ipp32s  srcStep,
  const Ipp8u*  pRef,
        Ipp32s  refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD4x4_8u32s,(const Ipp8u*  pSrc,
                                    Ipp32s        srcStep,
                                    const Ipp8u*  pRef,
                                    Ipp32s        refStep,
                                    Ipp32s*       pSAD,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD16x16Blocks8x8_8u16u,(const   Ipp8u*  pSrc,
                                               Ipp32s  srcStep,
                                               const   Ipp8u*  pRef,
                                               Ipp32s  refStep,
                                               Ipp16u*  pDstSAD,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD16x16Blocks4x4_8u16u, (const   Ipp8u*  pSrc,
                                                Ipp32s  srcStep,
                                                const   Ipp8u*  pRef,
                                                Ipp32s  refStep,
                                                Ipp16u*  pDstSAD,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSATD16x16_8u32s_C1R, (
       const Ipp8u  *pSrcCur,
       int           srcCurStep,
       const Ipp8u  *pSrcRef,
       int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSATD16x8_8u32s_C1R, (
       const Ipp8u  *pSrcCur,
       int           srcCurStep,
       const Ipp8u  *pSrcRef,
       int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSATD8x16_8u32s_C1R, (
       const Ipp8u  *pSrcCur,
       int           srcCurStep,
       const Ipp8u  *pSrcRef,
       int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSATD8x8_8u32s_C1R, (
       const Ipp8u  *pSrcCur,
       int           srcCurStep,
       const Ipp8u  *pSrcRef,
       int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSATD8x4_8u32s_C1R, (
       const Ipp8u  *pSrcCur,
       int           srcCurStep,
       const Ipp8u  *pSrcRef,
       int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSATD4x8_8u32s_C1R, (
       const Ipp8u  *pSrcCur,
       int           srcCurStep,
       const Ipp8u  *pSrcRef,
       int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSATD4x4_8u32s_C1R, (
       const Ipp8u  *pSrcCur,
       int           srcCurStep,
       const Ipp8u  *pSrcRef,
       int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAT8x8D_8u32s_C1R, (
       const Ipp8u* pSrcCur,
       int          srcCurStep,
       const Ipp8u* pSrcRef,
       int          srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAT8x8D_16u32s_C1R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSqrDiff16x16_8u32s, (
  const Ipp8u*  pSrc,
        Ipp32s  srcStep,
  const Ipp8u*  pRef,
        Ipp32s  refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSqrDiff16x16B_8u32s, (
  const Ipp8u*  pSrc,
        Ipp32s  srcStep,
  const Ipp8u*  pRefF,
        Ipp32s  refStepF,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVariance16x16_8u32s, (
  const Ipp8u*  pSrc,
        Ipp32s  srcStep,
        Ipp32s* pVar))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVarSum8x8_8u32s_C1R, (
  const Ipp8u*  pSrc,
        Ipp32s  srcStep,
        Ipp32s* pVar,
        Ipp32s* pSum))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVarSum8x8_16s32s_C1R, (
  const Ipp16s* pSrc,
        Ipp32s  srcStep,
        Ipp32s* pVar,
        Ipp32s* pSum))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVarMean8x8_8u32s_C1R, (
  const Ipp8u*  pSrc,
        Ipp32s  srcStep,
        Ipp32s* pVar,
        Ipp32s* pMean))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVarMean8x8_16s32s_C1R, (
  const Ipp16s* pSrc,
        Ipp32s  srcStep,
        Ipp32s* pVar,
        Ipp32s* pMean))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEdgesDetect16x16_8u_C1R, (
        const Ipp8u *pSrc,
        Ipp32u srcStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEdgesDetect16x16_16u_C1R, (
 const Ipp16u* pSrc,
       Ipp32s  srcStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVarMeanDiff16x16_8u32s_C1R, (
  const Ipp8u*  pSrc,
        Ipp32s  srcStep,
  const Ipp8u*  pRef,
        Ipp32s  refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiVarMeanDiff16x8_8u32s_C1R, (
  const Ipp8u*  pSrc,
        Ipp32s  srcStep,
  const Ipp8u*  pRef,
        Ipp32s  refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSumsDiff16x16Blocks4x4_8u16s_C1,
 (
  const Ipp8u*          pSrc,
        Ipp32s          srcStep,
  const Ipp8u*          pPred,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSumsDiff8x8Blocks4x4_8u16s_C1,
 (
  const Ipp8u*          pSrc,
        Ipp32s          srcStep,
  const Ipp8u*          pPred,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSumsDiff8x8Blocks4x4_8u16s_C2P2,
 (
  const Ipp8u*          pSrcUV,
        Ipp32s          srcStep,
  const Ipp8u*          pPredU,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantIntra_MPEG2_16s_C1I, (
        Ipp16s* pSrcDst,
        Ipp32s  QP,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuant_MPEG2_16s_C1I, (
        Ipp16s* pSrcDst,
        Ipp32s  QP,
  const Ipp32f* pQPMatrix,
        Ipp32s* pCount))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCreateRLEncodeTable, (
  const Ipp32s*                pSrcTable,
        IppVCHuffmanSpec_32s** ppDstSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiPutIntraBlock, (
  Ipp32u**              ppBitStream,
  int*                  pOffset,
  Ipp16s*               pSrcBlock,
  Ipp32s*               pDCPred,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiPutNonIntraBlock, (
  Ipp32u**              pBitStream,
  int*                  pOffset,
  Ipp16s*               pSrcBlock,
  IppVCHuffmanSpec_32s* pACTable,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInitAllocHuffmanTable_DV_32u, (
  Ipp32s*  pSrcTable1,
  Ipp32s*  pSrcTable2,
  Ipp32u** ppHuffTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFreeHuffmanTable_DV_32u, (Ipp32u* pHuffTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiHuffmanDecodeSegment_DV_8u16s, (
  const Ipp8u*  pStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiHuffmanDecodeSegmentOnePass_DV_8u16s, (
  const Ipp8u*  pStream,
  const Ipp32u* pZigzagTables,
  const Ipp32u* pHuffTable,
  Ipp16s* pBlock,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiHuffmanDecodeSegment_DV100_8u16s, (
  const Ipp8u*  pStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInv_DV_16s_C1I, (Ipp16s* pSrcDst, Ipp16s* pDequantTable))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCT2x4x8Inv_16s_C1I, (Ipp16s* pSrcDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCT2x4x8Frw_16s_C1I, (Ipp16s* pSrcDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCountZeros8x8_16s_C1, (Ipp16s* pSrc, Ipp32u* pCount))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFrameFieldSAD16x16_8u32s_C1R, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp32s*      pFrameSAD,
    Ipp32s*      pFieldSAD))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFrameFieldSAD16x16_16s32s_C1R, (
    const Ipp16s* pSrc,
    int           srcStep,
    Ipp32s*       pFrameSAD,
    Ipp32s*       pFieldSAD))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD16x8_8u32s_C1R, (
    const Ipp8u  *pSrcCur,
    int           srcCurStep,
    const Ipp8u  *pSrcRef,
    int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD8x16_8u32s_C1R, (
const Ipp8u  *pSrcCur,
int           srcCurStep,
const Ipp8u  *pSrcRef,
int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD8x4_8u32s_C1R, (
const Ipp8u  *pSrcCur,
int           srcCurStep,
const Ipp8u  *pSrcRef,
int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD4x8_8u32s_C1R, (
const Ipp8u  *pSrcCur,
int           srcCurStep,
const Ipp8u  *pSrcRef,
int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSSD8x8_8u32s_C1R, (
    const Ipp8u  *pSrcCur,
    int           srcCurStep,
    const Ipp8u  *pSrcRef,
    int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSSD4x4_8u32s_C1R, (
    const Ipp8u  *pSrcCur,
    int           srcCurStep,
    const Ipp8u  *pSrcRef,
    int           srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiScanFwd_16s_C1, (
       const Ipp16s* pSrc,
       Ipp16s*       pDst,
       int           countNonZero,
       int           scan))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiScanInv_16s_C1, (
    const Ipp16s* pSrc,
    Ipp16s*       pDst,
    int           indxLastNonZero,
    int           scan))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD8x8_8u32s_C1R, (
  const Ipp8u*  pSrcCur,
        int     srcCurStep,
  const Ipp8u*  pSrcRef,
        int     srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD8x8_8u32s_C2R, (
  const Ipp8u*  pSrcCur,
        int     srcCurStep,
  const Ipp8u*  pSrcRef,
        int     srcRefStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiMeanAbsDev16x16_8u32s_C1R, (
  const Ipp8u*  pSrc,
        int     srcStep,
        Ipp32s* pDst))


LEGACY90IPPAPI(IppStatus, legacy90ippiMeanAbsDev8x8_8u32s_C1R, (
  const Ipp8u*  pSrc,
        int     srcStep,
        Ipp32s* pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSub8x8_8u16s_C1R, (
    const Ipp8u*  pSrc1,
    int           src1Step,
    const Ipp8u*  pSrc2,
    int           src2Step,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSub16x16_8u16s_C1R, (
    const Ipp8u*  pSrc1,
    int           src1Step,
    const Ipp8u*  pSrc2,
    int           src2Step,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSubSAD8x8_8u16s_C1R, (
    const Ipp8u*  pSrc1,
    int           src1Step,
    const Ipp8u*  pSrc2,
    int           src2Step,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCopy8x8_8u_C1R, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCopy16x16_8u_C1R, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiAverage8x8_8u_C1IR, (
    const Ipp8u*  pSrc,
    int           srcStep,
    Ipp8u*        pSrcDst,
    int           srcDstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiAverage16x16_8u_C1IR, (
    const Ipp8u*  pSrc,
    int           srcStep,
    Ipp8u*        pSrcDst,
    int           srcDstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiAverage8x8_8u_C1R, (
    const Ipp8u*  pSrc1,
    int           src1Step,
    const Ipp8u*  pSrc2,
    int           src2Step,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiAverage16x16_8u_C1R, (
    const Ipp8u*  pSrc1,
    int           src1Step,
    const Ipp8u*  pSrc2,
    int           src2Step,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCopy8x4HP_8u_C1R, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCopy8x8HP_8u_C1R, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCopy16x8HP_8u_C1R, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCopy16x16HP_8u_C1R, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateAverage8x4_8u_C1IR, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pSrcDst,
    int          srcDstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateAverage8x8_8u_C1IR, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateAverage16x8_8u_C1IR, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateAverage16x16_8u_C1IR, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiAdd8x8_16s8u_C1IRS, (
    const Ipp16s* pSrc,
    int           srcStep,
    Ipp8u*        pSrcDst,
    int           srcDstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiAdd8x8HP_16s8u_C1RS, (
    const Ipp16s* pSrc1,
    int           src1Step,
    Ipp8u*        pSrc2,
    int           src2Step,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiAddC8x8_16s8u_C1IR, (
    Ipp16s   value,
    Ipp8u*   pSrcDst,
    int      srcDstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilter8x8_H261_8u_C1R, (
    Ipp8u*  pSrc,
    int     srcStep,
    Ipp8u*  pDst,
    int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCoeffsIntra_H261_1u16s, (
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  Ipp16s* pCoef,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCoeffsInter_H261_1u16s, (
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  Ipp16s* pCoef,
  int*    pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructCoeffsIntra_H261_1u16s, (
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  Ipp16s* pCoef,
  int*    pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructCoeffsInter_H261_1u16s, (
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  Ipp16s* pCoef,
  int*    pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsIntra_H261_16s1u, (
  Ipp16s* pQCoef,
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  int     countNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsInter_H261_16s1u, (
  Ipp16s* pQCoef,
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  int     countNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeDCIntra_H263_1u16s, (
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  Ipp16s* pDC))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCoeffsIntra_H263_1u16s, (
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  Ipp16s* pCoef,
  int*    pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCoeffsInter_H263_1u16s, (
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  Ipp16s* pCoef,
  int*    pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvIntra_H263_16s_C1I, (
    Ipp16s* pSrcDst,
    int     indxLastNonZero,
    int     QP,
    int     advIntraFlag,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvInter_H263_16s_C1I, (
    Ipp16s* pSrcDst,
    int     indxLastNonZero,
    int     QP,
    int     modQuantFlag))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiAddBackPredPB_H263_8u_C1R, (
  const Ipp8u* pSrc,
  int          srcStep,
  IppiSize     srcRoiSize,
  Ipp8u*       pSrcDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiResample_H263_8u_P3R, (
  const Ipp8u*    pSrcY,
  int             srcYStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiUpsampleFour_H263_8u_C1R, (
  const Ipp8u* pSrc,
  int          srcStep,
  IppiSize     srcRoiSize,
  Ipp8u*       pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDownsampleFour_H263_8u_C1R, (
  const Ipp8u* pSrc,
  int          srcStep,
  IppiSize     srcRoiSize,
  Ipp8u*       pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSpatialInterpolation_H263_8u_C1R, (
  const Ipp8u* pSrc,
  int          srcStep,
  IppiSize     srcRoiSize,
  Ipp8u*       pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiUpsampleFour8x8_H263_16s_C1R, (
  const Ipp16s* pSrc,
  int     srcStep,
  Ipp16s* pDst,
  int     dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDownsampleFour16x16_H263_16s_C1R, (
  const Ipp16s* pSrc,
  int           srcStep,
  Ipp16s*       pDst,
  int           dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblocking8x8HorEdge_H263_8u_C1IR, (
  Ipp8u* pSrcDst,
  int    srcDstStep,
  int    QP))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblocking8x8VerEdge_H263_8u_C1IR, (
  Ipp8u* pSrcDst,
  int    srcDstStep,
  int    QP))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblocking16x16HorEdge_H263_8u_C1IR, (
  Ipp8u* pSrcDst,
  int    srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblocking16x16VerEdge_H263_8u_C1IR, (
  Ipp8u* pSrcDst,
  int    srcDstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterBlockBoundaryHorEdge_H263_8u_C1IR, (
  Ipp8u* pSrcDst,
  int    srcDstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterBlockBoundaryVerEdge_H263_8u_C1IR, (
  Ipp8u* pSrcDst,
  int    srcDstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructCoeffsIntra_H263_1u16s, (
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  Ipp16s* pCoef,
  int*    pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructCoeffsInter_H263_1u16s, (
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  Ipp16s* pCoef,
  int*    pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeDCIntra_H263_16s1u, (
  Ipp16s  qDC,
  Ipp8u** ppBitStream,
  int*    pBitOffset))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsIntra_H263_16s1u, (
  Ipp16s* pQCoef,
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  int     countNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsInter_H263_16s1u, (
  Ipp16s* pQCoef,
  Ipp8u** ppBitStream,
  int*    pBitOffset,
  int     countNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantIntra_H263_16s_C1I, (
   Ipp16s* pSrcDst,
   int     QP,
   int*    pCountNonZero,
   int     advIntraFlag,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInter_H263_16s_C1I, (
   Ipp16s* pSrcDst,
   int     QP,
   int*    pCountNonZero,
   int     modQuantFlag))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblocking8x8HorEdge_MPEG4_8u_C1IR, (
  Ipp8u*  pSrcDst,
  int     step,
  int     QP,
  int     THR1,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblocking8x8VerEdge_MPEG4_8u_C1IR, (
  Ipp8u*  pSrcDst,
  int     step,
  int     QP,
  int     THR1,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeringingThreshold_MPEG4_8u_P3R, (
  const Ipp8u*  pSrcY,
        int     stepY,
  const Ipp8u*  pSrcCb,
        int     stepCb,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeringingSmooth8x8_MPEG4_8u_C1R, (
  const Ipp8u*  pSrc,
        int     srcStep,
        Ipp8u*  pDst,
        int     dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeDCIntra_MPEG4_16s1u, (
    Ipp16s   dcCoeff,
    Ipp8u**  ppBitStream,
    int*     pBitOffset,
    int      blockType))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsIntra_MPEG4_16s1u, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsInter_MPEG4_16s1u, (
    const Ipp16s*  pCoeffs,
    Ipp8u**        ppBitStream,
    int*           pBitOffset,
    int            countNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeDCIntra_MPEG4_1u16s, (
    Ipp8u**  ppBitStream,
    int*     pBitOffset,
    Ipp16s*  pDst,
    int      blockType))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCoeffsIntra_MPEG4_1u16s, (
    Ipp8u**  ppBitStream,
    int*     pBitOffset,
    Ipp16s*  pCoeffs,
    int*     pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCoeffsIntraRVLCBack_MPEG4_1u16s, (
    Ipp8u**  ppBitStream,
    int*     pBitOffset,
    Ipp16s*  pCoeffs,
    int*     pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCoeffsInter_MPEG4_1u16s, (
    Ipp8u**  ppBitStream,
    int*     pBitOffset,
    Ipp16s*  pCoeffs,
    int*     pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCoeffsInterRVLCBack_MPEG4_1u16s, (
    Ipp8u**  ppBitStream,
    int*     pBitOffset,
    Ipp16s*  pCoeffs,
    int*     pIndxLastNonZero))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructCoeffsInter_MPEG4_1u16s, (
    Ipp8u**                            ppBitStream,
    int*                               pBitOffset,
    Ipp16s*                            pCoeffs,
    int*                               pIndxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvIntraInit_MPEG4, (
    const Ipp8u*                 pQuantMatrix,
    IppiQuantInvIntraSpec_MPEG4* pSpec,
    int                          bitsPerPixel))


LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvInterInit_MPEG4, (
    const Ipp8u*                 pQuantMatrix,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvIntraGetSize_MPEG4, (
    int* pSpecSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvInterGetSize_MPEG4, (
    int* pSpecSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvIntra_MPEG4_16s_C1I, (
    Ipp16s*                            pCoeffs,
    int                                indxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvInter_MPEG4_16s_C1I, (
    Ipp16s*                            pCoeffs,
    int                                indxLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantIntraInit_MPEG4, (
    const Ipp8u*              pQuantMatrix,
    IppiQuantIntraSpec_MPEG4* pSpec,
    int                       bitsPerPixel))


LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInterInit_MPEG4, (
    const Ipp8u*              pQuantMatrix,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantIntraGetSize_MPEG4, (
    int* pSpecSize))


LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInterGetSize_MPEG4, (
    int* pSpecSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantIntra_MPEG4_16s_C1I, (
    Ipp16s*                         pCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInter_MPEG4_16s_C1I, (
    Ipp16s*                         pCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWarpInit_MPEG4, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWarpGetSize_MPEG4, (
    int*  pSpecSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWarpLuma_MPEG4_8u_C1R, (
    const Ipp8u*              pSrcY,
    int                       srcStepY,
    Ipp8u*                    pDstY,
    int                       dstStepY,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWarpChroma_MPEG4_8u_P2R, (
    const Ipp8u*              pSrcCb,
    int                       srcStepCb,
    const Ipp8u*              pSrcCr,
    int                       srcStepCr,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCalcGlobalMV_MPEG4, (
    int                        xOffset,
    int                        yOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiChangeSpriteBrightness_MPEG4_8u_C1IR, (
    Ipp8u*  pSrcDst,
    int     srcDstStep,
    int     width,
    int     height,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCopy8x8QP_MPEG4_8u_C1R, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCopy16x8QP_MPEG4_8u_C1R, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCopy16x16QP_MPEG4_8u_C1R, (
    const Ipp8u* pSrc,
    int          srcStep,
    Ipp8u*       pDst,
    int          dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiOBMC8x8HP_MPEG4_8u_C1R, (
  const Ipp8u*              pSrc,
        int                 srcStep,
        Ipp8u*              pDst,
        int                 dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiOBMC16x16HP_MPEG4_8u_C1R, (
  const Ipp8u*              pSrc,
        int                 srcStep,
        Ipp8u*              pDst,
        int                 dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiOBMC8x8QP_MPEG4_8u_C1R, (
  const Ipp8u*              pSrc,
        int                 srcStep,
        Ipp8u*              pDst,
        int                 dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiPredictIntra_4x4_H264_8u_C1IR, (
  Ipp8u*                    pSrcDst,
  Ipp32s                    srcdstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiPredictIntra_16x16_H264_8u_C1IR, (
  Ipp8u*                     pSrcDst,
  Ipp32s                     srcdstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiPredictIntraChroma8x8_H264_8u_C1IR, (
  Ipp8u*                      pSrcDst,
  Ipp32s                      srcdstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformDequantLumaDC_H264_16s_C1I, (
  Ipp16s* pSrcDst,
  Ipp32s  QP))


LEGACY90IPPAPI(IppStatus, legacy90ippiTransformDequantChromaDC_H264_16s_C1I, (
  Ipp16s* pSrcDst,
  Ipp32s  QP))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDequantTransformResidual_H264_16s_C1I, (
  Ipp16s* pSrcDst,
  Ipp32s  step,
  Ipp16s* pDC,
  Ipp32s  AC,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDequantTransformResidualAndAdd_H264_16s_C1I,(
    const Ipp8u*  pPred,
          Ipp16s* pSrcDst,
          Ipp16s* pDC,
          Ipp8u*  pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingLuma_VerEdge_H264_8u_C1IR, (
        Ipp8u*    pSrcDst,
        Ipp32s    srcdstStep,
  const Ipp8u*    pAlpha,
  const Ipp8u*    pBeta,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingLuma_VerEdge_MBAFF_H264_8u_C1IR, (
        Ipp8u*    pSrcDst,
        Ipp32s    srcdstStep,
        Ipp32u    nAlpha,
        Ipp32u    nBeta,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingLuma_HorEdge_H264_8u_C1IR, (
        Ipp8u*    pSrcDst,
        Ipp32s    srcdstStep,
  const Ipp8u*    pAlpha,
  const Ipp8u*    pBeta,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_VerEdge_H264_8u_C1IR, (
        Ipp8u*       pSrcDst,
        Ipp32s       srcdstStep,
  const Ipp8u*       pAlpha,
  const Ipp8u*       pBeta,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_VerEdge_H264_8u_C2IR, (
        Ipp8u*       pSrcDst,
        Ipp32u       srcdstStep,
  const Ipp8u*       pAlpha,
  const Ipp8u*       pBeta,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_VerEdge_H264_8u_C2I, ( const IppiFilterDeblock_8u * pDeblockInfo))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_VerEdge_MBAFF_H264_8u_C1IR, (
        Ipp8u*       pSrcDst,
        Ipp32s       srcdstStep,
        Ipp32u       nAlpha,
        Ipp32u       nBeta,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_HorEdge_H264_8u_C1IR, (
        Ipp8u*       pSrcDst,
        Ipp32s       srcdstStep,
  const Ipp8u*       pAlpha,
  const Ipp8u*       pBeta,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_HorEdge_H264_8u_C2IR, (
        Ipp8u*       pSrcDst,
        Ipp32u       srcdstStep,
  const Ipp8u*       pAlpha,
  const Ipp8u*       pBeta,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_HorEdge_H264_8u_C2I, (const IppiFilterDeblock_8u * pDeblockInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingLumaVerEdge_H264_16u_C1IR, (
            const IppiFilterDeblock_16u * pDeblockInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingLumaVerEdgeMBAFF_H264_16u_C1IR, (
            const IppiFilterDeblock_16u * pDeblockInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingLumaHorEdge_H264_16u_C1IR, (
            const IppiFilterDeblock_16u * pDeblockInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChromaVerEdge_H264_16u_C1IR, (
            const IppiFilterDeblock_16u * pDeblockInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChromaVerEdgeMBAFF_H264_16u_C1IR, (
            const IppiFilterDeblock_16u * pDeblockInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChromaHorEdge_H264_16u_C1IR, (
            const IppiFilterDeblock_16u * pDeblockInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma422VerEdge_H264_16u_C1IR, (
            const IppiFilterDeblock_16u * pDeblockInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma422HorEdge_H264_16u_C1IR, (
            const IppiFilterDeblock_16u * pDeblockInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma422VerEdge_H264_8u_C1IR, (
            const IppiFilterDeblock_8u * pDeblockInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma422HorEdge_H264_8u_C1IR, (
            const IppiFilterDeblock_8u * pDeblockInfo))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateLuma_H264_8u_C1R, (
  const Ipp8u*   pSrc,
        Ipp32s   srcStep,
        Ipp8u*   pDst,
        Ipp32s   dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateLumaTop_H264_8u_C1R, (
        const Ipp8u*   pSrc,
        Ipp32s   srcStep,
        Ipp8u*   pDst,
        Ipp32s   dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateLumaBottom_H264_8u_C1R, (
       const Ipp8u*   pSrc,
       Ipp32s   srcStep,
       Ipp8u*   pDst,
       Ipp32s   dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateLuma_H264_16u_C1R, (
       const IppVCInterpolate_16u * interpolateInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateLumaTop_H264_16u_C1R, (
       const IppVCInterpolate_16u * interpolateInfo, Ipp32s  outPixels))


LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateLumaBottom_H264_16u_C1R, (
       const IppVCInterpolate_16u * interpolateInfo, Ipp32s  outPixels))


LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateBlock_H264_8u_P2P1R, (
  const Ipp8u *pSrc1,
  const Ipp8u *pSrc2,
        Ipp8u *pDst,
        Ipp32u uWidth,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateLumaBlock_H264_8u_P1R, (const IppVCInterpolateBlock_8u *interpolateInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateLumaBlock_H264_16u_P1R, (const IppVCInterpolateBlock_16u *interpolateInfo))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChroma_H264_8u_C1R, (
  const Ipp8u*   pSrc,
        Ipp32s   srcStep,
        Ipp8u*   pDst,
        Ipp32s   dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChromaTop_H264_8u_C1R, (
  const Ipp8u*   pSrc,
        Ipp32s   srcStep,
        Ipp8u*   pDst,
        Ipp32s   dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChromaBottom_H264_8u_C1R, (
  const Ipp8u*   pSrc,
        Ipp32s   srcStep,
        Ipp8u*   pDst,
        Ipp32s   dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChroma_H264_16u_C1R, (
       const IppVCInterpolate_16u * interpolateInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChromaTop_H264_16u_C1R, (
       const IppVCInterpolate_16u * interpolateInfo, Ipp32s  outPixels))


LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChromaBottom_H264_16u_C1R, (
       const IppVCInterpolate_16u * interpolateInfo, Ipp32s  outPixels))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChroma_H264_8u_C2P2R, (
   const Ipp8u *pSrcUV,
         Ipp32s srcStep,
         Ipp8u *pDstU,
         Ipp8u *pDstV,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChromaBlock_H264_8u_P2R, (const IppVCInterpolateBlock_8u *interpolateInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChromaBlock_H264_16u_P2R, (const IppVCInterpolateBlock_16u *interpolateInfo))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChromaBlock_H264_8u_C2P2R, (const IppVCInterpolateBlock_8u *interpolateInfo))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateChromaBlock_H264_8u_C2C2R, (const IppVCInterpolateBlock_8u *interpolateInfo))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWeightedAverage_H264_8u_C1IR, (
  const Ipp8u*   pSrc1,
        Ipp8u*   pSrc2Dst,
        Ipp32s   srcDstStep,
        Ipp32s   weight1,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiUniDirWeightBlock_H264_8u_C1R, (
        Ipp8u *pSrcDst,
        Ipp32u srcDstStep,
        Ipp32u ulog2wd,
        Ipp32s iWeight,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiUniDirWeightBlock_H264_8u_C1IR, (
        Ipp8u *pSrcDst,
        Ipp32u srcDstStep,
        Ipp32u ulog2wd,
        Ipp32s iWeight,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBiDirWeightBlock_H264_8u_P2P1R,(
  const Ipp8u *pSrc1,
  const Ipp8u *pSrc2,
        Ipp8u *pDst,
        Ipp32u srcStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBiDirWeightBlockImplicit_H264_8u_P2P1R, (
  const Ipp8u *pSrc1,
  const Ipp8u *pSrc2,
        Ipp8u *pDst,
        Ipp32u srcStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBidir_H264_16u_P2P1R, (
            const IppVCBidir_16u * bidirInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiBidirWeightImplicit_H264_16u_P2P1R, (
            const IppVCBidir_16u * bidirInfo,
            Ipp32s iWeight1,
            Ipp32s iWeight2))


LEGACY90IPPAPI(IppStatus, legacy90ippiBidirWeight_H264_16u_P2P1R, (
            const IppVCBidir_16u * bidirInfo,
            Ipp32u ulog2wd,
            Ipp32s iWeight1,
            Ipp32s iOffset1,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiUnidirWeight_H264_16u_IP2P1R, (
            Ipp16u *pSrcDst,
            Ipp32u srcDstStep,
            Ipp32u ulog2wd,
            Ipp32s iWeight,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiUniDirWeightBlock_H264_8u_C2R, (
            IppVCWeightBlock_8u* pIppVCWeightBlock,
      const IppVCWeightParams_8u* pIppVCWeightParams))


LEGACY90IPPAPI(IppStatus, legacy90ippiBiDirWeightBlock_H264_8u_C2R,(
            IppVCWeightBlock_8u* pIppVCWeightBlock,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformPrediction_H264_8u16s_C1, (
  const Ipp8u   *pSrc,
        Ipp32s  step,
        Ipp16s  *pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDequantTransformResidual_SISP_H264_16s_C1I, (
        Ipp16s* pSrcDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformDequantChromaDC_SISP_H264_16s_C1I, (
        Ipp16s* pSrcDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntraMB_H264_16s8u_C1R, (Ipp16s **ppSrcCoeff,
                                                              Ipp8u *pSrcDstYPlane,
                                                              Ipp32s srcdstYStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaInterMB_H264_16s8u_P2R, (Ipp16s **ppSrcCoeff,
                                                                Ipp8u *pSrcDstUPlane,
                                                                Ipp8u *pSrcDstVPlane,
                                                                Ipp32u srcdstStep,
                                                                Ipp32u cbp4x4,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaInterMB_H264_16s8u_C2R, (Ipp16s **ppSrcDstCoeff,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntraHalfMB_H264_16s8u_C1R, (Ipp16s **ppSrcCoeff,
                                                                Ipp8u *pSrcDstYPlane,
                                                                Ipp32s srcdstYStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntraHalfsMB_H264_16s8u_P2R, (Ipp16s **ppSrcCoeff,
                                                                Ipp8u *pSrcDstUPlane,
                                                                Ipp8u *pSrcDstVPlane,
                                                                Ipp32u srcdstUVStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntraHalvesMB_H264_16s8u_P2R, (Ipp16s **ppSrcCoeff,
                                                                Ipp8u *pSrcDstUPlane,
                                                                Ipp8u *pSrcDstVPlane,
                                                                Ipp32u srcdstUVStep,
                                                                IppIntraChromaPredMode_H264 intra_chroma_mode,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntraHalvesMB_H264_16s8u_C2R, (Ipp16s **ppSrcDstCoeff,
                                                                Ipp8u *pSrcDstUVPlane,
                                                                Ipp32s srcdstUVStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntraMB_H264_16s8u_P2R, (Ipp16s **ppSrcCoeff,
                                                                Ipp8u *pSrcDstUPlane,
                                                                Ipp8u *pSrcDstVPlane,
                                                                Ipp32u srcdstUVStep,
                                                                IppIntraChromaPredMode_H264 intra_chroma_mode,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntraMB_H264_16s8u_C2R, (Ipp16s **ppSrcDstCoeff,
                                                                Ipp8u *pSrcDstUVPlane,
                                                                Ipp32s srcdstUVStep,
                                                                IppIntraChromaPredMode_H264 intraChromaMode,
                                                                Ipp32u cbp4x4,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaInterMB_H264_16s8u_C1R, (Ipp16s **ppSrcCoeff,
                                                              Ipp8u *pSrcDstYPlane,
                                                              Ipp32u srcdstYStep,
                                                              Ipp32u cbp4x4,
                                                              Ipp32s QP))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntra16x16MB_H264_16s8u_C1R, (Ipp16s **ppSrcCoeff,
                                                                   Ipp8u *pSrcDstYPlane,
                                                                   Ipp32u srcdstYStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntra_16x16MB_H264_16s8u_C1R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstYPlane,
        Ipp32u srcdstYStep,
        IppIntra16x16PredMode_H264 intra_luma_mode,
        Ipp32u cbp4x4,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntra4x4MB_H264_16s8u_C1R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstYPlane,
        Ipp32s srcdstYStep,
        IppIntra4x4PredMode_H264 *pMBIntraTypes,
        Ipp32u cbp4x4,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaInter4x4MB_H264_16s8u_C1R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstYPlane,
        Ipp32u srcdstYStep,
        Ipp32u cbp4x4,
        Ipp32s QP,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaInter4x4MB_H264_16s8u_P2R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstUPlane,
        Ipp8u *pSrcDstVPlane,
        Ipp32u srcdstUVStep,
        Ipp32u cbp4x4,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaInter4x4MB_H264_16s8u_C2R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstUVPlane,
        Ipp32u srcdstUVStep,
        Ipp32u cbp4x4,
        Ipp32u chromaQPU,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntra4x4MB_H264_16s8u_P2R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstUPlane,
        Ipp8u *pSrcDstVPlane,
        Ipp32u srcdstUVStep,
        IppIntraChromaPredMode_H264 intra_chroma_mode,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntra4x4MB_H264_16s8u_C2R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstUVPlane,
        Ipp32u srcdstUVStep,
        IppIntraChromaPredMode_H264 intraChromaMode,
        Ipp32u cbp4x4,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntra8x8MB_H264_16s8u_C1R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstYPlane,
        Ipp32s srcdstYStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaInter8x8MB_H264_16s8u_C1R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstYPlane,
        Ipp32u srcdstYStep,
        Ipp32u cbp8x8,
        Ipp32s QP,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntraHalf4x4MB_H264_16s8u_C1R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstYPlane,
        Ipp32s srcdstYStep,
        IppIntra4x4PredMode_H264 *pMBIntraTypes,
        Ipp32u cbp4x2,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntraHalf8x8MB_H264_16s8u_C1R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstYPlane,
        Ipp32s srcdstYStep,
        IppIntra8x8PredMode_H264 *pMBIntraTypes,
        Ipp32u cbp8x2,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntraHalfs4x4MB_H264_16s8u_P2R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstUPlane,
        Ipp8u *pSrcDstVPlane,
        Ipp32u srcdstUVStep,
        IppIntraChromaPredMode_H264 intra_chroma_mode,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntraHalves4x4MB_H264_16s8u_P2R, (Ipp16s **ppSrcDstCoeff,
        Ipp8u *pSrcDstUPlane,
        Ipp8u *pSrcDstVPlane,
        Ipp32u srcdstUVStep,
        IppIntraChromaPredMode_H264 intra_chroma_mode,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntra4x4_H264High_32s16u_IP2R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo[2],
            IppIntraChromaPredMode_H264 intraChromaMode,
            Ipp32u edgeType))


LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntraHalf4x4_H264High_32s16u_IP2R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo[2],
            IppIntraChromaPredMode_H264 intraChromaMode,
            Ipp32u edgeTypeTop,
            Ipp32u edgeTypeBottom))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaInter4x4_H264High_32s16u_IP2R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo[2]))


LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChroma422Intra4x4_H264High_32s16u_IP2R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo[2],
            IppIntraChromaPredMode_H264 intraChromaMode,
            Ipp32u edgeType,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChroma422IntraHalf4x4_H264High_32s16u_IP2R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo[2],
            IppIntraChromaPredMode_H264 intraChromaMode,
            Ipp32u edgeTypeTop,
            Ipp32u edgeTypeBottom,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChroma422Inter4x4_H264High_32s16u_IP2R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo[2],
            Ipp32u levelScaleDCU,
            Ipp32u levelScaleDCV))


LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntra4x4_H264High_32s16u_IP1R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo,
            const IppIntra4x4PredMode_H264 *pMBIntraTypes,
            Ipp32s edgeType))


LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntraHalf4x4_H264High_32s16u_IP1R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo,
            const IppIntra4x4PredMode_H264 *pMBIntraTypes,
            Ipp32u edgeType))


LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntra8x8_H264High_32s16u_IP1R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo,
            IppIntra8x8PredMode_H264 *pMBIntraTypes,
            Ipp32u edgeType))


LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntraHalf8x8_H264High_32s16u_IP1R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo,
            IppIntra8x8PredMode_H264 *pMBIntraTypes,
            Ipp32u edgeType))


LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntra16x16_H264High_32s16u_IP1R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo,
            IppIntra16x16PredMode_H264 intraLumaMode,
            Ipp32u edgeType))


LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaInter4x4_H264High_32s16u_IP1R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaInter8x8_H264High_32s16u_IP1R, (
            const IppiReconstructHighMB_32s16u * pReconstructInfo))


LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChroma422Intra4x4_H264High_16s8u_IP2R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChroma422IntraHalf4x4_H264High_16s8u_IP2R, (
            const IppiReconstructHighMB_16s8u * pReconstructInfo[2],
            IppIntraChromaPredMode_H264 intraChromaMode,
            Ipp32u edgeTypeTop,
            Ipp32u edgeTypeBottom,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChroma422Inter4x4_H264High_16s8u_IP2R, (
            const IppiReconstructHighMB_16s8u * pReconstructInfo[2],
            Ipp32u levelScaleDCU,
            Ipp32u levelScaleDCV))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateBlock_H264_8u_P3P1R, (
  const Ipp8u *pSrc1,
  const Ipp8u *pSrc2,
        Ipp8u *pDst,
        Ipp32u uWidth,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBiDirWeightBlock_H264_8u_P3P1R,( const Ipp8u *pSrc1,
       const Ipp8u *pSrc2,
       Ipp8u *pDst,
       Ipp32u nSrcPitch1,
       Ipp32u nSrcPitch2,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiBiDirWeightBlockImplicit_H264_8u_P3P1R,(const Ipp8u *pSrc1,
       const Ipp8u *pSrc2,
       Ipp8u *pDst,
       Ipp32u nSrcPitch1,
       Ipp32u nSrcPitch2,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCAVLCChromaDcCoeffs_H264_1u16s, (Ipp32u **ppBitStream,
                                                             Ipp32s *pOffset,
                                                             Ipp16s *pNumCoeff,
                                                             Ipp16s **ppDstCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCAVLCCoeffs_H264_1u16s, (Ipp32u **ppBitStream,
                                                     Ipp32s *pOffset,
                                                     Ipp16s *pNumCoeff,
                                                     Ipp16s **ppDstCoeffs,
                                                     Ipp32u uVLCSelect,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeExpGolombOne_H264_1u16s, (Ipp32u **ppBitStream,
                                                      Ipp32s *pBitOffset,
                                                      Ipp16s *pDst,
                                                      Ipp8u isSigned))


LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeExpGolombOne_H264_1u32s, (Ipp32u **ppBitStream,
                                                      Ipp32s *pBitOffset,
                                                      Ipp32s *pDst,
                                                      Ipp32s isSigned))


LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCAVLCChroma422DcCoeffs_H264_1u16s,(Ipp32u **ppBitStream,
                                                            Ipp32s *pBitOffset,
                                                            Ipp16s *pNumCoeff,
                                                            Ipp16s **ppDstCoeffs,
                                                            const Ipp32s *pTblCoeffToken,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCAVLCCoeffs_H264_1u32s, (Ipp32u **ppBitStream,
                                                     Ipp32s *pBitOffset,
                                                     Ipp16s *pNumCoeff,
                                                     Ipp32s **ppDstCoeffs,
                                                     Ipp32u uVLCSelect,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCAVLCChromaDcCoeffs_H264_1u32s, (Ipp32u **ppBitStream,
                                                             Ipp32s *pBitOffset,
                                                             Ipp16s *pNumCoeff,
                                                             Ipp32s **ppDstCoeffs,
                                                             const Ipp32s *pTblCoeffToken,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCAVLCChroma422DcCoeffs_H264_1u32s,(Ipp32u **ppBitStream,
                                                                 Ipp32s *pBitOffset,
                                                                 Ipp16s *pNumCoeff,
                                                                 Ipp32s **ppDstCoeffs,
                                                                 const Ipp32s *pTblCoeffToken,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiExpandPlane_H264_8u_C1R,   ( Ipp8u *StartPtr,
                                                    Ipp32u uFrameWidth,
                                                    Ipp32u uFrameHeight,
                                                    Ipp32u uPitch,
                                                    Ipp32u uPels,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsCAVLC_H264_16s, (
  const Ipp16s  *pSrc,
        Ipp8u   AC,
  const Ipp32s  *pScanMatrix,
        Ipp8u   Count,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsCAVLC_H264_32s ,(
 const Ipp32s* pSrc,
       Ipp32s  AC,
 const Ipp32s* pScanMatrix,
       Ipp32s  Count,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeChromaDcCoeffsCAVLC_H264_16s, (
  const Ipp16s  *pSrc,
        Ipp8u   *pTrailingOnes,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantChromaDC_H264_16s_C1I, (
        Ipp16s* pSrcDst,
        Ipp16s* pTBlock,
        Ipp32s  QPCroma,
        Ipp8s*  pNumLevels,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantLumaDC_H264_16s_C1I, (
        Ipp16s* pSrcDst,
        Ipp16s* pTBlock,
        Ipp32s  QP,
        Ipp8s*  pNumLevels,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantResidual_H264_16s_C1I , (
        Ipp16s* pSrcDst,
        Ipp32s  QP,
        Ipp8s*  pNumLevels,
        Ipp8u   intra,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb411ToYCbCr422_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb411ToYCbCr422_ZoomOut2_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb411ToYCbCr422_ZoomOut4_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb411ToYCbCr422_ZoomOut8_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5] ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb411ToYCbCr422_16x4x5MB_DV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstPitch ) )
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb411ToYCbCr422_EdgeDV_16s8u_P3C2R,(const Ipp16s* pSrc, Ipp8u* pDst, int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb411ToYCbCr422_ZoomOut2_EdgeDV_16s8u_P3C2R,(const Ipp16s* pSrc, Ipp8u* pDst, int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb411ToYCbCr422_ZoomOut4_EdgeDV_16s8u_P3C2R,(const Ipp16s* pSrc, Ipp8u* pDst, int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb411ToYCbCr422_ZoomOut8_EdgeDV_16s8u_P3C2R,(const Ipp16s* pSrc, Ipp8u* pDst, int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb411ToYCbCr422_8x8MB_DV_16s8u_P3C2R,(const Ipp16s* pSrc, Ipp8u* pDst, int dstPitch ) )
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb420ToYCbCr422_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb420ToYCbCr422_ZoomOut2_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb420ToYCbCr422_ZoomOut4_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb420ToYCbCr422_ZoomOut8_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb420ToYCbCr422_8x8x5MB_DV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstPitch ) )
...
LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb422ToYCbCr422_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb422ToYCbCr422_ZoomOut2_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb422ToYCbCr422_ZoomOut4_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb422ToYCbCr422_ZoomOut8_5MBDV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5] ))

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb422ToYCbCr422_8x4x5MB_DV_16s8u_P3C2R,(const Ipp16s* pSrc[5], Ipp8u* pDst[5], int dstStep ) )

LEGACY90IPPAPI(IppStatus, legacy90ippiYCrCb422ToYCbCr422_10HalvesMB16x8_DV100_16s8u_P3C2R, (const Ipp16s* pSrc, Ipp8u* pDst[10], int dstStep ) )
/* ///////////////////////////////////////////////////////////////////////////
//  Name:
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceFilterTriangle_8u_C1R, (
  const Ipp8u*   pSrc,
        Ipp32s   srcStep,
        Ipp8u*   pDst,
        Ipp32s   dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceFilterTriangle_8u_C2R, (
  const Ipp8u*   pSrc,
        Ipp32s   srcStep,
        Ipp8u*   pDst,
        Ipp32s   dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCbYCr422ToYCbCr420_Rotate_8u_C2P3R,(const Ipp8u* pSrc, int srcStep, IppiSize srcRoi,Ipp8u *pDst[3], int dstStep[3],
           int rotation ))

LEGACY90IPPAPI(IppStatus, legacy90ippiCbYCr422ToYCbCr420_Rotate_8u_P3R,(const Ipp8u* pSrc[3], int srcStep[3], IppiSize srcRoi,Ipp8u *pDst[3], int dstStep[3],
           int rotation ))
/* ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
LEGACY90IPPAPI(IppStatus, legacy90ippiResizeCCRotate_8u_C2R,(const Ipp8u* pSrc, int srcStep, IppiSize srcRoi,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGenScaleLevel8x8_H264_8u16s_D2, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformLuma8x8Fwd_H264_16s_C1I, (Ipp16s  *pSrcDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantLuma8x8_H264_16s_C1, (
    const Ipp16s *pSrc,
    Ipp16s       *pDst,
    int           Qp6,
    int           Intra,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantLuma8x8_H264_32s_C1, (
 const Ipp32s* pSrc,
       Ipp32s* pDst,
       Ipp32s  Qp6,
       Ipp32s  Intra,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantLuma8x8Inv_H264_16s_C1I, (
    Ipp16s       *pSrcDst,
    int           Qp6,
    const Ipp16s *pInvLevelScale))


LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvLuma8x8_H264_32s_C1I, (
       Ipp32s* pSrcDst,
       Ipp32s  Qp6,
 const Ipp16s* pInvLevelScale))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformLuma8x8InvAddPred_H264_16s8u_C1R, (
    const Ipp8u *pPred,
    int          PredStep,
    Ipp16s      *pSrcDst,
    Ipp8u       *pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantWeightBlockInv_DV_16s_C1I, (
       Ipp16s       *pSrcDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantWeightBlockInv_DV100_16s_C1I, (
       Ipp16s       *pSrcDst,
       const Ipp16s *pWeightInvTable,
       Ipp32s quantValue))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDCT8x4x2To4x4Inv_DV_16s_C1I, (
       Ipp16s       *pSrcDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransform8x8Inv_VC1_16s_C1R, (
 const Ipp16s *pSrc,
       int     srcStep,
       Ipp16s *pDst,
       int     dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransform4x4Inv_VC1_16s_C1R, (
 const Ipp16s *pSrc,
       int     srcStep,
       Ipp16s *pDst,
       int     dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransform8x4Inv_VC1_16s_C1R, (
 const Ipp16s *pSrc,
       int     srcStep,
       Ipp16s *pDst,
       int     dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransform4x8Inv_VC1_16s_C1R, (
 const Ipp16s *pSrc,
       int     srcStep,
       Ipp16s *pDst,
       int     dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransform8x8Inv_VC1_16s_C1IR, (
       Ipp16s *pSrcDst,
       int     srcDstStep,
       IppiSize srcSizeNZ))


LEGACY90IPPAPI(IppStatus, legacy90ippiTransform4x4Inv_VC1_16s_C1IR, (
       Ipp16s *pSrcDst,
       int     srcDstStep,
       IppiSize srcSizeNZ))


LEGACY90IPPAPI(IppStatus, legacy90ippiTransform8x4Inv_VC1_16s_C1IR, (
       Ipp16s *pSrcDst,
       int     srcDstStep,
       IppiSize srcSizeNZ))


LEGACY90IPPAPI(IppStatus, legacy90ippiTransform4x8Inv_VC1_16s_C1IR, (
       Ipp16s *pSrcDst,
       int     srcDstStep,
       IppiSize srcSizeNZ))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateQPBilinear_VC1_8u_C1R, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateQPBilinear_VC1_8u_C2R, (
  const IppVCInterpolate_8u* pParams))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateICBilinearBlock_VC1_8u_C1R,(
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateICBilinearBlock_VC1_8u_C2R,(
  const IppVCInterpolateBlockIC_8u* pParams))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateQPBicubic_VC1_8u_C1R, (
  const IppVCInterpolate_8u* pParams))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateICBicubicBlock_VC1_8u_C1R, (
   const IppVCInterpolateBlockIC_8u* pParams))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSmoothingLuma_VerEdge_VC1_16s8u_C1R, (Ipp16s* pSrcLeft, Ipp32s srcLeftStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSmoothingLuma_HorEdge_VC1_16s8u_C1R, (Ipp16s* pSrcUpper, Ipp32s srcUpperStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSmoothingChroma_HorEdge_VC1_16s8u_C1R, (Ipp16s* pSrcUpper, Ipp32s srcUpperStep,
                                                     Ipp16s* pSrcBottom, Ipp32s srcBottomStep,
                                                     Ipp8u* pDst, Ipp32s dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSmoothingChroma_HorEdge_VC1_16s8u_P2C2R,(Ipp16s* pSrcUpperU, Ipp32u srcUpperStepU,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSmoothingChroma_VerEdge_VC1_16s8u_C1R, (Ipp16s* pSrcLeft, Ipp32s srcLeftStep,
                                                     Ipp16s* pSrcRight, Ipp32s srcRightStep,
                                                     Ipp8u* pDst, Ipp32s dstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSmoothingChroma_VerEdge_VC1_16s8u_P2C2R, (Ipp16s* pSrcLeftU,  Ipp32u srcLeftStepU,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvIntraUniform_VC1_16s_C1IR, (Ipp16s* pSrcDst, Ipp32s srcDstStep,
                                                  Ipp32s doubleQuant, IppiSize* pDstSizeNZ))



LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvIntraNonuniform_VC1_16s_C1IR,(Ipp16s* pSrcDst, Ipp32s srcDstStep,
                                                          Ipp32s doubleQuant, IppiSize* pDstSizeNZ))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvInterUniform_VC1_16s_C1IR,(Ipp16s* pSrcDst, Ipp32s srcDstStep,
                                                       Ipp32s doubleQuant, IppiSize roiSize,
                                                       IppiSize* pDstSizeNZ))



LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvInterNonuniform_VC1_16s_C1IR,(Ipp16s* pSrcDst, Ipp32s srcDstStep,
                                                          Ipp32s doubleQuant, IppiSize roiSize,
                                                          IppiSize* pDstSizeNZ))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvIntraUniform_VC1_16s_C1R, (const Ipp16s* pSrc, Ipp32s srcStep, Ipp16s* pDst, Ipp32s dstStep,
                                                               Ipp32s doubleQuant, IppiSize *pDstSizeNZ))



LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvIntraNonuniform_VC1_16s_C1R,(const Ipp16s* pSrc, Ipp32s srcStep, Ipp16s* pDst, Ipp32s dstStep,
                                                                 Ipp32s doubleQuant, IppiSize *pDstSizeNZ ))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvInterUniform_VC1_16s_C1R,(const Ipp16s* pSrc, Ipp32s srcStep, Ipp16s* pDst, Ipp32s dstStep,
                                                       Ipp32s doubleQuant, IppiSize roiSize, IppiSize* pDstSizeNZ))



LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInvInterNonuniform_VC1_16s_C1R,(const Ipp16s* pSrc, Ipp32s srcStep, Ipp16s* pDst, Ipp32s dstStep,
                                                          Ipp32s doubleQuant, IppiSize roiSize, IppiSize* pDstSizeNZ))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingLuma_VerEdge_VC1_8u_C1IR,(Ipp8u* pSrcDst,
                                                                Ipp32s pQuant,
                                                                Ipp32s srcdstStep,
                                                                Ipp32s edgeDisabledFlag))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_VerEdge_VC1_8u_C1IR,(Ipp8u* pSrcDst,
                                                                  Ipp32s pQuant,
                                                                  Ipp32s srcdstStep,
                                                                  Ipp32s edgeDisabledFlag))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingLuma_HorEdge_VC1_8u_C1IR,(Ipp8u* pSrcDst,
                                                               Ipp32s pQuant,
                                                               Ipp32s srcdstStep,
                                                               Ipp32s edgeDisabledFlag))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_HorEdge_VC1_8u_C1IR,(Ipp8u* pSrcDst,
                                                                 Ipp32s pQuant,
                                                                 Ipp32s srcdstStep,
                                                                 Ipp32s edgeDisabledFlag))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_VerEdge_VC1_8u_C2IR,(Ipp8u* pSrcDst,Ipp32u pQuant, Ipp32s srcdstStep,
                                                                  Ipp32u uEdgeDisabledFlag, Ipp32u vEdgeDisabledFlag))

LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_HorEdge_VC1_8u_C2IR,(Ipp8u* pSrcDst,Ipp32u pQuant, Ipp32s srcdstStep,
                                                                  Ipp32u uEdgeDisabledFlag, Ipp32u vEdgeDisabledFlag))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiRangeMapping_VC1_8u_C1R ,(Ipp8u* pSrc, Ipp32s srcStep,
                             Ipp8u* pDst, Ipp32s dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantIntraUniform_VC1_16s_C1IR, (Ipp16s* pSrcDst, Ipp32s srcDstStep,
                                                  Ipp32s doubleQuant))



LEGACY90IPPAPI(IppStatus, legacy90ippiQuantIntraNonuniform_VC1_16s_C1IR,(Ipp16s* pSrcDst, Ipp32s srcDstStep,
                                                          Ipp32s doubleQuant))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInterUniform_VC1_16s_C1IR,(Ipp16s* pSrcDst, Ipp32s srcDstStep,
                                                       Ipp32s doubleQuant, IppiSize roiSize))



LEGACY90IPPAPI(IppStatus, legacy90ippiQuantInterNonuniform_VC1_16s_C1IR,(Ipp16s* pSrcDst, Ipp32s srcDstStep,
                                                          Ipp32s doubleQuant, IppiSize roiSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransform8x8Fwd_VC1_16s_C1R, (const Ipp16s *pSrc, Ipp32s srcStep,
                                                    Ipp16s *pDst, Ipp32s dstStep))

LEGACY90IPPAPI(IppStatus, legacy90ippiTransform4x4Fwd_VC1_16s_C1R, (const Ipp16s *pSrc, Ipp32s srcStep,
                                                    Ipp16s *pDst, Ipp32s dstStep))

LEGACY90IPPAPI(IppStatus, legacy90ippiTransform8x4Fwd_VC1_16s_C1R, (const Ipp16s *pSrc, Ipp32s srcStep,
                                                    Ipp16s *pDst, Ipp32s dstStep))

LEGACY90IPPAPI(IppStatus, legacy90ippiTransform4x8Fwd_VC1_16s_C1R, (const Ipp16s *pSrc, Ipp32s srcStep,
                                                    Ipp16s *pDst, Ipp32s dstStep))


LEGACY90IPPAPI(IppStatus, legacy90ippiTransform8x8Fwd_VC1_16s_C1IR, (Ipp16s *pSrcDst, Ipp32s srcDstStep))

LEGACY90IPPAPI(IppStatus, legacy90ippiTransform4x4Fwd_VC1_16s_C1IR, (Ipp16s *pSrcDst, Ipp32s srcDstStep))

LEGACY90IPPAPI(IppStatus, legacy90ippiTransform8x4Fwd_VC1_16s_C1IR, (Ipp16s *pSrcDst, Ipp32s srcDstStep))

LEGACY90IPPAPI(IppStatus, legacy90ippiTransform4x8Fwd_VC1_16s_C1IR, (Ipp16s *pSrcDst, Ipp32s srcDstStep))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiHadamard8x8Sum_VC1_8u16s,(Ipp8u* pSrc, Ipp32u srcStep, Ipp16s* pDst, Ipp32s* pSum))


LEGACY90IPPAPI(IppStatus, legacy90ippiHadamard8x8Sum_VC1_16s,(Ipp16s* pSrc, Ipp32u srcStep, Ipp16s* pDst, Ipp32s* pSum))
...
LEGACY90IPPAPI( IppStatus, legacy90ippiSub4x4_8u16s_C1R, ( const Ipp8u* pSrc1,
       int src1Step,
       const Ipp8u* pSrc2,
       int src2Step,
       Ipp16s* pDst,
...
LEGACY90IPPAPI( IppStatus, legacy90ippiSub4x4_16u16s_C1R, ( const Ipp16u* pSrc1,
       int src1Step,
       const Ipp16u* pSrc2,
       int src2Step,
       Ipp16s* pDst,
...
LEGACY90IPPAPI( IppStatus, legacy90ippiSub8x8_16u16s_C1R, (const Ipp16u* pSrc1,
                                              Ipp32s  src1Step,
                                        const Ipp16u* pSrc2,
                                              Ipp32s  src2Step,
                                              Ipp16s* pDst,
...
LEGACY90IPPAPI( IppStatus, legacy90ippiSAD16x16_16u32s_C1R, (const Ipp16u* pSrc,
                                               Ipp32s  srcStep,
                                         const Ipp16u* pRef,
                                               Ipp32s  refStep,
                                               Ipp32s* pSAD,
...
LEGACY90IPPAPI( IppStatus, legacy90ippiSAD4x4_16u32s_C1R, (const Ipp16u* pSrc,
                                             Ipp32s  srcStep,
                                       const Ipp16u* pRef,
                                             Ipp32s  refStep,
                                             Ipp32s* pSAD,
...
LEGACY90IPPAPI( IppStatus, legacy90ippiSAD8x8_16u32s_C1R, (const Ipp16u* pSrcCur,
                                                 Ipp32s  srcCurStep,
                                           const Ipp16u* pSrcRef,
                                                 Ipp32s  srcRefStep,
                                                 Ipp32s* pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantFwd4x4_H264_16s_C1, (
 const Ipp16s *pSrc,
       Ipp16s *pDst,
       Ipp32s  Qp6,
       Ipp32s *pNumCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantFwd4x4_H264_16s32s_C1, (
 const Ipp16s* pSrc,
       Ipp32s* pDst,
       Ipp32s  QP,
       Ipp32s* pNumCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantInvAddPred4x4_H264_16s_C1IR, (
 const Ipp8u*  pPred,
       Ipp32s  predStep,
       Ipp16s* pSrcDst,
 const Ipp16s* pDC,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantInvAddPred4x4_H264_32s_C1IR, (
 const Ipp16u* pPred,
       Ipp32s  predStep,
       Ipp32s* pSrcDst,
 const Ipp32s* pDC,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantFwdLumaDC4x4_H264_16s_C1I, (
       Ipp16s* pDCBuf,
       Ipp16s* pTBuf,
       Ipp32s  QP,
       Ipp32s* pNumCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantFwdLumaDC4x4_H264_32s_C1I, (
       Ipp32s* pDCBuf,
       Ipp32s* pQBuf,
       Ipp32s  QP,
       Ipp32s* NumCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantInvLumaDC4x4_H264_16s_C1I, (
       Ipp16s* pSrcDst,
       Ipp32s  QP,
 const Ipp16s* pScaleLevelsInv))


LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantInvLumaDC4x4_H264_32s_C1I, (
       Ipp32s* pSrcDst,
       Ipp32s  QP,
 const Ipp16s* pScaleLevels))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantFwdChromaDC2x2_H264_16s_C1I, (
       Ipp16s *pDCBuf,
       Ipp16s *pTBuf,
       Ipp32s  QP,
       Ipp32s* pNumCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantFwdChromaDC2x2_H264_32s_C1I, (
       Ipp32s* pSrcDst,
       Ipp32s* pTBlock,
       Ipp32s  QPChroma,
       Ipp32s* NumCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantInvChromaDC2x2_H264_16s_C1I, (
       Ipp16s* pSrcDst,
       Ipp32s  QP,
 const Ipp16s *pScaleLevels))


LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantInvChromaDC2x2_H264_32s_C1I, (
       Ipp32s* pSrcDst,
       Ipp32s  QP,
 const Ipp16s *pScaleLevels))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantFwdChromaDC2x4_H264_16s_C1I, (
       Ipp16s *pDCBuf,
       Ipp16s *pTBuf,
       Ipp32s  QPChroma,
       Ipp32s* NumCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantFwdChromaDC2x4_H264_32s_C1I, (
       Ipp32s *pDCBuf,
       Ipp32s *pTBuf,
       Ipp32s  QPChroma,
       Ipp32s* NumCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantInvChromaDC2x4_H264_16s_C1I, (
       Ipp16s* pSrcDst,
       Ipp32s  QPChroma,
 const Ipp16s* pScaleLevels))


LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuantInvChromaDC2x4_H264_32s_C1I, (
       Ipp32s *pSrcDst,
       Ipp32s  QPChroma,
 const Ipp16s* pScaleLevelsInv))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiGenScaleLevel4x4_H264_8u16s_C1, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD16x16Blocks4x4_16u32u_C1R, (
 const Ipp16u* pSrc,
       Ipp32s  srcStep,
 const Ipp16u* pRef,
       Ipp32s  refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD16x16Blocks8x8_16u32u_C1R, (
 const Ipp16u* pSrc,
       Ipp32s  srcStep,
 const Ipp16u* pRef,
       Ipp32s  refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD2x2xN_8u16u_C1R, (
 const Ipp8u *pSrc,
       Ipp32s srcStep,
 const Ipp8u *pRef,
       Ipp32s refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD4x4xN_8u16u_C1R, (
 const Ipp8u *pSrc,
       Ipp32s srcStep,
 const Ipp8u *pRef,
       Ipp32s refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD4x4xNI_8u16u_C1R, (
 const Ipp8u *pSrc,
       Ipp32s srcStep,
 const Ipp8u *pRef,
       Ipp32s refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD8x8xN_8u16u_C1R, (
 const Ipp8u *pSrc,
       Ipp32s srcStep,
 const Ipp8u *pRef,
       Ipp32s refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD8x8xNI_8u16u_C1R, (
 const Ipp8u *pSrc,
       Ipp32s srcStep,
 const Ipp8u *pRef,
       Ipp32s refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD16x16xN_8u16u_C1R, (
 const Ipp8u *pSrc,
       Ipp32s srcStep,
 const Ipp8u *pRef,
       Ipp32s refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSAD16x16xNI_8u16u_C1R, (
 const Ipp8u *pSrc,
       Ipp32s srcStep,
 const Ipp8u *pRef,
       Ipp32s refStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSumsDiff16x16Blocks4x4_16u32s_C1R, (
 const Ipp16u* pSrc,
       Ipp32s  srcStep,
 const Ipp16u* pPred,
       Ipp32s  predStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiSumsDiff8x8Blocks4x4_16u32s_C1R, (
 const Ipp16u* pSrc,
       Ipp32s  srcStep,
 const Ipp16u* pPred,
       Ipp32s  predStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformFwdLuma8x8_H264_16s32s_C1, (
 const Ipp16s* pSrc,
       Ipp32s* pDst))


LEGACY90IPPAPI(IppStatus, legacy90ippiTransformFwdLuma8x8_H264_16s_C1, (
 const Ipp16s*  pSrc,
       Ipp16s*  pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformInvAddPredLuma8x8_H264_32s16u_C1R, (
 const Ipp16u*  pPred,
       Ipp32s   predStep,
       Ipp32s*  pSrcDst,
       Ipp16u*  pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsCAVLCChromaDC2x2_H264_32s, (
 const Ipp32s* pSrc,
       Ipp8u*  pTrailingOnes,
       Ipp8u*  pTrailingOneSigns,
       Ipp8u*  pNumOutCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsCAVLCChromaDC2x4_H264_16s, (
 const Ipp16s *pSrc,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiEncodeCoeffsCAVLCChromaDC2x4_H264_32s, (
 const Ipp32s *pSrc,
       Ipp8u  *pTrailing_Ones,
       Ipp8u  *pTrailing_One_Signs,
       Ipp8u  *pNumOutCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiInterpolateLumaBlock_AVS_8u_P1R,(const IppVCInterpolateBlock_8u *interpolateInfo))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiWeightPrediction_AVS_8u_C1R,(const Ipp8u *pSrc,
                                                         Ipp32s srcStep,
                                                         Ipp8u *pDst,
                                                         Ipp32s dstStep,
                                                         Ipp32u scale,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaIntra_AVS_16s8u_C1R,(Ipp16s **ppSrcCoeff,
                                                        Ipp8u *pSrcDstYPlane,
                                                        Ipp32s srcDstYStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructLumaInter_AVS_16s8u_C1R,(Ipp16s **ppSrcCoeff,
                                                         Ipp8u *pSrcDstYPlane,
                                                         Ipp32s srcDstYStep,
                                                         const Ipp32s *pSrcNumCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaIntra_AVS_16s8u_C1R,(Ipp16s **ppSrcCoeff,
                                                           Ipp8u *pSrcDstUPlane,
                                                           Ipp8u *pSrcDstVPlane,
                                                           Ipp32s srcDstUVStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiReconstructChromaInter_AVS_16s8u_C1R,(Ipp16s **ppSrcCoeff,
                                                           Ipp8u *pSrcDstUPlane,
                                                           Ipp8u *pSrcDstVPlane,
                                                           Ipp32s srcDstUVStep,
                                                           const Ipp32s *pSrcNumCoeffs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingLuma_VerEdge_AVS_8u_C1IR,(const IppiFilterDeblock_8u *pDeblockInfo))

LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingLuma_HorEdge_AVS_8u_C1IR,(const IppiFilterDeblock_8u *pDeblockInfo))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_VerEdge_AVS_8u_C1IR,(const IppiFilterDeblock_8u *pDeblockInfo))

LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDeblockingChroma_HorEdge_AVS_8u_C1IR,(const IppiFilterDeblock_8u *pDeblockInfo))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeLumaBlockIntra_AVS_1u16s,(Ipp32u **ppBitStream,
                                                      Ipp32s *pBitOffset,
                                                      Ipp32s *pNumCoeff,
                                                      Ipp16s *pDstCoeffs,
                                                      Ipp32u scanType))

LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeLumaBlockInter_AVS_1u16s,(Ipp32u **ppBitStream,
                                                      Ipp32s *pBitOffset,
                                                      Ipp32s *pNumCoeff,
                                                      Ipp16s *pDstCoeffs,
                                                      Ipp32u scanType))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeChromaBlock_AVS_1u16s,(Ipp32u **ppBitStream,
                                                   Ipp32s *pBitOffset,
                                                   Ipp32s *pNumCoeff,
                                                   Ipp16s *pDstCoeffs,
                                                   Ipp32u scanType))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceMedianThreshold_8u_C1R, (const Ipp8u *pSrc,
                                                          int srcStep,
                                                          Ipp8u *pDst,
                                                          int dstStep,
                                                          IppiSize size,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceEdgeDetect_8u_C1R, (const Ipp8u *pSrc,
                                                     int srcStep,
                                                     Ipp8u *pDst,
                                                     int dstStep,
                                                     IppiSize size,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceMotionAdaptive_8u_C1, (const Ipp8u *pSrcPlane[4],
                                                        int srcStep,
                                                        Ipp8u *pDst,
                                                        int dstStep,
                                                        IppiSize planeSize,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceBlendInitAlloc_8u_C1, (IppiSize planeSize,
                                                        int blendThresh[2],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceBlendInit_8u_C1, (IppiSize size,
                                                   int blendThresh[2],
                                                   double blendConstants[2],
                                                   IppiDeinterlaceBlendState_8u_C1 **ppState,
                                                   Ipp8u *pMemState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceBlendGetSize_8u_C1, (int *pStateSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceBlendInitAlloc_8u_C2, (IppiSize size,
                                                        int blendThresh[2],
                                                        double blendConstants[2],
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceBlendInit_8u_C2, (IppiSize size,
                                                   int blendThresh[2],
                                                   double blendConstants[2],
                                                   IppiDeinterlaceBlendSpec_8u_C2 **ppSpec,
                                                   Ipp8u *pMemState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceBlendGetSize_8u_C2, (int *pSpecSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceBlend_8u_C1, (const Ipp8u *pSrcPlane[3],
                                               int srcStep,
                                               Ipp8u *pDst,
                                               int dstStep,
                                               IppiSize planeSize,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceBlend_8u_C2, (const Ipp8u* pSrcPrev, int srcStepPrev,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceBlendFree_8u_C1, (IppiDeinterlaceBlendState_8u_C1 *pState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDeinterlaceBlendFree_8u_C2, (IppiDeinterlaceBlendSpec_8u_C2 *pSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDenoiseSmooth_8u_C1R, (const Ipp8u* pSrc,
                                                   int           srcStep,
                                                   Ipp8u*        pDst,
                                                   int           dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDenoiseAdaptiveInitAlloc_8u_C1, (IppiDenoiseAdaptiveState_8u_C1 **ppState,
                                                             IppiSize roiSize,
                                                             IppiSize maskSize))
 ...
 */
 ...
 LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDenoiseAdaptive_8u_C1R, (const Ipp8u* pSrcPlane[3],
                                                     int           srcStep,
                                                     Ipp8u*        pDst,
                                                     int           dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDenoiseAdaptiveFree_8u_C1, (IppiDenoiseAdaptiveState_8u_C1 *pState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDenoiseMosquitoInitAlloc_8u_C1, (IppiDenoiseMosquitoState_8u_C1 **ppState, IppiSize roiSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDenoiseMosquitoFree_8u_C1, (IppiDenoiseMosquitoState_8u_C1 *pState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDenoiseMosquito_8u_C1R, (const Ipp8u *pSrcPlane[2],
                                                     int           srcStep,
                                                     Ipp8u*        pDst,
                                                     int           dstStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDenoiseCASTInit, (IppDenoiseCAST *pInParam))


LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDenoiseCASTYUV422_8u_C2R,(const Ipp8u* pSrcCur, const Ipp8u* pSrcPrev, int srcStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiFilterDenoiseCAST_8u_C1R, (const Ipp8u* pSrcCur, const Ipp8u* pSrcPrev, int srcStep,
                                                 const Ipp8u* pSrcEdge, int srcEdgeStep,
                                                 IppiSize srcRoiSize,
                                                 Ipp8u* pDst, int dstStep,
                                                 Ipp8u* pHistoryWeight, IppDenoiseCAST *pInParam))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformResidual4x4Fwd_H264_16s_C1, (const Ipp16s *pSrc,
                                                            Ipp16s *pDst))

LEGACY90IPPAPI(IppStatus, legacy90ippiTransformResidual4x4Fwd_H264_32s_C1, (const Ipp32s *pSrc,
                                                            Ipp32s *pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformResidual4x4Inv_H264_16s_C1, (const Ipp16s *pSrc,
                                                            Ipp16s *pDst))

LEGACY90IPPAPI(IppStatus, legacy90ippiTransformResidual4x4Inv_H264_32s_C1, (const Ipp32s *pSrc,
                                                            Ipp32s *pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiTransformQuant8x8Fwd_AVS_16s_C1, (const Ipp16s *pSrc,
                                                        Ipp16s *pDst,
                                                        Ipp32u *pNumCoeffs,
                                                        Ipp32u QP,
                                                        Ipp32u roundMode))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDisassembleLumaIntra_AVS_16s8u_C1R, (const Ipp8u *pSrcPlane, Ipp32s srcStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDisassembleChroma420Intra_AVS_16s8u_C1R, (const Ipp8u *pSrcPlane[2], Ipp32s srcStep,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantizeResidual4x4Fwd_H264_16s_C1, (const Ipp16s *pSrc,
                                                           Ipp16s *pDst,
                                                           Ipp32u *pNumNonZeros,
                                                           Ipp32u *pLastNonZero,
                                                           const Ipp16s *pQuantTable,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantizeResidual4x4Fwd_H264_16s32s_C1, (const Ipp16s *pSrc,
                                                              Ipp16s *pDst,
                                                              Ipp32u *pNumNonZeros,
                                                              Ipp32u *pLastNonZero,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiQuantizeResidual4x4Fwd_H264_32s_C1, (const Ipp32s *pSrc,
                                                           Ipp32s *pDst,
                                                           Ipp32u *pNumNonZeros,
                                                           Ipp32u *pLastNonZero,
                                                           const Ipp32s *pQuantTable,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACGetSize_H264, (
    Ipp32u* pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACInit_H264, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACInitAlloc_H264, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACFree_H264, (
    IppvcCABACState* pCabacState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACSetStream_H264, (
    Ipp8u*          pBitStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACGetStreamSize_H264, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACEncodeBin_H264, (
    Ipp32u          ctxIdx,
    Ipp32u          code,
    IppvcCABACState* pCabacState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACEncodeBinBypass_H264, (
    Ipp32u          code,
    IppvcCABACState* pCabacState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACTerminateSlice_H264, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACEncodeResidualBlock_H264_16s, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACEncodeResidualBlock_H264_32s, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiCABACGetContexts_H264, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippiDecodeCAVLCCoeffsIdxs_H264_1u16s, (Ipp32u **ppBitStream,
    Ipp32s *pOffset,
    Ipp16s *pNumCoeff,
    Ipp16s **ppPosCoefbuf,
    Ipp32u uVLCSelect,
