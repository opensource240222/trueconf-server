...
#if !defined(__IPPAC_90_LEGACY_H__)
#define __IPPAC_90_LEGACY_H__
...
//              has to be working
*/
LEGACY90IPPAPI( IppStatus, legacy90ippacInit, ( void ))
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippacSetNumThreads, ( int numThr ) )
...
*/
LEGACY90IPPAPI( IppStatus, legacy90ippacGetNumThreads, (int* pNumThr) )
...
LEGACY90IPPAPI(const IppLibraryVersion*, legacy90ippacGetLibVersion, (void))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFDPReset_32f, (IppsFDPState_32f *pFDPState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFDPResetSfb_32f, (const int* pSfbOffset, int sfbNumber, const Ipp8u* pResetFlag, IppsFDPState_32f* pFDPState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFDPResetGroup_32f, (int resetGroupNumber, int step, IppsFDPState_32f* pFDPState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFDPInitAlloc_32f, (IppsFDPState_32f** ppFDPState, int len))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFDPFree_32f, (IppsFDPState_32f *pFDPState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFDPFwd_32f, (const Ipp32f* pSrc, Ipp32f* pDst, IppsFDPState_32f* pFDPState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFDPInv_32f_I, (Ipp32f* pSrcDst, const int* pBandOffset, int predictorBandsNumber, const Ipp8u* pPredictionUsed, IppsFDPState_32f* pFDPState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFDPInit_32f, (IppsFDPState_32f **ppFDPState, int len, Ipp8u *pMemSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFDPGetSize_32f, (int len, int *pSizeState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRBlockInitAlloc_32f,(IppsFIRBlockState_32f** pState,
int order, int len))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRBlockFree_32f,(IppsFIRBlockState_32f* pState))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsFIRBlockOne_32f,(Ipp32f *pSrc, Ipp32f* pDst, IppsFIRBlockState_32f* pState, Ipp32f *pTaps))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwdInitAlloc_32f,(IppsMDCTFwdSpec_32f** ppMDCTSpec, int len))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInvInitAlloc_32f,(IppsMDCTInvSpec_32f** ppMDCTSpec, int len))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwdFree_32f,(IppsMDCTFwdSpec_32f* pMDCTSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInvFree_32f,(IppsMDCTInvSpec_32f* pMDCTSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwdGetBufSize_32f,(const IppsMDCTFwdSpec_32f* pMDCTSpec,
    int* pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInvGetBufSize_32f,(const IppsMDCTInvSpec_32f* pMDCTSpec,
    int* pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwd_32f,(const Ipp32f* pSrc, Ipp32f* pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInv_32f,(const Ipp32f* pSrc, Ipp32f* pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwd_32f_I,(Ipp32f* pSrcDst, const IppsMDCTFwdSpec_32f* pMDCTSpec, Ipp8u* pBuffer))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInv_32f_I,(Ipp32f* pSrcDst, const IppsMDCTInvSpec_32f* pMDCTSpec, Ipp8u* pBuffer))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwd_16s_Sfs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwdInitAlloc_16s, (IppsMDCTFwdSpec_16s** ppMDCTSpec, int len))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwdFree_16s, (IppsMDCTFwdSpec_16s* pMDCTSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwdGetSize_16s, (int len, int* pSizeSpec, int* pSizeInit, int* pSizeBuf))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwdGetBufSize_16s,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInvGetSize_32f, (int len, int *pSizeSpec, int *pSizeInit, int *pSizeBuf))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwdGetSize_32f, (int len, int *pSizeSpec, int *pSizeInit, int *pSizeBuf))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwdInit_32f, (IppsMDCTFwdSpec_32f** ppMDCTSpec, int len, Ipp8u* pMemSpec, Ipp8u* pMemInit))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInvInit_32f,(IppsMDCTInvSpec_32f** ppMDCTSpec, int len, Ipp8u* pMemSpec, Ipp8u* pMemInit))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwdInit_16s,(IppsMDCTFwdSpec_16s** ppMDCTSpec, int len, Ipp8u* pMemSpec, Ipp8u* pMemInit))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSpread_16s_Sfs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsInterleave_16s, (const Ipp16s   **pSrc,
                                             int      ch_num,
                                             int      len,
                                             Ipp16s   *pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsInterleave_32f, (const Ipp32f **pSrc,
                                             int    ch_num,
                                             int    len,
                                             Ipp32f *pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDeinterleave_16s, (const Ipp16s* pSrc, int ch_num,
                                              int len, Ipp16s** pDst))
/* ///////////////////////////////////////////////////////////////////////////
//  Name:
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDeinterleave_32f, (const Ipp32f* pSrc, int ch_num,
                                              int len, Ipp32f** pDst))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPow34_32f16s, (const Ipp32f* pSrc, Ipp16s* pDst, int len))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPow43_16s32f, (const Ipp16s* pSrc, Ipp32f* pDst, int len))


LEGACY90IPPAPI(IppStatus, legacy90ippsPow43Scale_16s32s_Sf, (const Ipp16s* pSrc, Ipp32s* pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPow34_32f,(const Ipp32f* pSrc, Ipp32f* pDst, int len))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPow34_16s_Sfs,(const Ipp16s* pSrc, int inScaleFactor, Ipp16s* pDst, int ScaleFactor, int len))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsCalcSF_16s32f, (const Ipp16s* pSrc, int offset,Ipp32f *pDst, int len))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsScale_32f_I, (Ipp32f* pSrcDst, Ipp32f* pSF, const Ipp32s* pBandOffset, int bandsNumber))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMakeFloat_16s32f, (Ipp16s* inmant, Ipp16s* inexp, Ipp32s size, Ipp32f* outfloat))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVQCodeBookInitAlloc_32f, (const Ipp32f* pInputTable, IppsVQCodeBookState_32f** ppCodeBooks, int step, int height))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVQCodeBookFree_32f, (IppsVQCodeBookState_32f* pCodeBook))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVQCodeBookInit_32f, (const Ipp32f* pInputTable, IppsVQCodeBookState_32f** ppCodeBook , int step, int height, Ipp8u* pMemSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVQPreliminarySelect_32f, (const Ipp32f* pSrc, const Ipp32f* pWeights, int nDiv, const Ipp32s* pLengths, Ipp32s* pIndx, Ipp32s* pSign, int nCand, int* polbits, IppsVQCodeBookState_32f* pCodeBook))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVQMainSelect_32f, (const Ipp32f* pSrc, const Ipp32f* pWeights, const Ipp32s* pLengths, int nDiv, int nCand, Ipp32s** ppIndexCand, Ipp32s** ppSignCand, Ipp32s** ppIndx, Ipp32s** ppSign, IppsVQCodeBookState_32f** ppCodeBooks, int nCodeBooks))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVQIndexSelect_32f, (const Ipp32f* pSrc, const Ipp32f* pWeights, int nDiv, const Ipp32s* pLengths,  int nCand, int** ppPolbits, Ipp32s** ppIndx, Ipp32s** ppSign, IppsVQCodeBookState_32f** ppCodeBooks, int nCodeBooks))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVQReconstruction_32f, (const Ipp32s** ppIndx, const Ipp32s** ppSign, const Ipp32s* pLength, int nDiv, int nStream, Ipp32f* pDst, IppsVQCodeBookState_32f** ppCodeBooks))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVQCodeBookGetSize_32f, (int step, int height, int *pSizeState))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterGetSize_SBR_RToC_32f, ( int* pSizeSpec, int* pSizeInitBuf, int* pSizeWorkBuf ))

LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterGetSize_SBR_RToC_32f32fc, ( int* pSizeSpec, int* pSizeInitBuf, int* pSizeWorkBuf ))

LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterGetSize_SBR_RToR_32f, ( int* pSizeSpec, int* pSizeInitBuf, int* pSizeWorkBuf ))

LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterGetSize_SBR_CToR_32f, ( int* pSizeSpec, int* pSizeInitBuf, int* pSizeWorkBuf ))

LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterGetSize_SBR_CToR_32fc32f, ( int* pSizeSpec, int* pSizeInitBuf, int* pSizeWorkBuf ))

LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterGetSize_SBR_RToR_32f, ( int* pSizeSpec, int* pSizeInitBuf, int* pSizeWorkBuf ))

LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterGetSize_SBR_CToR_32f, ( int* pSizeSpec, int* pSizeInitBuf, int* pSizeWorkBuf ))

LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterGetSize_SBR_CToR_32fc32f, ( int* pSizeSpec, int* pSizeInitBuf, int* pSizeWorkBuf ))

LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterGetSize_SBR_RToR_32f, ( int* pSizeSpec, int* pSizeInitBuf, int* pSizeWorkBuf ))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterInit_SBR_RToC_32f,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterInit_SBR_CToR_32fc32f,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterInit_SBR_RToC_32f32fc,
       ( IppsFilterSpec_SBR_C_32fc** ppFilterSpec, Ipp8u* pMemSpec, Ipp8u* pInitBuf))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterInit_SBR_RToR_32f,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterInit_SBR_CToR_32f,
       ( IppsFilterSpec_SBR_C_32f** ppFilterSpec, Ipp8u* pMemSpec, Ipp8u* pInitBuf))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterInit_SBR_RToR_32f,
       ( IppsFilterSpec_SBR_R_32f** ppFilterSpec, Ipp8u* pMemSpec, Ipp8u* pInitBuf))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterInit_SBR_CToR_32f,
       ( IppsFilterSpec_SBR_C_32f** ppFilterSpec, Ipp8u* pMemSpec, Ipp8u* pInitBuf))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterInit_SBR_CToR_32fc32f,
       ( IppsFilterSpec_SBR_C_32fc** ppFilterSpec, Ipp8u* pMemSpec, Ipp8u* pInitBuf))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterInit_SBR_RToR_32f,
       ( IppsFilterSpec_SBR_R_32f** ppFilterSpec, Ipp8u* pMemSpec, Ipp8u* pInitBuf))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilter_SBR_RToC_32f_D2L,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilter_SBR_RToC_32f32fc_D2L,
       (const Ipp32f* pSrc, Ipp32fc* pDst[], const Ipp32f* pSbrTableWinDown,
       int NumLoop, int offset, int kx,
       const IppsFilterSpec_SBR_C_32fc* pFilterSpec, Ipp8u* pWorkBuf))

LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilter_SBR_RToR_32f_D2L,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_SBR_CToR_32f_D2L,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_SBR_CToR_32fc32f_D2L,
       (const Ipp32fc* pSrc[], Ipp32f* pDst, const Ipp32f* pSbrTableWindow, int NumLoop,
       const IppsFilterSpec_SBR_C_32fc* pFilterSpec, Ipp8u* pWorkBuf ))

LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_SBR_RToR_32f_D2L,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilter_SBR_CToR_32f_D2L,
       (const Ipp32f* pSrcRe[],const Ipp32f* pSrcIm[], Ipp32f* pDst,
       const Ipp32f* pSbrTableWindowDown, int NumLoop,
       const IppsFilterSpec_SBR_C_32f* pFilterSpec, Ipp8u* pWorkBuf ))

LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilter_SBR_CToR_32fc32f_D2L,
       (const Ipp32fc* pSrc[], Ipp32f* pDst, const Ipp32f* pSbrTableWindowDown, int NumLoop,
       const IppsFilterSpec_SBR_C_32fc* pFilterSpec, Ipp8u* pWorkBuf ))

LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilter_SBR_RToR_32f_D2L,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsPredictCoef_SBR_R_32f_D2L,
       (const Ipp32f* pSrc[], Ipp32f* pAlpha0, Ipp32f* pAlpha1, int k0, int len))

LEGACY90IPPAPI( IppStatus, legacy90ippsPredictCoef_SBR_C_32fc_D2L,
       (const Ipp32fc* pSrc[], Ipp32fc* pAlpha0, Ipp32fc* pAlpha1, int k0, int len))

LEGACY90IPPAPI( IppStatus, legacy90ippsPredictCoef_SBR_C_32f_D2L,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsPredictOneCoef_SBRHQ_32sc_D2L,
       (const Ipp32sc* pSrc[], Ipp32sc* pAlpha0, Ipp32sc* pAlpha1, int k, int lenCorr))


LEGACY90IPPAPI( IppStatus, legacy90ippsPredictOneCoef_SBRLP_32s_D2L,
 ...
 ****************************************************************************/
 ...
 /* <-------------------- HQ MODE --------------------------> */
  ...
  LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterGetSize_SBRHQ_32s32sc, ( int* pSizeSpec ))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterGetSize_SBRHQ_32sc32s, ( int* pSizeSpec ))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterGetSize_SBRHQ_32sc32s, ( int* pSizeSpec))

  /* INIT */
  
  LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterInit_SBRHQ_32s32sc,
       ( IppsFilterSpec_SBR_C_32sc* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterInit_SBRHQ_32sc32s,
       ( IppsFilterSpec_SBR_C_32sc* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterInit_SBRHQ_32sc32s,
       ( IppsFilterSpec_SBR_C_32sc* pFilterSpec))

  /* INITALLOC */
  
  LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterInitAlloc_SBRHQ_32s32sc,
       ( IppsFilterSpec_SBR_C_32sc** ppFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterInitAlloc_SBRHQ_32sc32s,
       ( IppsFilterSpec_SBR_C_32sc** ppFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterInitAlloc_SBRHQ_32sc32s,
       ( IppsFilterSpec_SBR_C_32sc** ppFilterSpec))

  /* FREE */
  
  LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterFree_SBRHQ_32s32sc,
       ( IppsFilterSpec_SBR_C_32sc* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterFree_SBRHQ_32sc32s,
       ( IppsFilterSpec_SBR_C_32sc* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterFree_SBRHQ_32sc32s,
       ( IppsFilterSpec_SBR_C_32sc* pFilterSpec))

  /* MAIN */
  
  LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilter_SBRHQ_32s32sc,
       (const Ipp32s* pSrc, Ipp32sc* pDst,int kx,
        const IppsFilterSpec_SBR_C_32sc* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_SBRHQ_32sc32s,
       (const Ipp32sc* pSrc, Ipp32s* pDst,
        const IppsFilterSpec_SBR_C_32sc* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilter_SBRHQ_32sc32s,
       (const Ipp32sc* pSrc, Ipp32s* pDst,
        const IppsFilterSpec_SBR_C_32sc* pFilterSpec ))
...
/* <-----------------------LP MODE -----------------------> */
  ...
  LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterGetSize_SBRLP_32s, ( int* pSizeSpec ))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterGetSize_SBRLP_32s, ( int* pSizeSpec ))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterGetSize_SBRLP_32s, ( int* pSizeSpec ))

  /* INIT */
  
  LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterInit_SBRLP_32s,
       ( IppsFilterSpec_SBR_R_32s* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterInit_SBRLP_32s,
       ( IppsFilterSpec_SBR_R_32s* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterInit_SBRLP_32s,
       ( IppsFilterSpec_SBR_R_32s* pFilterSpec))

  /* INITALLOC */
  
  LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterInitAlloc_SBRLP_32s,
       ( IppsFilterSpec_SBR_R_32s** ppFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterInitAlloc_SBRLP_32s,
       ( IppsFilterSpec_SBR_R_32s** ppFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterInitAlloc_SBRLP_32s,
       ( IppsFilterSpec_SBR_R_32s** ppFilterSpec))

  /* FREE */
  
  LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilterFree_SBRLP_32s,
       ( IppsFilterSpec_SBR_R_32s* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilterFree_SBRLP_32s,
       ( IppsFilterSpec_SBR_R_32s* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilterFree_SBRLP_32s,
       ( IppsFilterSpec_SBR_R_32s* pFilterSpec))

  /* MAIN */
  
  LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilter_SBRLP_32s,
       (const Ipp32s* pSrc, Ipp32s* pDst,int kx,
        const IppsFilterSpec_SBR_R_32s* pFilterSpec))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisFilter_SBRLP_32s,
       (const Ipp32s* pSrc, Ipp32s* pDst,
        const IppsFilterSpec_SBR_R_32s* pFilterSpec ))

  
  LEGACY90IPPAPI( IppStatus, legacy90ippsSynthesisDownFilter_SBRLP_32s,
       (const Ipp32s* pSrc, Ipp32s* pDst,
        const IppsFilterSpec_SBR_R_32s* pFilterSpec ))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisFilterEncGetSize_SBR_32f,
       (int *pSizeSpec,
       int *pSizeInitBuf))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisFilterEncInit_SBR_32f,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisFilterEncInitAlloc_SBR_32f, (IppsFilterSpec_SBR_C_32f **ppFilterSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisFilterEncFree_SBR_32f, (IppsFilterSpec_SBR_C_32f *pFilterSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisFilterEnc_SBR_32f32fc,
       (const Ipp32f   *pSrc,
       Ipp32fc        *pDst,
...
LEGACY90IPPAPI( IppStatus, legacy90ippsDetectTransient_SBR_32f, (const Ipp32f* pSrc, Ipp32f* pInOutThr, Ipp32f* pDst))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsEstimateTNR_SBR_32f, (const Ipp32fc* pSrc, Ipp32f* pTNR0, Ipp32f* pTNR1, Ipp32f* pMeanNrg))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsAnalysisFilter_PS_32fc_D2, (const Ipp32fc* pSrc, Ipp32fc ppDst[32][12],
...
LEGACY90IPPAPI(IppStatus, legacy90ippsUnpackFrameHeader_MP3, (
  Ipp8u**            ppBitStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsUnpackSideInfo_MP3, (
  Ipp8u**            ppBitStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsUnpackScaleFactors_MP3_1u8s, (
  Ipp8u**            ppBitStream,
  int*               pOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsHuffmanDecode_MP3_1u32s, (
  Ipp8u**            ppBitStream,
  int*               pOffset,
  Ipp32s*            pDstIs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsHuffmanDecodeSfb_MP3_1u32s, (
  Ipp8u**            ppBitStream,
  int*               pOffset,
  Ipp32s*            pDstIs,
  int*               pDstNonZeroBound,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsHuffmanDecodeSfbMbp_MP3_1u32s, (
  Ipp8u**            ppBitStream,
  int*               pOffset,
  Ipp32s*            pDstIs,
  int*               pDstNonZeroBound,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsReQuantize_MP3_32s_I, (
  Ipp32s*            pSrcDstIsXr,
  int*               pNonZeroBound,
  Ipp8s*             pScaleFactor,
  IppMP3SideInfo*    pSideInfo,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsReQuantizeSfb_MP3_32s_I, (
  Ipp32s*            pSrcDstIsXr,
  int*               pNonZeroBound,
  Ipp8s*             pScaleFactor,
  IppMP3SideInfo*    pSideInfo,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInv_MP3_32s, (
  Ipp32s* pSrcXr,
  Ipp32s* pDstY,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthPQMF_MP3_32s16s, (
  Ipp32s* pSrcY,
  Ipp16s* pDstAudioOut,
  Ipp32s* pVBuffer,
  int*    pVPosition,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsUnpackADIFHeader_AAC,(Ipp8u **ppBitStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodePrgCfgElt_AAC,(Ipp8u **ppBitStream, int *pOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsUnpackADTSFrameHeader_AAC, (Ipp8u **ppBitStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeDatStrElt_AAC,(Ipp8u **ppBitStream, int *pOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeFillElt_AAC,(Ipp8u **ppBitStream, int *pOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeChanPairElt_AAC, (Ipp8u             **ppBitStream,
                                              int               *pOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsNoiselessDecoder_LC_AAC,(Ipp8u **ppBitStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsQuantInv_AAC_32s_I,(Ipp32s *pSrcDstSpectralCoef,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeMsStereo_AAC_32s_I,(Ipp32s *pSrcDstL,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeIsStereo_AAC_32s,(const Ipp32s *pSrcL,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDeinterleaveSpectrum_AAC_32s,(const Ipp32s *pSrc,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeTNS_AAC_32s_I,(Ipp32s *pSrcDstSpectralCoefs,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInv_AAC_32s16s,(Ipp32s *pSrcSpectralCoefs,
                         Ipp16s *pDstPcmAudioOut, Ipp32s *pSrcDstOverlapAddBuf,
                int winSequence, int winShape, int prevWinShape, int pcmMode ))


LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInv_AAC_32s_I,(Ipp32s *tst_SrcDst, Ipp32s *tst_OverlapBuf,
       int winSeq, int winShape, int prewinShape, int len))


LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwd_AAC_32s_I,(Ipp32s *tst_SrcDst, int winSeq, int winShape,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeMainHeader_AAC,(Ipp8u **ppBitStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeExtensionHeader_AAC,(Ipp8u **ppBitStream,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodePNS_AAC_32s,(Ipp32s *pSrcDstSpec,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeMsPNS_AAC_32s,(Ipp32s *pSrcDstSpec,
                      int *pSrcDstLtpFlag, Ipp8u *pSfbCb, Ipp16s *pScaleFactor,
             int maxSfb, int numWinGrp, int *pWinGrpLen, int samplingFreqIndex,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsLongTermReconstruct_AAC_32s,(Ipp32s *pSrcEstSpec,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsEncodeTNS_AAC_32s_I,(Ipp32s *pSrcDstSpectralCoefs,
                              const int *pTnsNumFilt, const int *pTnsRegionLen,
                          const int *pTnsFiltOrder, const int *pTnsFiltCoefRes,
                           const Ipp8s *pTnsFiltCoef, const int *pTnsDirection,
                  int maxSfb, int profile, int samplingRateIndex, int winLen ))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsLongTermPredict_AAC_32s,(Ipp32s *pSrcTimeSignal,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsNoiselessDecode_AAC,(Ipp8u **ppBitStream, int *pOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsLtpUpdate_AAC_32s,(Ipp32s *pSpecVal,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwd_AAC_32s,(Ipp32s *pSrc, Ipp32s *pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsDecodeChanPairElt_MP4_AAC,(Ipp8u **ppBitStream, int *pOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeEscBlock_MP3_1u16s,(Ipp8u **ppBitStream,
                                                   int *pBitOffset,
                                                   int linbits,
                                                   Ipp16s *pData,
                                                   int len,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeEscBlock_AAC_1u16s,(Ipp8u **ppBitStream,
                                                   int *pBitOffset,
                                                   Ipp16s *pData,
                                                   int len,
                                                   const IppsVLCDecodeSpec_32s *pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCEncodeEscBlock_MP3_16s1u,(const Ipp16s *pInputData,
                                                   int len,
                                                   int linbits,
                                                   Ipp8u **ppBitStream,
                                                   int *pBitOffset,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCEncodeEscBlock_AAC_16s1u,(const Ipp16s *pInputData,
                                                   int len,
                                                   Ipp8u **ppBitStream,
                                                   int *pBitOffset,
                                                   const IppsVLCEncodeSpec_32s *pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCCountEscBits_MP3_16s32s,(const Ipp16s *pInputData,
                                                  int len,
                                                  int linbits,
                                                  Ipp32s *pCountBits,
                                                  const IppsVLCEncodeSpec_32s *pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCCountEscBits_AAC_16s32s,(const Ipp16s *pInputData,
                                                  int len,
                                                  Ipp32s *pCountBits,
                                                  const IppsVLCEncodeSpec_32s *pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeUTupleEscBlock_MP3_1u16s,(Ipp8u **ppBitStream,
                                                   int *pBitOffset,
                                                   int linbits,
                                                   Ipp16s *pData,
                                                   int len,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeUTupleEscBlock_AAC_1u16s,(Ipp8u **ppBitStream,
                                                   int *pBitOffset,
                                                   Ipp16s *pData,
                                                   int len,
                                                   const IppsVLCDecodeUTupleSpec_32s *pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPackFrameHeader_MP3, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPackSideInfo_MP3, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPackScaleFactors_MP3_8s1u, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippsHuffmanEncode_MP3_32s1u, (
    Ipp32s *pSrcIx,
    Ipp8u **ppBitStream,
    int *pOffset,
    IppMP3FrameHeader *pFrameHeader,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsBitReservoirInit_MP3, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTFwd_MP3_32s, (
    const Ipp32s*       pSrc,
    Ipp32s*             pDst,
    int                 blockType,
    int                 mixedBlock,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsMDCTInvWindow_MP3_32s,(
    Ipp32s* pSrc,
    Ipp32s* pDst,
    int     blockType))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisPQMF_MP3_16s32s, (
...
LEGACY90IPPAPI(IppStatus, legacy90ippsJointStereoEncode_MP3_32s_I, (
    Ipp32s*             pSrcDstXrL,
    Ipp32s*             pSrcDstXrR,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsQuantize_MP3_32s_I, (
    Ipp32s*             pSrcDstXrIx,
    Ipp8s*              pDstScaleFactor,
    int*                pDstScfsi,
    int*                pDstCount1Len,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsPsychoacousticModelTwo_MP3_16s, (
    const Ipp16s*       pSrcPcm,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilter_PQMF_MP3_32f, (const  Ipp32f  *pSrc,
                                                            Ipp32f  *pDst,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterGetSize_PQMF_MP3_32f, (int *pSizeSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterInit_PQMF_MP3_32f, (IppsFilterSpec_PQMF_MP3 **ppFilterSpec,
                                                         Ipp8u                   *pMemSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterInitAlloc_PQMF_MP3_32f, (IppsFilterSpec_PQMF_MP3 **ppFilterSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterFree_PQMF_MP3_32f, (IppsFilterSpec_PQMF_MP3 *pFilterSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisFilter_PQMF_MP3_32f, (const  Ipp32f  *pSrc,
                                                            Ipp32f  *pDst,
                                                     const  IppsFilterSpec_PQMF_MP3 *pFilterSpec,
                                                            int     mode))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisFilterGetSize_PQMF_MP3_32f, (int *pSizeSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisFilterInit_PQMF_MP3_32f, (IppsFilterSpec_PQMF_MP3 **ppFilterSpec,
                                                         Ipp8u                   *pMemSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisFilterInitAlloc_PQMF_MP3_32f, (IppsFilterSpec_PQMF_MP3 **ppFilterSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsAnalysisFilterFree_PQMF_MP3_32f, (IppsFilterSpec_PQMF_MP3 *pFilterSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilter_DTS_32f, (const  Ipp32f  *pSrc,
                                                Ipp32f  *pDst,
                                                Ipp32s filt_type,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterGetSize_DTS_32f, (int *pSizeSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterInit_DTS_32f, (IppsFilterSpec_DTS_32f *pFilterSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterInitAlloc_DTS_32f, (IppsFilterSpec_DTS_32f **ppFilterSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsSynthesisFilterFree_DTS_32f, (IppsFilterSpec_DTS_32f *pFilterSpec))
...
LEGACY90IPPAPI( IppStatus, legacy90ippsJoin_32f16s_D2L, ( const Ipp32f** pSrc,
...
LEGACY90IPPAPI(void, legacy90ippsVLCEncodeFree_32s, (IppsVLCEncodeSpec_32s* pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCEncodeInitAlloc_32s, (const IppsVLCTable_32s* pInputTable, int inputTableSize, IppsVLCEncodeSpec_32s** ppVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCEncodeInit_32s, (const IppsVLCTable_32s* pInputTable, int inputTableSize, IppsVLCEncodeSpec_32s* pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCEncodeGetSize_32s, (const IppsVLCTable_32s* pInputTable, int inputTableSize, Ipp32s* pSize))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCEncodeBlock_16s1u, (const Ipp16s* pSrc, int srcLen, Ipp8u** ppDst, int* pDstBitsOffset, const IppsVLCEncodeSpec_32s* pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCEncodeOne_16s1u, (Ipp16s src, Ipp8u** pDst, int* pDstBitsOffset, const IppsVLCEncodeSpec_32s* pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCCountBits_16s32s, (const Ipp16s* pSrc, int srcLen, Ipp32s* pCountBits, const IppsVLCEncodeSpec_32s* pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeGetSize_32s,(const IppsVLCTable_32s *pInputTable,
                                            int inputTableSize,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeInit_32s,(const IppsVLCTable_32s *pInputTable,
                                         int inputTableSize,
                                         Ipp32s *pSubTablesSizes,
                                         int numSubTables,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeInitAlloc_32s,(const IppsVLCTable_32s *pInputTable,
                                              int inputTableSize,
                                              Ipp32s *pSubTablesSizes,
                                              int numSubTables,
...
LEGACY90IPPAPI(void, legacy90ippsVLCDecodeFree_32s, (IppsVLCDecodeSpec_32s *pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeBlock_1u16s,(Ipp8u **ppSrc,
                                            int *pSrcBitsOffset,
                                            Ipp16s *pDst,
                                            int dstLen,
                                            const IppsVLCDecodeSpec_32s *pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeOne_1u16s,(Ipp8u **ppSrc,
                                          int *pSrcBitsOffset,
                                          Ipp16s *pDst,
                                          const IppsVLCDecodeSpec_32s *pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeUTupleGetSize_32s,(const IppsVLCTable_32s  *pInputTable,
                                                  int               inputTableSize,
                                                  Ipp32s            *pSubTablesSizes,
                                                  int               numSubTables,
                                                  int               numElements,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeUTupleInit_32s,(const  IppsVLCTable_32s      *pInputTable,
                                                int                   inputTableSize,
                                                Ipp32s                *pSubTablesSizes,
                                                int                   numSubTables,
                                                int                   numElements,
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeUTupleInitAlloc_32s,(const IppsVLCTable_32s      *pInputTable,
                                                    int                   inputTableSize,
                                                    Ipp32s                *pSubTablesSizes,
                                                    int                   numSubTables,
                                                    int                   numElements,
...
LEGACY90IPPAPI(void, legacy90ippsVLCDecodeUTupleFree_32s,(IppsVLCDecodeUTupleSpec_32s *pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeUTupleBlock_1u16s,(Ipp8u                       **ppSrc,
                                            int                         *pSrcBitsOffset,
                                            Ipp16s                      *pDst,
                                            int                         dstLen,
                                            const IppsVLCDecodeUTupleSpec_32s *pVLCSpec))
...
LEGACY90IPPAPI(IppStatus, legacy90ippsVLCDecodeUTupleOne_1u16s,(Ipp8u                   **ppSrc,
                                           int                          *pSrcBitsOffset,
                                           Ipp16s                       *pDst,
                                           const IppsVLCDecodeUTupleSpec_32s  *pVLCSpec))
...
#endif  /* #if !defined(__IPPAC_90_LEGACY_H__ ) */
