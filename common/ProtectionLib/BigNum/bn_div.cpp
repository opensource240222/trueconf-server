...
// The code above does a really evil thing - it shadows function with a macro.
// If the file containing definition of that function happens to be included in
// unity after this file then we get mysterious compiler errors.
// So we have to undo that to avoid random build breakages.
#ifdef bn_div_words
# undef bn_div_words
#endif
#endif
