...
namespace webrtc
{
	...
	class VS_LevelEstimatorImpl : public LevelEstimator
	{
	public:
		explicit VS_LevelEstimatorImpl(rtc::CriticalSection* crit);
		~VS_LevelEstimatorImpl() override;
	...
	private:
		...
		RTC_DISALLOW_IMPLICIT_CONSTRUCTORS(VS_LevelEstimatorImpl);
	};
}  // namespace webrtc
