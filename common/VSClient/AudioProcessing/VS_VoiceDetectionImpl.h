...
namespace webrtc
{
	...
	class VS_VoiceDetectionImpl : public VoiceDetection
	{
	public:
		explicit VS_VoiceDetectionImpl(rtc::CriticalSection* crit);
		~VS_VoiceDetectionImpl() override;
	...
	private:
		...
		RTC_DISALLOW_IMPLICIT_CONSTRUCTORS(VS_VoiceDetectionImpl);
	};
}  // namespace webrtc
