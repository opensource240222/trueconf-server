...
#if !FFL_DUMP_RTP
inline std::shared_ptr<AbstractSource> FilterDumpRTP::Create(const std::shared_ptr<AbstractSource>& src, string_view /*name*/)
{
	return src;
}
#endif
