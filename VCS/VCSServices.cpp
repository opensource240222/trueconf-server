...
#include "Services/VCSAuthService.h"
#include "Services/VS_CheckLicenseService.h"
#include "Services/VS_OfflineChatService.h"
#include "Services/VS_RegistryStorage.h"
#include "Services/VS_VCSABStorage.h"
#include "Services/VS_VCSConfigurationService.h"
#include "Services/VS_VCSConfRestrict.h"
#include "Services/VS_VCSLocatorService.h"
#include "Services/VS_VCSLogService.h"
...
//			chs.SetPresenceService(upss);
			...
			STARTMESS(DS_CONTROL_SRV);
			if (!tr->AddService(DS_CONTROL_SRV, &dsc_srv) || !dsc_srv.SetThread()) {
				puts(sFd); return false;
			}
			ss = DS_CONTROL_SS; puts(sSd);
