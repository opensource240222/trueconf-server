...
static CRC32 GetKeyCRC(const char *keytext, int period) {
...
static void GenerateKeyNumberFromString(const char *string, BigInt p, BigInt *keynumber, int keysystem, int v3level) {
...
static int MakeEccSignature(unsigned char *keybytes, int *keylength, const char *pvtkeystring, char *name_to_make_key_for, int level) {
	EC_PARAMETER Base;
	EC_KEYPAIR Signer;
	SIGNATURE signature;
...
static int MakeSignature(unsigned char *keybytes, int *keylength, const char *pvtkeystring, char *name_encryptkey, int level) {
...
const char *CreateSignedKey(int level, const char *encryption_template, char *_name_to_make_key_for, unsigned long hardwareID, unsigned short otherinfo1, unsigned short otherinfo2, unsigned short otherinfo3, unsigned short otherinfo4, unsigned short otherinfo5, char *keystring) {
...
const char *CreateShortV3Key(int level, const char *encryption_template, char *name_to_make_key_for, unsigned long hardwareID, unsigned short otherinfo1, unsigned short otherinfo2, unsigned short otherinfo3, unsigned short otherinfo4, unsigned short otherinfo5) {
...
#include <windows.h>
void MakeLicenseKey(char* result,const char *template_, unsigned long hardwareID, unsigned short daysLifeTime, unsigned short otherinfo1, unsigned short otherinfo2, unsigned short otherinfo3, unsigned short otherinfo4){
	if (!template_) return;
	static HANDLE m_lock=0;
	if(m_lock==0){
	...
	{
	  const char *tmp=CreateShortV3Key(9,template_,NULL,hardwareID,daysLifeTime,otherinfo1,otherinfo2,otherinfo3,otherinfo4);
	  memcpy(result,tmp,512);
	  ReleaseMutex(m_lock);
	};
}
//CreateShortV3Key(9,"1",NULL,0,0,0,0,0,0);
